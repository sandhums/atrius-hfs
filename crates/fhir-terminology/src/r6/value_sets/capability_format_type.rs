...
impl CapabilityFormatType {
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["http://hl7.org/fhir/fhir-format-type", "urn:ietf:bcp:13"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        if system == "urn:ietf:bcp:13" {
            return Some(matches!(
                code,
                "application/fhir+json" | "application/fhir+xml" | "application/fhir+ttl"
            ));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/fhir-format-type" {
            return super::super::code_systems::FHIRFormatType::try_from_code(code)
