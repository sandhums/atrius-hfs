...
impl ProductClassification {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/medicinal-product-classification";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "medicinal_product_classification";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &["http://www.whocc.no/atc"];
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://www.whocc.no/atc".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://www.whocc.no/atc", code)
    }
