...
pub struct PolymerStartingMaterialCategory;

impl PolymerStartingMaterialCategory {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/polymer-starting-material-category";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "polymer_starting_material_category_1466202f";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["http://hl7.org/fhir/polymer-starting-material-category"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/polymer-starting-material-category" {
            return Some(
                super::super::code_systems::PolymerStartingMaterialCategoryExample::try_from_code(
                    code,
                )
                .is_some(),
            );
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/polymer-starting-material-category" {
            return super::super::code_systems::PolymerStartingMaterialCategoryExample::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://hl7.org/fhir/polymer-starting-material-category".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
