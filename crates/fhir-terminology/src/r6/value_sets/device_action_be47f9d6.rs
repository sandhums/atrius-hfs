...
pub struct ProcedureDeviceActionCodes;

impl ProcedureDeviceActionCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/device-action";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "device_action_be47f9d6";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(
                code,
                "129336009" | "278312000" | "282089006" | "129303008"
            ));
        }
        None
    }
