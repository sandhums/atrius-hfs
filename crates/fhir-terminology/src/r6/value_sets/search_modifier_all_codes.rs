...
impl SearchModifierAllCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/search-modifier-code" {
            return Some(
                super::super::code_systems::SearchModifierCode::try_from_code(code).is_some(),
            );
        }
        ...
        // http://hl7.org/fhir/ValueSet/extended-resource-types
        match super::super::value_sets::extended_resource_types::ExtendedResourceTypes::contains(
            system, code,
        ) {
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/search-modifier-code" {
            return super::super::code_systems::SearchModifierCode::try_from_code(code)
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://hl7.org/fhir/search-modifier-code".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
