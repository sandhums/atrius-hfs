...
impl FHIRTypes {
    ...
    pub const MODULE: &'static str = "data_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(super::super::code_systems::FHIRTypes::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return super::super::code_systems::FHIRTypes::try_from_code(code)
