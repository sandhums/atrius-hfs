...
//! Device Definition Clinical Condition
//!
//! Example value set for clinical conditions and findings relevant to device indication and contraindication.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct DeviceDefinitionClinicalCondition;

impl DeviceDefinitionClinicalCondition {
    pub const URL: &'static str =
        "http://hl7.org/fhir/ValueSet/devicedefinition-clinical-condition";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "devicedefinition_clinical_condition";
