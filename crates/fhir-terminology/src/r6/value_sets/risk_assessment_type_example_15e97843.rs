...
//!
//! Example value set illustrating possible codes for identifying the types of risk assessment; e.g. Renal, Cardiovascular, or Hepatic risk.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct RiskAssessmentTypeExample;

impl RiskAssessmentTypeExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/risk-assessment-type-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "risk_assessment_type_example_15e97843";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/risk-assessment-type-example" {
            return Some(
                super::super::code_systems::RiskAssessmentTypeExample::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/risk-assessment-type-example" {
            return super::super::code_systems::RiskAssessmentTypeExample::try_from_code(code)
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://hl7.org/fhir/risk-assessment-type-example".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/risk-assessment-type-example", code)
    }
