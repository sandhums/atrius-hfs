...
pub struct ImmunizationStatusCodes;

impl ImmunizationStatusCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-status";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "immunization_status";
