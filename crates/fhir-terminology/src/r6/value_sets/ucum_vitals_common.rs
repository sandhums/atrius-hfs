...
pub struct VitalSignsUnits;

impl VitalSignsUnits {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/ucum-vitals-common";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "ucum_vitals_common";
