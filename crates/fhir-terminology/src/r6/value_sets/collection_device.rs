...
//! Collection Device
//!
//! Codes for devices used in specimen collection.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct CollectionDevice;

impl CollectionDevice {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/collection-device";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "collection_device";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(
                code,
                "1003474008" | "20568009" | "706681000" | "700956008" | "22566001"
            ));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "1003474008" => Some("Oral specimen collection swab (physical object)"),
                "20568009" => Some("Urinary catheter, device (physical object)"),
                "706681000" => Some("Aspiration needle (physical object)"),
                "700956008" => Some("Blood collection needle, basic (physical object)"),
                "22566001" => Some("Cytology brush, device (physical object)"),
                _ => None,
            };
        }
        None
