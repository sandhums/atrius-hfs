...
pub struct QuestionnaireAnswerCodes;

impl QuestionnaireAnswerCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/questionnaire-answers";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "questionnaire_answers";
