...
//!
//! Unified Code for Units of Measure (UCUM). This value set includes all possible UCUM codes used for time measures (Age, Duration etc.) - that it is, all units which have the same canonical unit as 'a' (year)
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct AllUCUMExpressionForTime;

impl AllUCUMExpressionForTime {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/all-time-units";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "all_time_units";
