...
pub struct BodyTemperatureUnits;

impl BodyTemperatureUnits {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/ucum-bodytemp";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "ucum_bodytemp";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "Cel" | "[degF]"));
        }
        None
    }
