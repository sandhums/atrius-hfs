...
pub struct DeviceVersionType;

impl DeviceVersionType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/device-versiontype";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "device_versiontype";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:iso:std:iso:11073:10101" {
            return Some(matches!(
                code,
                "531974" | "531975" | "531976" | "531977" | "532352"
            ));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "urn:iso:std:iso:11073:10101" {
            return match code {
                "531974" => Some("Hardware revision"),
                "531975" => Some("Software revision"),
                "531976" => Some("Firmware revision"),
                "531977" => Some("Protocol revision"),
                "532352" => Some("Continua version"),
                _ => None,
            };
        }
        None
