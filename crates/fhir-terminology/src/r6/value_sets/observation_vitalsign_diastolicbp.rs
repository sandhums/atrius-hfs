...
pub struct VitalSignsDiastolicBP;

impl VitalSignsDiastolicBP {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/observation-vitalsign-diastolicbp";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "observation_vitalsign_diastolicbp";
