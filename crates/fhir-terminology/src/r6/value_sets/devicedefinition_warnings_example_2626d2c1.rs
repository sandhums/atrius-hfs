...
pub struct DeviceWarningsExample;

impl DeviceWarningsExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/devicedefinition-warnings-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "devicedefinition_warnings_example_2626d2c1";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/devicedefinition-warnings-example" {
            return Some(
                super::super::code_systems::DeviceWarningsExample::try_from_code(code).is_some(),
            );
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/devicedefinition-warnings-example" {
            return super::super::code_systems::DeviceWarningsExample::try_from_code(code)
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://hl7.org/fhir/devicedefinition-warnings-example".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
