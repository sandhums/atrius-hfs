...
pub struct DiseaseSymptomProcedure;

impl DiseaseSymptomProcedure {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/disease-symptom-procedure";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "disease_symptom_procedure";
