...
pub struct VitalSignsBodyHeight;

impl VitalSignsBodyHeight {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/observation-vitalsign-bodyheight";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "observation_vitalsign_bodyheight";
