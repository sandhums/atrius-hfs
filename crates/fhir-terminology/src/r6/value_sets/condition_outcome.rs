...
pub struct ConditionOutcomeCodes;

impl ConditionOutcomeCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/condition-outcome";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "condition_outcome";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(
                code,
                "419099009" | "370996005" | "765205004" | "21134002"
            ));
        }
        None
    }
