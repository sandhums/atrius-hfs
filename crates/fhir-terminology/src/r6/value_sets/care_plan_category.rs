...
pub struct CarePlanCategory;

impl CarePlanCategory {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/care-plan-category";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "care_plan_category";
