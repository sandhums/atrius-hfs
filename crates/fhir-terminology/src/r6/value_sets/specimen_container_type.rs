...
//! Specimen Container
//!
//! Containers which may hold specimens or specimen containers.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct SpecimenContainer;

impl SpecimenContainer {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/specimen-container-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "specimen_container_type";
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "434711009" => Some("Specimen container (physical object)"),
                "434746001" => Some("Specimen vial (physical object)"),
                "434822004" => Some("Specimen well (physical object)"),
                "713791004" => Some("Breath specimen container (physical object)"),
                "1331905008" => {
                    Some("Cytology specimen vial containing preservative fluid (physical object)")
                }
                "702281005" => {
                    Some("Evacuated blood collection tube, thrombin/clot activator/gel separator")
                }
                "702232008" => Some("Sweat specimen container IVD"),
                "702244006" => Some("Sterile urine specimen container"),
                _ => None,
            };
        }
        None
