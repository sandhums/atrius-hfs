...
pub struct ExtendedResourceTypes;

impl ExtendedResourceTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/extended-resource-types";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "extended_resource_types";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &[
        ...
        "http://hl7.org/fhir/tools/CodeSystem/additional-resources",
    ];
