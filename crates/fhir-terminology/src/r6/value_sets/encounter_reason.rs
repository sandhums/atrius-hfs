...
pub struct EncounterReasonCodes;

impl EncounterReasonCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/encounter-reason";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "encounter_reason";
