...
pub struct AllUCUMExpressionForDistance;

impl AllUCUMExpressionForDistance {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/all-distance-units";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "all_distance_units";
