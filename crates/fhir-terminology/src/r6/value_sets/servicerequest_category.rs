...
pub struct ServiceRequestCategoryCodes;

impl ServiceRequestCategoryCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/servicerequest-category";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "servicerequest_category";
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "108252007" => Some("Laboratory procedure"),
                "363679005" => Some("Imaging"),
                "409063005" => Some("Counselling"),
                "409073007" => Some("Education"),
                "387713003" => Some("Surgical procedure"),
                _ => None,
            };
        }
        None
