...
//!
//! This value set includes all codes from [SNOMED CT](http://snomed.info/sct/) where concept is-a 118956008 (Body structure, altered from its original anatomical structure (morphologic abnormality)).
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct SNOMEDCTMorphologicAbnormalities;

impl SNOMEDCTMorphologicAbnormalities {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/bodystructure-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "bodystructure_code";
