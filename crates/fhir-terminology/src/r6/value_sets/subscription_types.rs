...
pub struct SubscriptionTypes;

impl SubscriptionTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/subscription-types";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "subscription_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(matches!(code, "Reference"));
        }
        ...
        // http://hl7.org/fhir/ValueSet/version-independent-resource-types
        match super::super::value_sets::version_independent_resource_types::VersionIndependentResourceTypes::contains(system, code) {
