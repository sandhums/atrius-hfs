...
pub struct ManifestationAndSymptomCodesExample;

impl ManifestationAndSymptomCodesExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/manifestation-or-symptom-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "manifestation_or_symptom_example";
