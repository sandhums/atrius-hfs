...
pub struct SpecimenProcessingMethod;

impl SpecimenProcessingMethod {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/specimen-processing-method";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "specimen_processing_method";
