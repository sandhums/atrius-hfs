...
pub struct SNOMEDCTMedicationAsNeededReasonCodes;

impl SNOMEDCTMedicationAsNeededReasonCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/medication-as-needed-reason";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "medication_as_needed_reason";
