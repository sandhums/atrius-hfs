...
pub struct CommonUCUMCodesForAge;

impl CommonUCUMCodesForAge {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/age-units";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "age_units";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "min" | "h" | "d" | "wk" | "mo" | "a"));
        }
        None
    }
