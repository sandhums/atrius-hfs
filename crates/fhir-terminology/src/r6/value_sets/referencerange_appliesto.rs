...
pub struct ObservationReferenceRangeAppliesToCodes;

impl ObservationReferenceRangeAppliesToCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/referencerange-appliesto";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "referencerange_appliesto";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "248153007" | "248152002" | "77386006"));
        }

        // Delegation to included ValueSets (compose.include.valueSet)
        let mut any_none = false;
        let mut any_false = false;
        // http://terminology.hl7.org/ValueSet/v3-Race (not generated locally)
        any_none = true;
