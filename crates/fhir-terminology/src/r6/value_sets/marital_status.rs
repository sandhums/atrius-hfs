...
pub struct MaritalStatusCodes;

impl MaritalStatusCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/marital-status";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "marital_status";
