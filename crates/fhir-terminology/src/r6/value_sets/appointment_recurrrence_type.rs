...
pub struct AppointmentRecurrenceType;

impl AppointmentRecurrenceType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/appointment-recurrrence-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "appointment_recurrrence_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "d" | "wk" | "mo" | "a"));
        }
        None
    }
