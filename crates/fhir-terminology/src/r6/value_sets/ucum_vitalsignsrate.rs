...
pub struct VitalSignsRateUnits;

impl VitalSignsRateUnits {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/ucum-vitalsignsrate";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "ucum_vitalsignsrate";
