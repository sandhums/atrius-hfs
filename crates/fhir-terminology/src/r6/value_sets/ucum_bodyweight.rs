...
pub struct BodyWeightUnits;

impl BodyWeightUnits {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/ucum-bodyweight";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "ucum_bodyweight";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "kg" | "g" | "[lb_av]" | "[oz_av]"));
        }
        None
    }
