...
pub struct SecurityLabelExamples;

impl SecurityLabelExamples {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/security-label-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "security_label_example";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/security-label-data-example
        match super::super::value_sets::security_label_data_example::SecurityLabelDataExamples::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/security-label-event-example
        match super::super::value_sets::security_label_event_example::SecurityLabelEventExamples::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
