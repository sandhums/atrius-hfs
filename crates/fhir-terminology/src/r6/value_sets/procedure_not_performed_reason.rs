...
pub struct ProcedureNotPerformedReasonSNOMEDCT;

impl ProcedureNotPerformedReasonSNOMEDCT {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/procedure-not-performed-reason";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "procedure_not_performed_reason";
