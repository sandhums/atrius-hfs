...
pub struct VaccineAdministeredValueSet;

impl VaccineAdministeredValueSet {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/vaccine-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "vaccine_code";
