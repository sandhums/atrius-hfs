...
//!
//! This value set represents codes for categories of nutrition products.  It includes all of the codes from the Food Type Modifiers valueset.  It include codes from [SNOMED CT](http://snomed.info/sct/) where concept is Breast Milk (226789007) and its sub-concepts, Infant Formula (412413001) and its sub-concepts, Enteral and Supplement Feeds (346415002) and its sub-concepts, Drinks (226465004) and its sub-concepts, Water (11713004), Potable Water (890302005) and its sub-concepts, and 444923006 (Tap Water).
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct CategoriesOfNutritionProducts;

impl CategoriesOfNutritionProducts {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/nutrition-product-category";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "nutrition_product_category";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            if matches!(code, "11713004" | "444923006") {
                return Some(true);
            }
            return None;
        }
        ...
        // http://hl7.org/fhir/ValueSet/modified-foodtype
        match super::super::value_sets::modified_foodtype::TextureModifiedFoodTypeCodes::contains(
            system, code,
        ) {
