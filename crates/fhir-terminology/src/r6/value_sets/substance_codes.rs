...
pub struct SNOMEDCTSubstanceCodes;

impl SNOMEDCTSubstanceCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/substance-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "substance_codes";
