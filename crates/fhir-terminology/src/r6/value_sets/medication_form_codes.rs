...
pub struct SNOMEDCTFormCodes;

impl SNOMEDCTFormCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/medication-form-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "medication_form_codes";
