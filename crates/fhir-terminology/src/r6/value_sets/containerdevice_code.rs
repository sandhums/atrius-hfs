...
pub struct ContainerDeviceCode;

impl ContainerDeviceCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/containerdevice-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "containerdevice_code";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(
                code,
                "702281005" | "702232008" | "702244006" | "434746001"
            ));
        }
        None
    }
