...
//!
//! Example set of values used for classification of an EvidenceVariable.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct EvidenceVariableClassifierExample;

impl EvidenceVariableClassifierExample {
    pub const URL: &'static str =
        "http://hl7.org/fhir/ValueSet/evidence-variable-classifier-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "evidence_variable_classifier_example_5861e422";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["http://hl7.org/fhir/evidence-variable-classifier-example"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/evidence-variable-classifier-example" {
            return Some(
                super::super::code_systems::EvidenceVariableClassifierExample::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/evidence-variable-classifier-example" {
            return super::super::code_systems::EvidenceVariableClassifierExample::try_from_code(
                code,
            )
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some(
                    "http://hl7.org/fhir/evidence-variable-classifier-example".to_string(),
                ),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
