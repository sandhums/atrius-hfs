...
pub struct SNOMEDCTMedicationCodes;

impl SNOMEDCTMedicationCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/medication-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "medication_codes";
