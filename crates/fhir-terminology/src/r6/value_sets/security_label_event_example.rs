...
pub struct SecurityLabelEventExamples;

impl SecurityLabelEventExamples {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/security-label-event-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "security_label_event_example";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ActReason" {
            return Some(matches!(code, "TREAT" | "HPAYMT" | "ETREAT"));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-ActCode" {
            return Some(matches!(code, "NOAUTH" | "DELAU" | "NORDSCLCD"));
        }
        None
    }
