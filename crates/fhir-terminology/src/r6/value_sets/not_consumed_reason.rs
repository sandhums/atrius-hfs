...
//! Reasons for why a food item was not consumed
//!
...
pub struct ReasonsFoodItemNotConsumed;

impl ReasonsFoodItemNotConsumed {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/not-consumed-reason";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "not_consumed_reason";
