...
//!
//! MedicationStatement Codes for Medications taken (or not taken)
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct MedicationStatementMedicationCodes;

impl MedicationStatementMedicationCodes {
    pub const URL: &'static str =
        "http://hl7.org/fhir/ValueSet/medication-statement-medication-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "medication_statement_medication_codes";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "787481004"));
        }
