...
pub struct ConditionProblemDiagnosisCodes;

impl ConditionProblemDiagnosisCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/condition-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "condition_code";
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "160245001" => Some("No current problems or disability"),
                _ => None,
            };
        }
        None
