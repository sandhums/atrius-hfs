...
pub struct ParticipantRoles;

impl ParticipantRoles {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/participant-role";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "participant_role";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            if matches!(code, "429577009" | "116154003" | "133932002") {
                return Some(true);
            }
            return None;
        }
