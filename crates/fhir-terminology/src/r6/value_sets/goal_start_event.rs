...
impl GoalStartEvent {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/goal-start-event";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "goal_start_event";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(
                code,
                "32485007" | "308283009" | "442137000" | "386216000"
            ));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "32485007" => Some("Admission to hospital"),
                "308283009" => Some("Discharge from hospital"),
                "442137000" => Some("Completion time of procedure"),
                "386216000" => Some("Childbirth"),
                _ => None,
            };
        }
        None
