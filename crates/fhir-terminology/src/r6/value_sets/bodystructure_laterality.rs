...
pub struct BodystructureLaterality;

impl BodystructureLaterality {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/bodystructure-laterality";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "bodystructure_laterality";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "7771000" | "24028007" | "51440002"));
        }
        None
    }
