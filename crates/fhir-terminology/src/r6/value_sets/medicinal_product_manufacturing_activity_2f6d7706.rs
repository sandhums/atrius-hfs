...
pub struct MedicinalProductManufacturingActivity;

impl MedicinalProductManufacturingActivity {
    pub const URL: &'static str =
        "http://hl7.org/fhir/ValueSet/medicinal-product-manufacturing-activity";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "medicinal_product_manufacturing_activity_2f6d7706";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["http://hl7.org/fhir/medicinal-product-manufacturing-activity"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/medicinal-product-manufacturing-activity" {
            return Some(super::super::code_systems::MedicinalProductManufacturingActivityExample::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/medicinal-product-manufacturing-activity" {
            return super::super::code_systems::MedicinalProductManufacturingActivityExample::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some(
                    "http://hl7.org/fhir/medicinal-product-manufacturing-activity".to_string(),
                ),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
