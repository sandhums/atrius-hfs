...
pub struct ParticipantResourceTypes;

impl ParticipantResourceTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/participant-resource-types";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "participant_resource_types";
