...
pub struct SNOMEDCTAnatomicalStructureAdministrationSites;

impl SNOMEDCTAnatomicalStructureAdministrationSites {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/approach-site-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "approach_site_codes";
