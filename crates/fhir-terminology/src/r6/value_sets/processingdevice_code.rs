...
pub struct ProcessingDeviceCode;

impl ProcessingDeviceCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/processingdevice-code";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "processingdevice_code";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "465735003" | "701945002"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "465735003" => Some("Sliding microtome"),
                "701945002" => Some("Blood centrifugation system processing unit"),
                _ => None,
            };
        }
        None
