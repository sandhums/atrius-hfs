...
pub struct QuestionnaireQuestionCodes;

impl QuestionnaireQuestionCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/questionnaire-questions";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "questionnaire_questions";
