...
pub struct TypesOfEdibleSubstances;

impl TypesOfEdibleSubstances {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/edible-substance-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "edible_substance_type";
