...
pub struct AllSecurityLabels;

impl AllSecurityLabels {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/security-labels";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "security_labels";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://terminology.hl7.org/ValueSet/v3-Confidentiality (not generated locally)
        any_none = true;
        // http://terminology.hl7.org/ValueSet/v3-InformationSensitivityPolicy (not generated locally)
        any_none = true;
        // http://terminology.hl7.org/ValueSet/v3-Compartment (not generated locally)
        any_none = true;
        // http://terminology.hl7.org/ValueSet/v3-SecurityIntegrityObservationValue (not generated locally)
        any_none = true;
        // http://terminology.hl7.org/ValueSet/v3-SecurityControlObservationValue (not generated locally)
        any_none = true;
        // http://terminology.hl7.org/ValueSet/v3-ActUSPrivacyLaw (not generated locally)
        any_none = true;
