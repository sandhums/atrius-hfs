...
pub struct UndesirableEffectSymptom;

impl UndesirableEffectSymptom {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/undesirable-effect-symptom";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "undesirable_effect_symptom";
