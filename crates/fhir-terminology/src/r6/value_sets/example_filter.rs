...
pub struct ACMECholCodesPlasma;

impl ACMECholCodesPlasma {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/example-filter";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "example_filter";
