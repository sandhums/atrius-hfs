...
pub struct ConsentContentCodes;

impl ConsentContentCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/consent-content-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "consent_content_code";
