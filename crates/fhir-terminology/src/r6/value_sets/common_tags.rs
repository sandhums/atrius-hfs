...
impl CommonTags {
    ...
    pub const MODULE: &'static str = "common_tags";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ObservationValue" {
            return Some(matches!(code, "SUBSETTED"));
        }
        None
    }
