...
pub struct ProcedurePerformerRoleCodes;

impl ProcedurePerformerRoleCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/performer-role";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "performer_role";
