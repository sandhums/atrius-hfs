...
pub struct CommonUCUMCodesForDuration;

impl CommonUCUMCodesForDuration {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/duration-units";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "duration_units";
