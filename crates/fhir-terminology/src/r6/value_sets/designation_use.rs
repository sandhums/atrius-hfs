...
impl DesignationUse {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/designation-use";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "designation_use";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "900000000000003001" | "900000000000013009"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "900000000000003001" => None,
                "900000000000013009" => None,
                _ => None,
            };
        }
        None
