...
//! Version Independent Resource Types
//!
...
pub struct VersionIndependentResourceTypes;

impl VersionIndependentResourceTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/version-independent-resource-types";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "version_independent_resource_types";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &["http://hl7.org/fhir/fhir-old-types"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-old-types" {
            return Some(super::super::code_systems::FHIROldTypes::try_from_code(code).is_some());
        }
        ...
        // http://hl7.org/fhir/ValueSet/resource-types
        match super::super::value_sets::resource_types::ResourceType::contains(system, code) {
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/fhir-old-types" {
            return super::super::code_systems::FHIROldTypes::try_from_code(code)
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://hl7.org/fhir/fhir-old-types".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/fhir-old-types", code)
    }
