...
pub struct PatientRelationshipType;

impl PatientRelationshipType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/relatedperson-relationshiptype";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "relatedperson_relationshiptype";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType" {
            return Some(matches!(code, "WIT"));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-RoleClass" {
            return Some(matches!(
                code,
                "NOT" | "ECON" | "NOK" | "GUARD" | "DEPEN" | "EMP" | "GUAR" | "CAREGIVER"
            ));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v2-0131" {
            return Some(matches!(code, "E" | "O" | "U"));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-RoleCode" {
            return Some(matches!(
                code,
                "INTPRTER" | "POWATT" | "DPOWATT" | "HPOWATT" | "SPOWATT" | "BILL"
            ));
        }
        None
    }
