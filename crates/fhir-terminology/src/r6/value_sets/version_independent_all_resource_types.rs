...
impl VersionIndependentResourceTypesAll {
    ...
    pub const MODULE: &'static str = "version_independent_all_resource_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/all-resource-types
        match super::super::value_sets::all_resource_types::AllResourceTypes::contains(system, code)
        {
