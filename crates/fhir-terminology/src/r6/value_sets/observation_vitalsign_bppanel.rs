...
pub struct VitalSignsBPPanel;

impl VitalSignsBPPanel {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/observation-vitalsign-bppanel";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "observation_vitalsign_bppanel";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://loinc.org" {
            return Some(matches!(code, "35094-2" | "55417-0" | "85354-9"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://loinc.org" {
            return match code {
                "35094-2" => Some("Blood pressure panel"),
                "55417-0" => Some("Short blood pressure panel"),
