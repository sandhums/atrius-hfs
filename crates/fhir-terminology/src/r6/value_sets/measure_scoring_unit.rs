...
pub struct MeasureScoringUnit;

impl MeasureScoringUnit {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/measure-scoring-unit";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "measure_scoring_unit";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "1" | "/1000.d"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://unitsofmeasure.org" {
            return match code {
                "1" => Some("Default units"),
                "/1000.d" => Some("per 1000 patient days"),
                _ => None,
            };
        }
        None
