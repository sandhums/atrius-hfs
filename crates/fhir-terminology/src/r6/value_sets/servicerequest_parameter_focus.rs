...
//! Service Request Parameter Focus Codes
//!
//! An example value set of coded concepts for identifying the type of item that order detail parameters apply to, such as a device type or medication. This is a union of the Device Type and SNOMED CT Medication Codes value sets.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct ServiceRequestParameterFocusCodes;

impl ServiceRequestParameterFocusCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/servicerequest-parameter-focus";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "servicerequest_parameter_focus";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/device-type
        match super::super::value_sets::device_type::DeviceType::contains(system, code) {
        ...
        // http://hl7.org/fhir/ValueSet/medication-codes
        match super::super::value_sets::medication_codes::SNOMEDCTMedicationCodes::contains(
            system, code,
        ) {
            Some(true) => return Some(true),
            Some(false) => {
