...
impl SignatureTypeCodes {
    ...
    pub const MODULE: &'static str = "signature_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://uri.etsi.org/01903/v1.2.2" {
            return Some(
                super::super::code_systems::ETSISignatureTypeCodes::try_from_code(code).is_some(),
            );
        }
        if system == "urn:iso-astm:E1762-95:2013" {
            return Some(
                super::super::code_systems::ASTMSignatureTypeCodes::try_from_code(code).is_some(),
            );
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://uri.etsi.org/01903/v1.2.2" {
            return super::super::code_systems::ETSISignatureTypeCodes::try_from_code(code)
                .and_then(|c| c.display());
        }
        if system == "urn:iso-astm:E1762-95:2013" {
            return super::super::code_systems::ASTMSignatureTypeCodes::try_from_code(code)
                .and_then(|c| c.display());
        }
        None
    }
