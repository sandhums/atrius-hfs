...
pub struct ProcedureReasonCodes;

impl ProcedureReasonCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/procedure-reason";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "procedure_reason";
