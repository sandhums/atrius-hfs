...
//!
//! Codes identifying the type of subject for an observation definition. Includes organisms (e.g., person, animal) and physical objects (e.g., device, surface, air).
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct ObservationSubjectType;

impl ObservationSubjectType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/observation-subject-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "observation_subject_type";
