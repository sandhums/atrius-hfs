...
pub struct FHIRDocumentTypeCodes;

impl FHIRDocumentTypeCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/doc-typecodes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "doc_typecodes";
