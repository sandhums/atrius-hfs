...
pub struct AssociatedReferenceType;

impl AssociatedReferenceType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/document-related-artifact-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "document_related_artifact_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/related-artifact-type" {
            return Some(matches!(
                code,
                "documentation" | "justification" | "citation" | "part-of"
            ));
        }
        None
    }
