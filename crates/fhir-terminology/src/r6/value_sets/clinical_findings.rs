...
pub struct SNOMEDCTClinicalFindings;

impl SNOMEDCTClinicalFindings {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/clinical-findings";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "clinical_findings";
