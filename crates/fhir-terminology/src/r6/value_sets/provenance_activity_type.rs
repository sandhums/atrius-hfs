...
//!
//! This example FHIR value set is comprised of representative activity type codes from the ISO 21089 Lifecycle Code System. The codes are intended to express the activity that a Provenance is describing.
...
impl ProvenanceActivityType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/provenance-activity-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "provenance_activity_type";
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some(
                    "http://terminology.hl7.org/CodeSystem/iso-21089-lifecycle".to_string(),
                ),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
