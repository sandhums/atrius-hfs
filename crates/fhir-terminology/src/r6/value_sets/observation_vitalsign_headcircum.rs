...
//!
//! This value set defines the set of LOINC codes considered to be appropriate for representing head circumference vital sign measurements in Observation.code.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct VitalSignsHeadCircum;

impl VitalSignsHeadCircum {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/observation-vitalsign-headcircum";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "observation_vitalsign_headcircum";
