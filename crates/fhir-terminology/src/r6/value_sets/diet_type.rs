...
pub struct DietCodes;

impl DietCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/diet-type";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "diet_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            if matches!(code, "35011000087100" | "1297276008" | "40043006") {
                return Some(true);
            }
            return None;
        }
