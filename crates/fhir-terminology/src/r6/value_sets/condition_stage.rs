...
impl ConditionStage {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/condition-stage";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "condition_stage";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            if matches!(code, "416780008") {
                return Some(true);
            }
            return None;
        }
        if system == "http://snomed.info/sct" {
            if matches!(code, "715345007") {
                return Some(true);
            }
            return None;
        }
