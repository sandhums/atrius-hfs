...
impl GroupInvolvement {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/group-involvement-set";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "group_involvement_set";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/group-involvement
        match super::super::value_sets::group_involvement_d86d9dae::GroupInvolvement::contains(
            system, code,
        ) {
