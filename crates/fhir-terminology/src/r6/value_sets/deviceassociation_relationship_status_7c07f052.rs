...
//! DeviceAssociation Relationship Status
//!
...
pub struct DeviceAssociationRelationshipStatus;

impl DeviceAssociationRelationshipStatus {
    pub const URL: &'static str =
        "http://hl7.org/fhir/ValueSet/deviceassociation-relationship-status";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "deviceassociation_relationship_status_7c07f052";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["http://hl7.org/fhir/deviceassociation-relationship-status"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/deviceassociation-relationship-status" {
            return Some(super::super::code_systems::DeviceAssociationRelationshipStatusCodes::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/deviceassociation-relationship-status" {
            return super::super::code_systems::DeviceAssociationRelationshipStatusCodes::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some(
                    "http://hl7.org/fhir/deviceassociation-relationship-status".to_string(),
                ),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
