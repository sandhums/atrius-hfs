...
//!
//! Codes for devices used for enteral formula delivery.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct DeliveryDeviceCode;

impl DeliveryDeviceCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/deliverydevice-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "deliverydevice_code";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "17102003" | "470571004"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "17102003" => Some("Nasogastric tube"),
                "470571004" => Some("Gastrostomy tube"),
                _ => None,
            };
        }
        None
