...
impl ContextOfUseValueSet {
    ...
    pub const MODULE: &'static str = "use_context";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://terminology.hl7.org/ValueSet/v2-0265 (not generated locally)
        any_none = true;
        // http://hl7.org/fhir/ValueSet/administrative-gender
        match super::super::value_sets::administrative_gender_0329d1dd::AdministrativeGender::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/condition-code
        match super::super::value_sets::condition_code::ConditionProblemDiagnosisCodes::contains(
            system, code,
        ) {
            Some(true) => return Some(true),
            Some(false) => {
        ...
        // http://terminology.hl7.org/ValueSet/v3-ActEncounterCode (not generated locally)
        any_none = true;
        // http://terminology.hl7.org/ValueSet/v3-ActTaskCode (not generated locally)
        any_none = true;
        // http://hl7.org/fhir/ValueSet/usage-context-agreement-scope
        match super::super::value_sets::usage_context_agreement_scope_c4408204::UsageContextAgreementScope::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
