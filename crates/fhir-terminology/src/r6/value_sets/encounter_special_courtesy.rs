...
pub struct SpecialCourtesy;

impl SpecialCourtesy {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/encounter-special-courtesy";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "encounter_special_courtesy";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-EncounterSpecialCourtesy" {
            return Some(matches!(code, "EXT" | "NRM" | "PRF" | "STF" | "VIP"));
        }
