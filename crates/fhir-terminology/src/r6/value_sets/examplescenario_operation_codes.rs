...
pub struct ExampleScenarioOperationCode;

impl ExampleScenarioOperationCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/examplescenario-operation-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "examplescenario_operation_codes";
