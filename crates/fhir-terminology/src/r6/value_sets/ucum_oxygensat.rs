...
//!
//! UCUM units for recording oxygen saturation.
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct OxygenSaturationUnits;

impl OxygenSaturationUnits {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/ucum-oxygensat";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "ucum_oxygensat";
