...
pub struct ProcedureCodesSNOMEDCT;

impl ProcedureCodesSNOMEDCT {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/procedure-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "procedure_code";
