...
pub struct SubstanceProductAndConditionAndNegationCodes;

impl SubstanceProductAndConditionAndNegationCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/allergyintolerance-code";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "allergyintolerance_code";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/substance-code
        match super::super::value_sets::substance_code::SubstanceCode::contains(system, code) {
