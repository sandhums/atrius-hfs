...
pub struct BodyLengthUnits;

impl BodyLengthUnits {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/ucum-bodylength";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "ucum_bodylength";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "cm" | "[in_i]"));
        }
        None
    }
