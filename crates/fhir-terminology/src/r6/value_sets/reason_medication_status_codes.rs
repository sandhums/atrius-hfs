...
pub struct SNOMEDCTDrugTherapyStatusCodes;

impl SNOMEDCTDrugTherapyStatusCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/reason-medication-status-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "reason_medication_status_codes";
