...
pub struct SNOMEDCTAdditionalDosageInstructions;

impl SNOMEDCTAdditionalDosageInstructions {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/additional-instruction-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "additional_instruction_codes";
