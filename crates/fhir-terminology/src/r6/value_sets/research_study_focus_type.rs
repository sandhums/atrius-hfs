...
impl ResearchStudyFocusType {
    ...
    pub const MODULE: &'static str = "research_study_focus_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "372567009" | "271062006" | "228557008"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "372567009" => Some("Metformin"),
                "271062006" => Some("Fasting blood glucose measurement"),
                "228557008" => Some("Cognitive and behavioral therapy"),
                _ => None,
            };
        }
        None
