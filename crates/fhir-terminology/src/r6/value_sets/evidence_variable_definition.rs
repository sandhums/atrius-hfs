...
impl EvidenceVariableDefinition {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/evidence-variable-definition";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "evidence_variable_definition";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "182886004" | "419620001"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "182886004" => Some("Placebo given (situation)"),
                "419620001" => Some("Death (event)"),
                _ => None,
            };
        }
        None
