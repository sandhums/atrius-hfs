...
pub struct CodesForProductCharacteristics;

impl CodesForProductCharacteristics {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/measurement-property";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "measurement_property";
