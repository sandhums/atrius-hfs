...
pub struct DetectedIssueManagementCodeExample;

impl DetectedIssueManagementCodeExample {
    pub const URL: &'static str =
        "http://hl7.org/fhir/ValueSet/detectedissue-management-code-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "detectedissue_management_code_example_6ce86149";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["http://hl7.org/fhir/detectedissue-management-code-example"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/detectedissue-management-code-example" {
            return Some(
                super::super::code_systems::DetectedIssueManagementCodeExample::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/detectedissue-management-code-example" {
            return super::super::code_systems::DetectedIssueManagementCodeExample::try_from_code(
                code,
            )
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some(
                    "http://hl7.org/fhir/detectedissue-management-code-example".to_string(),
                ),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
