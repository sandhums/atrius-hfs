...
pub struct SupplementedMimeTypes;

impl SupplementedMimeTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/supplemented-mimetypes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "supplemented_mimetypes";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] =
        &["urn:ietf:bcp:13", "http://hl7.org/fhir/simple-format-codes"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/simple-format-codes" {
            return Some(
                super::super::code_systems::SimpleFormatCodes::try_from_code(code).is_some(),
            );
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/simple-format-codes" {
            return super::super::code_systems::SimpleFormatCodes::try_from_code(code)
