...
pub struct AuditEventIDExample;

impl AuditEventIDExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/audit-event-type-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "audit_event_type_example";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_400.html (not generated locally)
        any_none = true;
