...
impl InteractionTrigger {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/interaction-trigger";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "interaction_trigger";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return Some(matches!(code, "create" | "update" | "delete"));
        }
        None
    }
