...
pub struct SecurityLabelDataExamples;

impl SecurityLabelDataExamples {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/security-label-data-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "security_label_data_example";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality" {
            return Some(matches!(code, "N" | "R"));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-ActCode" {
            return Some(matches!(code, "ETH" | "PSY" | "STD"));
        }
        None
    }
