...
pub struct UndesirableEffectClassification;

impl UndesirableEffectClassification {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/undesirable-effect-classification";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "undesirable_effect_classification";
