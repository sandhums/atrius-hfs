...
pub struct SNOMEDCTAdministrationMethodCodes;

impl SNOMEDCTAdministrationMethodCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/administration-method-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "administration_method_codes";
