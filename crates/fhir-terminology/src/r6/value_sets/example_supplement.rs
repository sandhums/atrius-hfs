...
//!
//! ACME Codes for Cholesterol: Plasma only - demonstrating the use of a supplement defined in a CodeSystem
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct ACMECholCodesPlasmaSupplemented;

impl ACMECholCodesPlasmaSupplemented {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/example-supplement";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "example_supplement";
