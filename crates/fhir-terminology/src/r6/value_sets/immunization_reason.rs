...
pub struct ImmunizationReasonCodes;

impl ImmunizationReasonCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-reason";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "immunization_reason";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "429060002" | "14747002"));
        }
        None
    }
