...
pub struct SNOMEDCTRouteCodes;

impl SNOMEDCTRouteCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/route-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "route_codes";
