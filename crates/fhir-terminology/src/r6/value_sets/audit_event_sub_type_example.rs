...
pub struct AuditEventSubTypeExample;

impl AuditEventSubTypeExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/audit-event-sub-type-example";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "audit_event_sub_type_example";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return Some(
                super::super::code_systems::FHIRRestfulInteractions::try_from_code(code).is_some(),
            );
        }
        ...
        // http://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_401.html (not generated locally)
        any_none = true;
        // http://dicom.nema.org/medical/dicom/current/output/chtml/part16/sect_CID_403.html (not generated locally)
        any_none = true;
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return super::super::code_systems::FHIRRestfulInteractions::try_from_code(code)
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("http://hl7.org/fhir/restful-interaction".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/restful-interaction", code)
    }
