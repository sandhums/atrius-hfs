...
pub struct CommonUCUMCodesForDistance;

impl CommonUCUMCodesForDistance {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/distance-units";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "distance_units";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://unitsofmeasure.org" {
            return Some(matches!(code, "nm" | "um" | "mm" | "m" | "km"));
        }
        None
    }
