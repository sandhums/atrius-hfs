...
//! RelativeTime Codes
//!
//! Example Codes to illustrate the use of RelativeTime.contextCode
use crate::TerminologyValidationError;
use helios_fhir::r6::{CodeableConcept, Coding};

pub struct RelativeTimeCodes;

impl RelativeTimeCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/relativetime-codes";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "relativetime_codes";
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        ...
        if system == "http://snomed.info/sct" {
            return match code {
                "129018004" => Some("Traveling"),
                "261041009" => Some("Working"),
                "712823008" => Some("Acute depression"),
                "871840004" => Some("Depressive episode"),
                _ => None,
            };
        }
        None
