...
impl AdverseEventMitigatingAction {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/adverse-event-mitigating-action";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "adverse_event_mitigating_action";
