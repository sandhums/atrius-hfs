...
pub struct ConditionDiagnosisSeverity;

impl ConditionDiagnosisSeverity {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/condition-severity";
    pub const VERSION: &'static str = "6.0.0-ballot4";
    pub const MODULE: &'static str = "condition_severity";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "24484000" | "6736007" | "255604002"));
        }
        None
    }
