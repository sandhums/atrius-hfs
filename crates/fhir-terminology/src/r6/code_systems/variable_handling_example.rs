...
pub enum EvidenceVariableHandlingExample {
    Boolean,
    Continuous,
    Dichotomous,
    Ordinal,
...
impl EvidenceVariableHandlingExample {
    pub const URL: &'static str = "http://hl7.org/fhir/variable-handling-example";
    ...
    pub fn as_code(self) -> &'static str {
        match self {
            ...
            Self::TimeToEvent => "time-to-event",
    ...
    pub fn try_from_code(code: &str) -> Option<Self> {
        Some(match code {
            ...
            "time-to-event" => Self::TimeToEvent,
    ...
    pub fn display(self) -> Option<&'static str> {
        match self {
            Self::Boolean => Some("boolean variable"),
