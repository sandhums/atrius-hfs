...
pub enum SecurityStructuralRolesExamples {
...
impl SecurityStructuralRolesExamples {
    pub const URL: &'static str = "http://hl7.org/fhir/security-structural-roles-example";
