...
impl IssueType {
    ...
    pub fn try_from_code(code: &str) -> Option<Self> {
        Some(match code {
            ...
            "limited-filter" => Self::LimitedFilter,
    ...
    pub fn display(self) -> Option<&'static str> {
        match self {
            ...
            Self::LimitedFilter => Some("Limited Filter Application"),
            ...
            Self::Success => Some("Operation Successful"),
        }
    }
    ...
    pub fn parent_code(self) -> Option<&'static str> {
        match self {
            ...
            Self::LimitedFilter => Some("processing"),
            Self::Transient => None,
