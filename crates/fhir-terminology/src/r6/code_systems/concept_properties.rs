...
impl ConceptProperties {
    ...
    pub fn as_code(self) -> &'static str {
        match self {
            ...
            Self::LastVersionPresent => "lastVersionPresent",
    ...
    pub fn try_from_code(code: &str) -> Option<Self> {
        Some(match code {
            ...
            "lastVersionPresent" => Self::LastVersionPresent,
    ...
    pub fn display(self) -> Option<&'static str> {
        match self {
            ...
            Self::LastVersionPresent => Some("LastVersionPresent"),
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            ...
            Self::LastVersionPresent => Some(
                "The value of the property is the version of the code system where the concept was last known to be present. This property is used in value set expansions to indicate concepts that are explicitly referenced in value set definitions but are no longer present in the code system version being used for the expansion. See the includeLastVersionPresent parameter in the Canonical Resource Management Infrastructure specialization of the ValueSet/$expand operation for a description of when this parameter is used. This property will only appear in expansions because it describes concepts that are not in the code system version used in the $expand.",
            ),
