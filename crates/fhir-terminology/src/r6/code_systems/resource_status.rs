...
impl FHIRCanonicalStatusCodes {
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            ...
            Self::Ended => Some(
                "The process described/requested has reached a state where no further action is planned",
            ),
            Self::Complete => Some(
            ...
            Self::BehindTarget => Some("Behind the planned timelines"),
            Self::NotReady => Some("Not ready to act"),
    ...
    pub fn parent_code(self) -> Option<&'static str> {
        match self {
            ...
            Self::Replaced => None,
            Self::Ended => None,
            Self::Complete => Some("ended"),
            Self::Failed => Some("ended"),
            Self::Abandoned => Some("ended"),
            Self::Inactive => None,
            Self::Unknown => None,
