...
pub struct CarePlanActivityOutcome;

impl CarePlanActivityOutcome {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/care-plan-activity-outcome";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "care_plan_activity_outcome";
