...
pub struct FocalSubjectCodes;

impl FocalSubjectCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/focal-subject";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "focal_subject";
