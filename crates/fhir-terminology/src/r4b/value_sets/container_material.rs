...
impl ContainerMaterials {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/container-material";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "container_material";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "32039001" | "61088005" | "425620007"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "32039001" => Some("glass"),
                "61088005" => Some("plastic"),
                "425620007" => Some("metal"),
                _ => None,
            };
        }
        None
