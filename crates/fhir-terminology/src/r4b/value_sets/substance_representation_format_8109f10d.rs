...
impl SubstanceRepresentationFormat {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/substance-representation-format" {
            return Some(
                super::super::code_systems::SubstanceRepresentationFormat::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/substance-representation-format" {
            return super::super::code_systems::SubstanceRepresentationFormat::try_from_code(code)
