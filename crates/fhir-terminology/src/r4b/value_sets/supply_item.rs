...
pub struct SNOMEDCTSupplyItem;

impl SNOMEDCTSupplyItem {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/supply-item";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "supply_item";
