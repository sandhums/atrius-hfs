...
impl ObjectLifecycleEvents {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/object-lifecycle-events";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "object_lifecycle_events";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/dicom-audit-lifecycle" {
            return Some(
                super::super::code_systems::DICOMAuditMessageRecordLifecycleEvents::try_from_code(
                    code,
                )
                .is_some(),
            );
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/dicom-audit-lifecycle" {
            return super::super::code_systems::DICOMAuditMessageRecordLifecycleEvents::try_from_code(code).and_then(|c| c.display());
        }
        if system == "http://terminology.hl7.org/CodeSystem/iso-21089-lifecycle" {
