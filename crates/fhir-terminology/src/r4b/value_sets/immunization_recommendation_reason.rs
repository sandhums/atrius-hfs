...
pub struct ImmunizationRecommendationReasonCodes;

impl ImmunizationRecommendationReasonCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-recommendation-reason";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "immunization_recommendation_reason";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "77176002" | "77386006"));
        }
        None
    }
