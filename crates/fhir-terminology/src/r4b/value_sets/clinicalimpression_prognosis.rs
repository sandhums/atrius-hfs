...
pub struct ClinicalImpressionPrognosis;

impl ClinicalImpressionPrognosis {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/clinicalimpression-prognosis";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "clinicalimpression_prognosis";
