...
impl ObservationCategoryCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/observation-category" {
            return Some(
                super::super::code_systems::ObservationCategoryCodes::try_from_code(code).is_some(),
            );
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/observation-category" {
            return super::super::code_systems::ObservationCategoryCodes::try_from_code(code)
