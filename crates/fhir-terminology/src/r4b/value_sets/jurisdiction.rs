...
pub struct JurisdictionValueSet;

impl JurisdictionValueSet {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/jurisdiction";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "jurisdiction";
