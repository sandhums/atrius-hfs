...
impl CarePlanIntent {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/care-plan-intent";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "care_plan_intent";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/request-intent" {
            return Some(matches!(code, "proposal" | "plan" | "order" | "option"));
        }
        None
    }
