...
impl ElementTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/fhir-element-types";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "fhir_element_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/CodeSystem/fhirpath-types" {
            return Some(super::super::code_systems::FHIRPathTypes::try_from_code(code).is_some());
        }
        ...
        // http://hl7.org/fhir/ValueSet/defined-types
        match super::super::value_sets::defined_types::FHIRDefinedType::contains(system, code) {
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/CodeSystem/fhirpath-types" {
            return super::super::code_systems::FHIRPathTypes::try_from_code(code)
