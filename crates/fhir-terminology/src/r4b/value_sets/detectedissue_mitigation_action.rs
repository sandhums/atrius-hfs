...
pub struct DetectedIssueMitigationAction;

impl DetectedIssueMitigationAction {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/detectedissue-mitigation-action";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "detectedissue_mitigation_action";
