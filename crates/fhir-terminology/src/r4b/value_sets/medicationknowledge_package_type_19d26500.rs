...
impl MedicationKnowledgePackageTypeCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/medicationknowledge-package-type" {
            return Some(
                super::super::code_systems::MedicationKnowledgePackageTypeCodes::try_from_code(
                    code,
                )
                .is_some(),
            );
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/medicationknowledge-package-type" {
            return super::super::code_systems::MedicationKnowledgePackageTypeCodes::try_from_code(
                code,
            )
