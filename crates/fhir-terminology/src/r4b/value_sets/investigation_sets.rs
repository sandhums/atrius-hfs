...
impl InvestigationType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/investigation-sets";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "investigation_sets";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "271336007" | "160237006"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "271336007" => Some("Examination / signs"),
                "160237006" => Some("History/symptoms"),
                _ => None,
            };
        }
        None
