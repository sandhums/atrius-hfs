...
impl RegulatedAuthorizationCaseType {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/regulated-authorization-case-type" {
            return Some(
                super::super::code_systems::RegulatedAuthorizationCaseType::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/regulated-authorization-case-type" {
            return super::super::code_systems::RegulatedAuthorizationCaseType::try_from_code(code)
