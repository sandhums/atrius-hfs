...
pub struct CodesForNutritionProductNutrients;

impl CodesForNutritionProductNutrients {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/nutrition-product-nutrient";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "nutrition_product_nutrient";
