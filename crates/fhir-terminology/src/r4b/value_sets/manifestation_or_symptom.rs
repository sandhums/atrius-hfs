...
pub struct ManifestationAndSymptomCodes;

impl ManifestationAndSymptomCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/manifestation-or-symptom";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "manifestation_or_symptom";
