...
pub struct DataElementSDCObjectClass;

impl DataElementSDCObjectClass {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/dataelement-sdcobjectclassproperty";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "dataelement_sdcobjectclassproperty";
