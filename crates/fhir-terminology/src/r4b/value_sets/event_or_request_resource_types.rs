...
impl EventOrRequestResourceTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/event-or-request-resource-types";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "event_or_request_resource_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/event-resource-types
        match super::super::value_sets::event_resource_types_884f4fa4::EventResourceType::contains(
            system, code,
        ) {
        ...
        // http://hl7.org/fhir/ValueSet/request-resource-types
        match super::super::value_sets::request_resource_types_30200337::RequestResourceType::contains(system, code) {
            Some(true) => return Some(true),
