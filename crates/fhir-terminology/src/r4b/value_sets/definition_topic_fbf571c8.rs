...
impl DefinitionTopic {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/definition-topic";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "definition_topic_fbf571c8";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/definition-topic" {
            return Some(
                super::super::code_systems::DefinitionTopic::try_from_code(code).is_some(),
            );
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/definition-topic" {
            return super::super::code_systems::DefinitionTopic::try_from_code(code)
