...
pub struct MediaCollectionViewProjection;

impl MediaCollectionViewProjection {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/media-view";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "media_view";
