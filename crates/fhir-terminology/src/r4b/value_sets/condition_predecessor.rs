...
pub struct ConditionPredecessorCodes;

impl ConditionPredecessorCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/condition-predecessor";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "condition_predecessor";
