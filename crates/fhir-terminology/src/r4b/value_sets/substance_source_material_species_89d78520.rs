...
impl SourceMaterialSpecies {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/substance-source-material-species" {
            return Some(
                super::super::code_systems::SubstanceSourceMaterialSpecies::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/substance-source-material-species" {
            return super::super::code_systems::SubstanceSourceMaterialSpecies::try_from_code(code)
