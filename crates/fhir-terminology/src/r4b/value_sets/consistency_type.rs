...
pub struct FluidConsistencyTypeCodes;

impl FluidConsistencyTypeCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/consistency-type";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "consistency_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(
                code,
                "439031000124108" | "439021000124105" | "439041000124103" | "439081000124109"
            ));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "439031000124108" => Some("honey thick liquid"),
                "439021000124105" => Some("nectar thick liquid"),
                "439041000124103" => Some("spoon thick liquid"),
                "439081000124109" => Some("thin liquid"),
                _ => None,
            };
        }
        None
