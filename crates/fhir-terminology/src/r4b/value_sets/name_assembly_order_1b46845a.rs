...
impl HumanNameAssemblyOrder {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/name-assembly-order";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "name_assembly_order_1b46845a";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/name-assembly-order" {
            return Some(
                super::super::code_systems::HumanNameAssemblyOrder::try_from_code(code).is_some(),
            );
        }
        if system == "http://terminology.hl7.org/CodeSystem/v2-0444" {
            return Some(matches!(code, "F" | "G"));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-NullFlavor" {
            return Some(matches!(code, "UNK"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/name-assembly-order" {
            return super::super::code_systems::HumanNameAssemblyOrder::try_from_code(code)
                .and_then(|c| c.display());
        }
        if system == "http://terminology.hl7.org/CodeSystem/v2-0444" {
            return match code {
                "F" => Some("Prefix Family Given Suffix"),
                "G" => Some("Prefix Given Family Suffix"),
                _ => None,
            };
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-NullFlavor" {
