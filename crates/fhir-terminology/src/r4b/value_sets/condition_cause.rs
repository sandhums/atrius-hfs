...
pub struct ConditionCauseCodes;

impl ConditionCauseCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/condition-cause";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "condition_cause";
