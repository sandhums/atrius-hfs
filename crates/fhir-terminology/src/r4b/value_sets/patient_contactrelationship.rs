...
pub struct PatientContactRelationship;

impl PatientContactRelationship {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/patient-contactrelationship";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "patient_contactrelationship";
