...
pub struct DeviceMetricAndComponentTypes;

impl DeviceMetricAndComponentTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/devicemetric-type";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "devicemetric_type";
