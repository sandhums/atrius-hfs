...
impl Laterality {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/bodysite-laterality";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "bodysite_laterality";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "419161000" | "419465000" | "51440002"));
        }
        None
    }
