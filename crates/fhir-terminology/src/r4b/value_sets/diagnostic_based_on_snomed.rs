...
pub struct DiagnosticAttachmentType;

impl DiagnosticAttachmentType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/diagnostic-based-on-snomed";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "diagnostic_based_on_snomed";
