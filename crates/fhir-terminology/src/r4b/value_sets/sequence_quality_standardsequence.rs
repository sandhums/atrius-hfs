...
pub struct FDAStandardSequence;

impl FDAStandardSequence {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/sequence-quality-standardSequence";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "sequence_quality_standardsequence";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &["https://precision.fda.gov/files/"];
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            ...
            Some(false) => Err(TerminologyValidationError::NotInValueSet {
                valueset_url: Self::URL.to_string(),
                system: Some("https://precision.fda.gov/files/".to_string()),
                code: code.to_string(),
            }),
            None => Err(TerminologyValidationError::RemoteValidationRequired(
                "Remote terminology validation required".to_string(),
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("https://precision.fda.gov/files/", code)
    }
