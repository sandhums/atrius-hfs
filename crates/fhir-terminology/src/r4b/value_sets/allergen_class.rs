...
pub struct CodesForAllergenClasses;

impl CodesForAllergenClasses {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/allergen-class";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "allergen_class";
