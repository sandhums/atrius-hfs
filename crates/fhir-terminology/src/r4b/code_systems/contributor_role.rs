...
impl ContributorRole {
    pub const URL: &'static str = "http://terminology.hl7.org/CodeSystem/contributor-role";
    ...
    pub fn display(self) -> Option<&'static str> {
        match self {
            ...
            Self::Author => Some("Author/Creator"),
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            ...
            Self::Funder => Some("Entity that supplies financial support"),
        }
    }
