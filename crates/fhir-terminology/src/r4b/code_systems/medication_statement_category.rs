...
pub enum MedicationStatementCategoryCodes {
    Inpatient,
    Outpatient,
    Community,
    Patientspecified,
...
impl MedicationStatementCategoryCodes {
    ...
    pub fn try_from_code(code: &str) -> Option<Self> {
        Some(match code {
            ...
            "patientspecified" => Self::Patientspecified,
            _ => return None,
        })
    }
    ...
    pub fn display(self) -> Option<&'static str> {
        match self {
            ...
            Self::Patientspecified => Some("Patient Specified"),
        }
    }
