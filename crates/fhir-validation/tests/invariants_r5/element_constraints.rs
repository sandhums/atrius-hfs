...
use crate::common::fixtures::{assert_has_invariant_expression, load_resource, local_terminology_r5};
...
fn patient_empty_human_name_violates_ele1() {
    let r = load_resource(FhirVersion::R5, "invalid/patient/patient-empty_name_ele1.json");
