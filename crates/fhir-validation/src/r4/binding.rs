//! Binding validation for FHIR r4.
//!
//! This module implements ValueSet binding validation for generated r4 resources.
//!
//! Supported binding target kinds (per FHIR `ElementDefinition.binding`):
//! - primitives `code`, `string`, `uri`
//! - `Coding`, `CodeableConcept`, `Quantity`
...
use fhir_terminology::r4::index as terminology_index;
use fhir_validation_types::{BindingDef, BindingTargetKind};
use helios_fhir::r4::{CodeableConcept, Coding, Quantity};
use serde::Serialize;
use serde_json::Value;

/// R4 has no `CodeableReference`; used only for uniform binding dispatch signatures.
pub enum NeverCodeableReference {}

struct R4BindingChoiceProbe;

impl BindingChoiceProbe for R4BindingChoiceProbe {
    ...
    fn parse_codeable_reference(_value: &Value) -> bool {
        false
    }
...
struct R4BindingAdapter;

impl BindingVersionAdapter for R4BindingAdapter {
    type Coding = Coding;
    type CodeableConcept = CodeableConcept;
    type Quantity = Quantity;
    type CodeableReference = NeverCodeableReference;
...
impl BindingTerminologyHooks for R4BindingAdapter {
    const SUPPORTS_CODEABLE_REFERENCE: bool = false;
    ...
    fn parse_codeable_reference(_field_value: &Value) -> Option<NeverCodeableReference> {
        None
    }
}
...
{
    crate::binding::validators::validate_primitive_code_binding::<R4BindingAdapter, F>(
        ctx,
        code_value,
        implicit_system,
        local_check,
...
where
    F: Fn(&str) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_primitive_value_binding::<R4BindingAdapter, F>(
        ctx,
        value,
        local_check,
    )
...
where
    F: Fn(&str) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_primitive_code_binding_async::<R4BindingAdapter, F>(
        ctx,
        code,
        implicit_system,
        local_check,
...
where
    F: Fn(&str) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_primitive_value_binding_async::<R4BindingAdapter, F>(
        ctx,
        value,
        local_check,
    )
...
{
    crate::binding::validators::validate_quantity_binding::<R4BindingAdapter, F>(
        ctx,
        quantity,
        local_check,
    )
...
where
    F: Fn(&Quantity) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_quantity_binding_async::<R4BindingAdapter, F>(
        ctx,
        quantity,
        local_check,
    )
...
{
    crate::binding::validators::validate_coding_binding::<R4BindingAdapter, F>(
        ctx,
        coding,
        local_check,
    )
...
where
    F: Fn(&Coding) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_coding_binding_async::<R4BindingAdapter, F>(
        ctx,
        coding,
        local_check,
    )
...
{
    crate::binding::validators::validate_codeable_concept_binding::<R4BindingAdapter, F>(
        ctx,
        codeable_concept,
        local_check,
    )
...
where
    F: Fn(&CodeableConcept) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_codeable_concept_binding_async::<R4BindingAdapter, F>(
        ctx,
        codeable_concept,
        local_check,
    )
...
pub fn validate_codeable_reference_binding<F>(
    ctx: &BindingCheckContextSync<'_>,
    codeable_reference: Option<&NeverCodeableReference>,
    local_check: F,
) -> Vec<ValidationIssue>
where
    F: Fn(&CodeableConcept) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_codeable_reference_binding::<R4BindingAdapter, F>(
        ctx,
        codeable_reference,
        local_check,
    )
...
where
    F: Fn(&CodeableConcept) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_codeable_reference_binding_async::<R4BindingAdapter, F>(
        ctx,
        codeable_reference,
        local_check,
    )
...
fn apply_r4_binding_sync_single(
    validator: &Validator,
    binding: &BindingDef,
    field_value: &Value,
    ...
    apply_binding_sync_single::<R4BindingAdapter>(
        validator,
        binding,
        field_value,
        kind,
...
async fn apply_r4_binding_async_single(
    validator: &Validator,
    binding: &BindingDef,
    field_value: &Value,
    kind: BindingTargetKind,
    ...
    apply_binding_async_single::<R4BindingAdapter>(
        validator,
        binding,
        field_value,
        kind,
...
/// Apply binding validation to a serialized r4 resource.
    ...
    T: Serialize,
{
    apply_bindings_sync(
        ...
        bindings,
        terminology,
        infer_choice_kind::<R4BindingChoiceProbe>,
        apply_r4_binding_sync_single,
    )
}

crate::define_apply_bindings_async! {
    /// Async binding dispatcher for r4 resources.
    apply_r4_bindings_async,
    R4BindingChoiceProbe,
    apply_r4_binding_async_single,
}
