...
use fhir_terminology::r6::index as terminology_index;
...
struct R6BindingChoiceProbe;

impl BindingChoiceProbe for R6BindingChoiceProbe {
...
impl BindingVersionAdapter for R6BindingAdapter {
    ...
    crate::impl_binding_version_adapter_rebuild! {
        helios_fhir::r6::Code,
        helios_fhir::r6::String,
        Coding,
        CodeableConcept
    }
}

impl BindingTerminologyHooks for R6BindingAdapter {
...
{
    crate::binding::validators::validate_primitive_code_binding::<R6BindingAdapter, F>(
        ctx,
        code_value,
        implicit_system,
        local_check,
...
where
    F: Fn(&str) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_primitive_value_binding::<R6BindingAdapter, F>(
        ctx,
        value,
        local_check,
    )
...
where
    F: Fn(&str) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_primitive_code_binding_async::<R6BindingAdapter, F>(
        ctx,
        code,
        implicit_system,
        local_check,
...
where
    F: Fn(&str) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_primitive_value_binding_async::<R6BindingAdapter, F>(
        ctx,
        value,
        local_check,
    )
...
{
    crate::binding::validators::validate_quantity_binding::<R6BindingAdapter, F>(
        ctx,
        quantity,
        local_check,
    )
...
where
    F: Fn(&Quantity) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_quantity_binding_async::<R6BindingAdapter, F>(
        ctx,
        quantity,
        local_check,
    )
...
{
    crate::binding::validators::validate_coding_binding::<R6BindingAdapter, F>(
        ctx,
        coding,
        local_check,
    )
...
where
    F: Fn(&Coding) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_coding_binding_async::<R6BindingAdapter, F>(
        ctx,
        coding,
        local_check,
    )
...
{
    crate::binding::validators::validate_codeable_concept_binding::<R6BindingAdapter, F>(
        ctx,
        codeable_concept,
        local_check,
    )
...
where
    F: Fn(&CodeableConcept) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_codeable_concept_binding_async::<R6BindingAdapter, F>(
        ctx,
        codeable_concept,
        local_check,
    )
...
where
    F: Fn(&CodeableConcept) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_codeable_reference_binding::<R6BindingAdapter, F>(
        ctx,
        codeable_reference,
        local_check,
    )
...
where
    F: Fn(&CodeableConcept) -> Result<(), fhir_terminology::TerminologyValidationError>,
{
    crate::binding::validators::validate_codeable_reference_binding_async::<R6BindingAdapter, F>(
        ctx,
        codeable_reference,
        local_check,
    )
...
fn apply_r6_binding_sync_single(
    ...
    apply_binding_sync_single::<R6BindingAdapter>(
        validator,
        binding,
        field_value,
        kind,
...
async fn apply_r6_binding_async_single(
    ...
    apply_binding_async_single::<R6BindingAdapter>(
        validator,
        binding,
        field_value,
        kind,
    ...
    T: Serialize,
{
    apply_bindings_sync(
        ...
        bindings,
        terminology,
        infer_choice_kind::<R6BindingChoiceProbe>,
        apply_r6_binding_sync_single,
    )
}

crate::define_apply_bindings_async! {
    /// Async binding dispatcher for r6 resources.
    apply_r6_bindings_async,
    R6BindingChoiceProbe,
    apply_r6_binding_async_single,
}
