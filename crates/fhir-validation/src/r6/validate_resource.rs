...
#[cfg(feature = "R6")]
pub fn validate_r6_resource_with_validation_addons(
    validator: &Validator,
    resource: &helios_fhir::r6::Resource,
    terminology: Option<&dyn TerminologyServiceSync>,
    evaluator: &dyn FhirPathEvaluator,
...
#[cfg(feature = "R6")]
pub fn validate_r6_resource_with_profiles_and_validation_addons(
    validator: &Validator,
    resource: &helios_fhir::r6::Resource,
    terminology: Option<&dyn TerminologyServiceSync>,
    evaluator: &dyn FhirPathEvaluator,
    ...
    let mut issues = validate_r6_resource_with_profiles(
        validator,
        resource,
        terminology,
        evaluator,
...
#[cfg(feature = "R6")]
pub async fn validate_r6_resource_async_with_validation_addons(
    validator: &Validator,
    resource: &helios_fhir::r6::Resource,
    terminology: Option<&dyn TerminologyService>,
    evaluator: &dyn FhirPathEvaluator,
...
#[cfg(feature = "R6")]
pub async fn validate_r6_resource_async_with_profiles_and_validation_addons(
    validator: &Validator,
    resource: &helios_fhir::r6::Resource,
    terminology: Option<&dyn TerminologyService>,
    evaluator: &dyn FhirPathEvaluator,
    ...
    let mut issues = validate_r6_resource_async_with_profiles(
        validator,
        resource,
        terminology,
        evaluator,
