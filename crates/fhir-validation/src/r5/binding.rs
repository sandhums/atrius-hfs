...
struct R5BindingChoiceProbe;

impl BindingChoiceProbe for R5BindingChoiceProbe {
...
impl BindingVersionAdapter for R5BindingAdapter {
    ...
    crate::impl_binding_version_adapter_rebuild! {
        helios_fhir::r5::Code,
        helios_fhir::r5::String,
        Coding,
        CodeableConcept
    }
}

impl BindingTerminologyHooks for R5BindingAdapter {
...
fn apply_r5_binding_sync_single(
    ...
    apply_binding_sync_single::<R5BindingAdapter>(
        validator,
        binding,
        field_value,
        kind,
...
async fn apply_r5_binding_async_single(
    ...
    apply_binding_async_single::<R5BindingAdapter>(
        validator,
        binding,
        field_value,
        kind,
    ...
    T: Serialize,
{
    apply_bindings_sync(
        ...
        bindings,
        terminology,
        infer_choice_kind::<R5BindingChoiceProbe>,
        apply_r5_binding_sync_single,
    )
}

crate::define_apply_bindings_async! {
    /// Async binding dispatcher for r5 resources.
    apply_r5_bindings_async,
    R5BindingChoiceProbe,
    apply_r5_binding_async_single,
}
