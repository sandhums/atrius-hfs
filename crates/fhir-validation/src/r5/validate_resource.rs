...
pub fn validate_r5_resource(
    ...
    let mut issues = validator.validate_r5_resource_bindings(resource, terminology);
    issues.extend(validator.validate_r5_resource_invariants(resource, evaluator));
    issues
}
...
#[cfg(feature = "R5")]
pub fn validate_r5_resource_with_profiles(
    validator: &Validator,
    resource: &helios_fhir::r5::Resource,
    terminology: Option<&dyn TerminologyServiceSync>,
    evaluator: &dyn FhirPathEvaluator,
    ...
    issues.extend(validate_r5_declared_profiles(
        validator,
        resource,
        terminology,
        evaluator,
...
#[cfg(feature = "R5")]
pub async fn validate_r5_manifest_profiles_async(
    validator: &Validator,
    resource: &helios_fhir::r5::Resource,
    terminology: Option<&dyn TerminologyService>,
    evaluator: &dyn FhirPathEvaluator,
...
#[cfg(feature = "R5")]
pub async fn validate_r5_manifest_profiles_with_addons_async(
    validator: &Validator,
    resource: &helios_fhir::r5::Resource,
    terminology: Option<&dyn TerminologyService>,
    evaluator: &dyn FhirPathEvaluator,
    ...
    let mut issues = validate_r5_declared_profiles_async(
        validator,
        resource,
        terminology,
        evaluator,
...
#[cfg(feature = "R5")]
fn validate_r5_declared_profiles(
    validator: &Validator,
    resource: &helios_fhir::r5::Resource,
    terminology: Option<&dyn TerminologyServiceSync>,
    evaluator: &dyn FhirPathEvaluator,
...
#[cfg(feature = "R5")]
async fn validate_r5_declared_profiles_async(
    validator: &Validator,
    resource: &helios_fhir::r5::Resource,
    terminology: Option<&dyn TerminologyService>,
    evaluator: &dyn FhirPathEvaluator,
