...
impl AnimalSpecies {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/animal-species";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "animal_species_b76de8ac";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "125097000" | "125099002" | "34618005" | "425134008" | "47290002" | "15778005" | "396620009" | "388445009" | "85626006" | "132950000"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "125097000" => Some("goat"),
                "125099002" => Some("sheep"),
                "34618005" => Some("cow"),
                "425134008" => Some("turkey"),
                "47290002" => Some("chicken"),
                "15778005" => Some("goose"),
                "396620009" => Some("duck"),
                "388445009" => Some("horse"),
                "85626006" => Some("donkey"),
                "132950000" => Some("mule"),
                _ => None,
            };
        }
