...
pub struct ProcedureFollowUpCodesSNOMEDCT;

impl ProcedureFollowUpCodesSNOMEDCT {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/procedure-followup";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "procedure_followup";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "18949003" | "30549001" | "241031001" | "35963001" | "225164002" | "447346005" | "229506003" | "274441001" | "394725008" | "359825008"));
        }
        None
    }
