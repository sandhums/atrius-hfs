...
pub struct ConsentContentClass;

impl ConsentContentClass {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/consent-content-class";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "consent_content_class";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/resource-types" {
            return Some(super::super::code_systems::ResourceType::try_from_code(code).is_some());
        }
        if system == "urn:ietf:rfc:3986" {
            return Some(matches!(code, "http://hl7.org/fhir/StructureDefinition/lipidprofile"));
        }
        if system == "urn:ietf:bcp:13" {
            return Some(matches!(code, "application/hl7-cda+xml"));
        }
        ...
        // http://hl7.org/fhir/ValueSet/formatcodes
        match super::super::value_sets::formatcodes::DocumentReferenceFormatCodeSet::contains(system, code) {
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/resource-types" {
            return super::super::code_systems::ResourceType::try_from_code(code).and_then(|c| c.display());
        }
        if system == "urn:ietf:rfc:3986" {
            return match code {
                "http://hl7.org/fhir/StructureDefinition/lipidprofile" => Some("Lipid Lab Report"),
                _ => None,
            };
        }
        if system == "urn:ietf:bcp:13" {
            return match code {
                "application/hl7-cda+xml" => Some("CDA Documents"),
                _ => None,
            };
        }
        None
