...
pub struct ImmunizationEvaluationStatusCodes;

impl ImmunizationEvaluationStatusCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-evaluation-status";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "immunization_evaluation_status";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/medication-admin-status" {
            return Some(matches!(code, "completed" | "entered-in-error"));
        }
        None
    }
