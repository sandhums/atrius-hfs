...
impl ClinicalImpressionStatus {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/clinicalimpression-status";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "clinicalimpression_status";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/event-status" {
            return Some(matches!(code, "in-progress" | "completed" | "entered-in-error"));
        }
        None
    }
