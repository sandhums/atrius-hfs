...
impl ExampleProgramReasonCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/ex-programcode" {
            return Some(super::super::code_systems::ExampleProgramCodes::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/ex-programcode" {
            return super::super::code_systems::ExampleProgramCodes::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
