...
impl SubjectType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/subject-type";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "subject_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/resource-types" {
            return Some(matches!(code, "Patient" | "Practitioner" | "Organization" | "Location" | "Device"));
        }
        None
    }
