...
pub struct ImmunizationEvaluationTargetDiseaseCodes;

impl ImmunizationEvaluationTargetDiseaseCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-evaluation-target-disease";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "immunization_evaluation_target_disease";
