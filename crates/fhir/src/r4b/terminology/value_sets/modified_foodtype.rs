...
pub struct TextureModifiedFoodTypeCodes;

impl TextureModifiedFoodTypeCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/modified-foodtype";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "modified_foodtype";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "255620007" | "28647000" | "22836000" | "72511004" | "226760005" | "226887002" | "102263004" | "74242007" | "227415002" | "264331002" | "227518002" | "44027008" | "226529007" | "227210005"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "255620007" => Some("Foods"),
                "28647000" => Some("Meat"),
                "22836000" => Some("Vegetables"),
                "72511004" => Some("Fruit"),
                "226760005" => Some("Dairy foods"),
                "226887002" => Some("Dietary Fats and Oils"),
                "102263004" => Some("Eggs"),
                "74242007" => Some("Food Starch"),
                "227415002" => Some("Fruit Nuts and Seeds"),
                "264331002" => Some("Grain"),
                "227518002" => Some("Sauce seasonings and soups"),
                "44027008" => Some("Seafood"),
                "226529007" => Some("Starchy food"),
                "227210005" => Some("Vegetables plus herbs and spices"),
                _ => None,
            };
        }
        None
