...
impl CarePlanActivityKind {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/care-plan-activity-kind";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "care_plan_activity_kind";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/resource-types" {
            return Some(matches!(code, "Appointment" | "CommunicationRequest" | "DeviceRequest" | "MedicationRequest" | "NutritionOrder" | "Task" | "ServiceRequest" | "VisionPrescription"));
        }
        None
    }
