...
impl BodystructureLocationQualifier {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "419161000" | "419465000" | "51440002" | "261183002" | "261122009" | "255561001" | "49370004" | "264217000" | "261089000" | "255551008" | "351726001" | "352730000"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "419161000" => Some("Unilateral left"),
                "419465000" => Some("Unilateral right"),
