...
pub struct FHIRAllTypes;

impl FHIRAllTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/all-types";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "all_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/data-types" {
            return Some(super::super::code_systems::DataType::try_from_code(code).is_some());
        }
        if system == "http://hl7.org/fhir/resource-types" {
            return Some(super::super::code_systems::ResourceType::try_from_code(code).is_some());
        }
        if system == "http://hl7.org/fhir/abstract-types" {
            return Some(super::super::code_systems::AbstractType::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/data-types" {
            return super::super::code_systems::DataType::try_from_code(code).and_then(|c| c.display());
        }
        if system == "http://hl7.org/fhir/resource-types" {
            return super::super::code_systems::ResourceType::try_from_code(code).and_then(|c| c.display());
        }
        if system == "http://hl7.org/fhir/abstract-types" {
            return super::super::code_systems::AbstractType::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
