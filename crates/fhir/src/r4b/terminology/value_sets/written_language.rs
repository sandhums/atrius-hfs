...
impl CommonLanguagesWritten {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/written-language";
    pub const VERSION: &'static str = "4.3.0";
    pub const MODULE: &'static str = "written_language";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:ietf:bcp:47" {
            return Some(matches!(code, "ar" | "bn" | "cs" | "da" | "de" | "el" | "en" | "es" | "fi" | "fr" | "fy" | "hi" | "hr" | "it" | "ja" | "ko" | "nl" | "no" | "pa" | "pl" | "pt" | "ru" | "sr" | "sv" | "te" | "zh"));
        }
        None
    }
