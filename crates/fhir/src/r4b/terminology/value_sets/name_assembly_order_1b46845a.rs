...
impl HumanNameAssemblyOrder {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/name-assembly-order" {
            return Some(super::super::code_systems::HumanNameAssemblyOrder::try_from_code(code).is_some());
        }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/name-assembly-order" {
            return super::super::code_systems::HumanNameAssemblyOrder::try_from_code(code).and_then(|c| c.display());
        }
        if system == "http://terminology.hl7.org/CodeSystem/v2-0444" {
            return match code {
