// @generated by helios-fhir-gen (R4B ProdCharacteristic) — do not edit
...
#[fhir_resource(summary_fields = "modifier_extension,height,width,depth,weight,nominal_volume,external_diameter,shape,color,imprint,image,scoring")]
