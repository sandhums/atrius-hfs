// @generated by helios-fhir-gen (R4B Population) — do not edit
...
#[fhir_resource(choice_elements = "age", summary_fields = "modifier_extension,age,gender,race,physiological_condition")]
