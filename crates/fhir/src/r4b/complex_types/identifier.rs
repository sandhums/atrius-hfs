// @generated by helios-fhir-gen (R4B Identifier) — do not edit
...
pub struct Identifier {
    ...
    /// [Rendered Value extension](extension-rendered-value.html). Identifier.value
    /// is to be treated as case sensitive unless knowledge of the Identifier.system
    /// allows the processer to be confident that non-case-sensitive processing is
    /// safe.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
