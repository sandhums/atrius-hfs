// @generated by helios-fhir-gen (R4B Timing) — do not edit
...
pub struct TimingRepeat {
    ...
    /// otherwise specified. The elements frequency and period cannot be used as well
    /// as dayOfWeek.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    ...
    /// day (as filtered by dayofWeek) on the specified times. The elements when,
    /// frequency and period cannot be used as well as timeOfDay.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
