// @generated by helios-fhir-gen (R4B Group) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,r#type,actual,code,name,quantity,managing_entity")]
pub struct Group {
