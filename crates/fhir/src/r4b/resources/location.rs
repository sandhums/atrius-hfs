// @generated by helios-fhir-gen (R4B Location) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,operational_status,name,description,mode,r#type,physical_type,managing_organization")]
pub struct Location {
