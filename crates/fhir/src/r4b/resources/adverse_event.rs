// @generated by helios-fhir-gen (R4B AdverseEvent) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,actuality,category,event,subject,encounter,date,detected,recorded_date,resulting_condition,location,seriousness,severity,outcome,recorder,contributor,suspect_entity,subject_medical_history,reference_document,study")]
