// @generated by helios-fhir-gen (R4B NutritionProduct) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,category,code,manufacturer,nutrient")]
