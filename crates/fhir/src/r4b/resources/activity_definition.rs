// @generated by helios-fhir-gen (R4B ActivityDefinition) — do not edit
...
#[fhir_resource(choice_elements = "subject,timing,product", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,experimental,date,publisher,contact,description,use_context,jurisdiction,effective_period,kind,code,do_not_perform")]
