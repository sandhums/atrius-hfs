// @generated by helios-fhir-gen (R4B Immunization) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,status,vaccine_code,patient,occurrence,primary_source,performer,note,is_subpotent")]
