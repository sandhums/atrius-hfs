// @generated by helios-fhir-gen (R4B ResearchStudy) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,title,protocol,part_of,status,primary_purpose_type,phase,category,focus,condition,contact,keyword,location,enrollment,period,sponsor,principal_investigator,site,reason_stopped")]
