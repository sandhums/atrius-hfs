// @generated by helios-fhir-gen (R4B Consent) — do not edit
...
#[fhir_resource(choice_elements = "source", summary_fields = "id,meta,implicit_rules,identifier,status,scope,category,patient,date_time,performer,organization,source,policy_rule,verification,provision")]
pub struct Consent {
