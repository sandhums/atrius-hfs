// @generated by helios-fhir-gen (R4B ImagingStudy) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,modality,subject,encounter,started,based_on,referrer,interpreter,endpoint,number_of_series,number_of_instances,procedure_reference,procedure_code,location,reason_code,reason_reference,note,description,series")]
