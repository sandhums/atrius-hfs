// @generated by helios-fhir-gen (R4B Communication) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,instantiates_canonical,instantiates_uri,based_on,part_of,status,status_reason,priority,subject,encounter,reason_code,reason_reference")]
