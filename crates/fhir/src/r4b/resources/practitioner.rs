// @generated by helios-fhir-gen (R4B Practitioner) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,name,telecom,address,gender,birth_date")]
pub struct Practitioner {
    ...
    /// urgently and to help with identification. These typically will have home
    /// numbers, or mobile numbers that are not role specific.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
