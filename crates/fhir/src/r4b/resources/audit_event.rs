// @generated by helios-fhir-gen (R4B AuditEvent) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,r#type,subtype,action,recorded,outcome,outcome_desc,purpose_of_event")]
