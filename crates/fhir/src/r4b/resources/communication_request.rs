// @generated by helios-fhir-gen (R4B CommunicationRequest) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,identifier,based_on,replaces,group_identifier,status,priority,do_not_perform,encounter,occurrence,authored_on,requester,sender,reason_code,reason_reference")]
