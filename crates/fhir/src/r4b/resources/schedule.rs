// @generated by helios-fhir-gen (R4B Schedule) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,service_category,service_type,specialty,actor,planning_horizon")]
pub struct Schedule {
