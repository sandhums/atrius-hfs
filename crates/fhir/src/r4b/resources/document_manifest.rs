// @generated by helios-fhir-gen (R4B DocumentManifest) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,master_identifier,identifier,status,r#type,subject,author,description,content")]
