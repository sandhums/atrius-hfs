// @generated by helios-fhir-gen (R4B EventDefinition) — do not edit
...
#[fhir_resource(choice_elements = "subject", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,approval_date,last_review_date,effective_period,trigger")]
