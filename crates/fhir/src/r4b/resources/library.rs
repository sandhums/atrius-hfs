// @generated by helios-fhir-gen (R4B Library) — do not edit
...
#[fhir_resource(choice_elements = "subject", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,experimental,r#type,date,publisher,contact,description,use_context,jurisdiction,effective_period,content")]
pub struct Library {
