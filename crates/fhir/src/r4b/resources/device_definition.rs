// @generated by helios-fhir-gen (R4B DeviceDefinition) — do not edit
...
#[fhir_resource(choice_elements = "manufacturer", summary_fields = "id,meta,implicit_rules,safety,parent_device")]
