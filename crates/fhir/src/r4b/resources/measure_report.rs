// @generated by helios-fhir-gen (R4B MeasureReport) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,r#type,measure,subject,date,reporter,period,improvement_notation")]
