// @generated by helios-fhir-gen (R4B ImmunizationRecommendation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,patient,date,recommendation")]
...
pub struct ImmunizationRecommendationRecommendation {
    ...
    /// cases where an interger is not available (such as when documenting a
    /// recurring booster dose).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
