// @generated by helios-fhir-gen (R4B Invoice) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,r#type,subject,recipient,date,total_net,total_gross")]
pub struct Invoice {
