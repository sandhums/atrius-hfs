// @generated by helios-fhir-gen (R4B RiskAssessment) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,identifier,status,method,code,subject,encounter,occurrence,condition,performer")]
