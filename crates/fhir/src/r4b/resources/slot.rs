// @generated by helios-fhir-gen (R4B Slot) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,service_category,service_type,specialty,appointment_type,schedule,status,start,end")]
pub struct Slot {
