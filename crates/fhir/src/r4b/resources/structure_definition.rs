// @generated by helios-fhir-gen (R4B StructureDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,keyword,fhir_version,kind,r#abstract,context,context_invariant,r#type,base_definition,derivation")]
