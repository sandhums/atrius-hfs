// @generated by helios-fhir-gen (R4B Endpoint) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,connection_type,name,managing_organization,period,payload_type,payload_mime_type,address")]
pub struct Endpoint {
