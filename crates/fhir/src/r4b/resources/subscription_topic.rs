// @generated by helios-fhir-gen (R4B SubscriptionTopic) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,title,derived_from,status,experimental,date,publisher,contact,use_context,jurisdiction,effective_period,resource_trigger,event_trigger,can_filter_by,notification_shape")]
