// @generated by helios-fhir-gen (R4B ServiceRequest) — do not edit
...
pub struct ServiceRequest {
    ...
    /// activated, competed, cancelled or suspended. States relating to the
    ...
    /// *Condition* should be used if available. Otherwise when referencing
    /// *DiagnosticReport* it should contain a finding in
    /// `DiagnosticReport.conclusion` and/or `DiagnosticReport.conclusionCode`. When
    /// using a reference to *DocumentReference*, the target document should contain
    /// clear findings language providing the relevant reason for this service
    ...
    /// requested on already existing specimens and the request points to the
