// @generated by helios-fhir-gen (R4B DetectedIssue) — do not edit
...
#[fhir_resource(choice_elements = "identified", summary_fields = "id,meta,implicit_rules,identifier,status,code,severity,patient,identified,author,implicated")]
