// @generated by helios-fhir-gen (R4B Account) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,r#type,name,subject,service_period,coverage,owner,description")]
pub struct Account {
