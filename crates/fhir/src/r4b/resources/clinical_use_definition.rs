// @generated by helios-fhir-gen (R4B ClinicalUseDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,r#type,category,subject,status,contraindication,indication,interaction,population,undesirable_effect,warning")]
