// @generated by helios-fhir-gen (R4B EpisodeOfCare) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,r#type,diagnosis,patient,managing_organization,period")]
