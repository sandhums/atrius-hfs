// @generated by helios-fhir-gen (R4B ResearchDefinition) — do not edit
...
/// FHIR Version: 4.3.0
/// 
/// See: [ResearchDefinition](http://hl7.org/fhir/StructureDefinition/ResearchDefinition)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(choice_elements = "subject", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,experimental,date,publisher,contact,description,use_context,jurisdiction,effective_period,population,exposure,exposure_alternative,outcome")]
pub struct ResearchDefinition {
    ...
    /// 
    /// ## Requirements
    /// Allows the research definition to be referenced by a single globally unique
    /// identifier.
    /// 
    /// ## Implementation Notes
    ...
    /// identifier) data type, and can then identify this research definition outside
    ...
    /// research definition with the format [url]|[version].
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    ...
    /// that would be used for a production-level research definition.
    /// 
    /// ## Implementation Notes
    /// Allows filtering of research definitions that are appropriate for use versus
    /// not.
    ...
    /// 
    /// ## Implementation Notes
    /// The subject of the ResearchDefinition is critical in interpreting the
    /// criteria definitions, as the logic in the ResearchDefinitions is evaluated
    /// with respect to a particular subject. This corresponds roughly to the notion
    /// of a Compartment in that it limits what content is available based on its
    ...
    /// 
    /// ## Requirements
    /// Helps establish the "authority/credibility" of the research definition. May
    /// also allow for contact.
    /// 
    /// ## Implementation Notes
    /// Usually an organization but may be an individual. The publisher (or steward)
    /// of the research definition is the organization or individual primarily
    /// responsible for the maintenance and upkeep of the research definition. This
    ...
    /// for questions or issues with the research definition. This item SHOULD be
    ...
    /// etc. It is not a rendering of the research definition as conveyed in the
    /// 'text' field of the resource itself. This item SHOULD be populated unless the
    /// information is available from context (e.g. the language of the research
    /// definition is presumed to be the predominant language in the place the
    /// research definition was created).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// ## Implementation Notes
    /// It may be possible for the research definition to be used in jurisdictions
    ...
    /// 
    /// ## Implementation Notes
    /// This element does not describe the usage of the research definition. Instead,
    ...
    /// research definition and/or its content.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// allows for a sunsetting process when new versions of the research definition
    ...
    /// ResearchDefinition so that it can be found by topical searches.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Requirements
    /// ResearchDefinitions must be able to provide enough information for consumers
