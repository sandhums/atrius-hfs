// @generated by helios-fhir-gen (R4B TerminologyCapabilities) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,version,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,copyright,kind,software,implementation,locked_date")]
