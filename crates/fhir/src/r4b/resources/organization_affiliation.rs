// @generated by helios-fhir-gen (R4B OrganizationAffiliation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,period,organization,participating_organization,network,code,specialty,location,telecom")]
