// @generated by helios-fhir-gen (R4B ImmunizationEvaluation) — do not edit
...
/// FHIR ImmunizationEvaluation type
/// 
...
/// FHIR Version: 4.3.0
/// 
/// See: [ImmunizationEvaluation](http://hl7.org/fhir/StructureDefinition/ImmunizationEvaluation)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(choice_elements = "doseNumber,seriesDoses", summary_fields = "id,meta,implicit_rules,status,patient,target_disease,immunization_event,dose_status")]
