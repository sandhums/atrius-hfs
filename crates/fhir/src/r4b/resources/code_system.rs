// @generated by helios-fhir-gen (R4B CodeSystem) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,case_sensitive,value_set,hierarchy_meaning,compositional,version_needed,content,supplements,count,filter,property")]
pub struct CodeSystem {
    ...
    /// It SHALL remain the same when the code system is stored on different servers.
    ...
    /// 
    /// ## Implementation Notes
    /// This description can be used to capture details such as why the code system
    ...
    /// is not a rendering of the code system as conveyed in the 'text' field of the
    /// resource itself. This item SHOULD be populated unless the information is
    /// available from context (e.g. the language of the code system is presumed to
    /// be the predominant language in the place the code system was created).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
