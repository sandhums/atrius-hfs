// @generated by helios-fhir-gen (R4B RequestGroup) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,instantiates_canonical,instantiates_uri,group_identifier,status,intent,priority,code")]
