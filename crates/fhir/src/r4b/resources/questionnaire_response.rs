// @generated by helios-fhir-gen (R4B QuestionnaireResponse) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,based_on,part_of,questionnaire,status,subject,encounter,authored,author,source")]
