// @generated by helios-fhir-gen (R4B OperationDefinition) — do not edit
...
pub struct OperationDefinition {
    ...
    /// etc. It is not a rendering of the operation definition as conveyed in the
    ...
    /// - **opd-3**: A targetProfile can only be specified for parameters of type Reference or Canonical (error)
