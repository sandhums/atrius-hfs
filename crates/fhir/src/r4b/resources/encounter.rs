// @generated by helios-fhir-gen (R4B Encounter) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,class,r#type,service_type,subject,episode_of_care,participant,appointment,reason_code,reason_reference,diagnosis")]
