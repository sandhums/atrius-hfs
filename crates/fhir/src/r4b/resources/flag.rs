// @generated by helios-fhir-gen (R4B Flag) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,category,code,subject,period,encounter,author")]
pub struct Flag {
