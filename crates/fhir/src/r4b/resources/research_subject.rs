// @generated by helios-fhir-gen (R4B ResearchSubject) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,period,study,individual")]
