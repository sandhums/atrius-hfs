// @generated by helios-fhir-gen (R4B Specimen) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,accession_identifier,status,r#type,subject,received_time,condition")]
pub struct Specimen {
