// @generated by helios-fhir-gen (R4B DocumentReference) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,master_identifier,identifier,status,doc_status,r#type,category,subject,date,author,relates_to,description,security_label,content,context")]
pub struct DocumentReference {
    ...
    /// 
    /// ## Requirements
    /// The structure and format of this Id shall be consistent with the
    /// specification corresponding to the formatCode attribute. (e.g. for a DICOM
    /// standard document a 64-character numeric UID, for an HL7 CDA format a
    /// serialization of the CDA Document Id extension and root in the form
    /// "oid^extension", where OID is a 64 digits max, and the Id is a 16 UTF-8 char
    /// max. If the OID is coded without the extension then the '^' character shall
    /// not be included.).
    /// 
    /// ## Implementation Notes
    ...
    /// document has been signed manually or electronically by the legal
    /// Authenticator.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    ...
    /// 
    /// ## Implementation Notes
    /// These values are primarily added to help with searching for
...
pub struct DocumentReferenceContent {
    ...
    /// 
    /// ## Implementation Notes
    /// Note that while IHE mostly issues URNs for format types, not all documents
...
pub struct DocumentReferenceContext {
    ...
    /// 
    /// ## Implementation Notes
    /// May be identifiers or resources that caused the DocumentReference or
    /// referenced Document to be created.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
