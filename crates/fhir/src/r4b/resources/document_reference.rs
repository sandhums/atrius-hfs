...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,master_identifier,identifier,status,doc_status,r#type,category,subject,date,author,relates_to,description,security_label,content,context"
)]
