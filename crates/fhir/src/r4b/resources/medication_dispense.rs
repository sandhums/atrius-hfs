// @generated by helios-fhir-gen (R4B MedicationDispense) — do not edit
...
#[fhir_resource(choice_elements = "statusReason,medication", summary_fields = "id,meta,implicit_rules,status,medication,subject,when_prepared")]
