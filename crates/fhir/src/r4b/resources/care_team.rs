// @generated by helios-fhir-gen (R4B CareTeam) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,category,name,subject,encounter,period,managing_organization")]
pub struct CareTeam {
