// @generated by helios-fhir-gen (R4B Substance) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,category,code,description,instance,ingredient")]
