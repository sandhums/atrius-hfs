// @generated by helios-fhir-gen (R4B MedicationAdministration) — do not edit
...
#[fhir_resource(choice_elements = "medication,effective", summary_fields = "id,meta,implicit_rules,instantiates,part_of,status,medication,subject,effective,performer")]
