// @generated by helios-fhir-gen (R4B VerificationResult) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,target,target_location,need,status,status_date,validation_type,validation_process,failure_action")]
