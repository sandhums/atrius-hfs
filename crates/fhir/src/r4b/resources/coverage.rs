// @generated by helios-fhir-gen (R4B Coverage) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,r#type,policy_holder,subscriber,subscriber_id,beneficiary,dependent,period,payor,order,network")]
pub struct Coverage {
