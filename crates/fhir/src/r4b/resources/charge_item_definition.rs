// @generated by helios-fhir-gen (R4B ChargeItemDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,title,derived_from_uri,part_of,replaces,status,experimental,date,publisher,contact,description,use_context,jurisdiction,effective_period,code")]
