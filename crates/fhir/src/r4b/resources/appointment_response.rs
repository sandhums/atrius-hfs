// @generated by helios-fhir-gen (R4B AppointmentResponse) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,appointment,participant_type,actor,participant_status")]
