// @generated by helios-fhir-gen (R4B PackagedProductDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,name,r#type,package_for,status,status_date,contained_item_quantity,description,legal_status_of_supply,marketing_status,characteristic,copackaged_indicator,manufacturer,package")]
