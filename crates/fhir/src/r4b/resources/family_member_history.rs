// @generated by helios-fhir-gen (R4B FamilyMemberHistory) — do not edit
...
#[fhir_resource(choice_elements = "born,age,deceased", summary_fields = "id,meta,implicit_rules,identifier,instantiates_canonical,instantiates_uri,status,data_absent_reason,patient,date,name,relationship,sex,age,estimated_age,deceased,reason_code,reason_reference")]
