// @generated by helios-fhir-gen (R4B DiagnosticReport) — do not edit
...
#[fhir_resource(choice_elements = "effective", summary_fields = "id,meta,implicit_rules,identifier,status,category,code,subject,encounter,effective,issued,performer,results_interpreter,media")]
