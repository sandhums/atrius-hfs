// @generated by helios-fhir-gen (R4B SearchParameter) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,version,name,status,experimental,date,publisher,contact,description,use_context,jurisdiction,code,base,r#type")]
