// @generated by helios-fhir-gen (R4B DeviceUseStatement) — do not edit
...
#[fhir_resource(choice_elements = "timing", summary_fields = "id,meta,implicit_rules,identifier,based_on,status,subject,derived_from,timing,recorded_on,source,device,reason_code,reason_reference,body_site")]
pub struct DeviceUseStatement {
    ...
    /// extension
    /// [http://hl7.org/fhir/StructureDefinition/bodySite](extension-bodysite.html).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
