// @generated by helios-fhir-gen (R4B EvidenceReport) — do not edit
...
#[fhir_resource(choice_elements = "citeAs", summary_fields = "id,meta,implicit_rules,url,status,use_context,identifier,related_identifier,subject,publisher,contact,author,endorser")]
