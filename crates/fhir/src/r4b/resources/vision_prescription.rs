// @generated by helios-fhir-gen (R4B VisionPrescription) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,created,patient,date_written,prescriber,lens_specification")]
