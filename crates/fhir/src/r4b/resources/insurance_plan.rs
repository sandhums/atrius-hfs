// @generated by helios-fhir-gen (R4B InsurancePlan) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,r#type,name,owned_by,administered_by,coverage_area")]
