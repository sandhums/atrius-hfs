// @generated by helios-fhir-gen (R4B PractitionerRole) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,period,practitioner,organization,code,specialty,location,telecom")]
