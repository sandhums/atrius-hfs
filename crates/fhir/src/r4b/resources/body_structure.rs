// @generated by helios-fhir-gen (R4B BodyStructure) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,morphology,location,description,patient")]
