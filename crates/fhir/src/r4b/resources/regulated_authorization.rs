...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,identifier,subject,r#type,description,region,status,status_date,validity_period,indication,intended_use,basis,holder,regulator,case"
)]
