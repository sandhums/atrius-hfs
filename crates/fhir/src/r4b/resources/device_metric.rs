// @generated by helios-fhir-gen (R4B DeviceMetric) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,r#type,unit,source,parent,operational_status,color,category,measurement_period,calibration")]
