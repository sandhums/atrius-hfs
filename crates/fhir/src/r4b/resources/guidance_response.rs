// @generated by helios-fhir-gen (R4B GuidanceResponse) — do not edit
...
#[fhir_resource(choice_elements = "module", summary_fields = "id,meta,implicit_rules,request_identifier,identifier,module,status")]
