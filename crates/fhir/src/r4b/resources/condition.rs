// @generated by helios-fhir-gen (R4B Condition) — do not edit
...
#[fhir_resource(choice_elements = "onset,abatement", summary_fields = "id,meta,implicit_rules,identifier,clinical_status,verification_status,code,body_site,subject,encounter,onset,recorded_date,recorder,asserter")]
