// @generated by helios-fhir-gen (R4B List) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,mode,title,code,subject,date,source")]
pub struct List {
...
pub struct ListEntry {
    ...
    /// element SHALL be true. Deleted can only be used if the List.mode is
    /// "changes".
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
