// @generated by helios-fhir-gen (R4B Subscription) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,contact,end,reason,criteria,error,channel")]
...
pub struct SubscriptionChannel {
    ...
    /// for example, support of multiple headers in the outgoing notifications for
    /// rest-hook type subscriptions.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
