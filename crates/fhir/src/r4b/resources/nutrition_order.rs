// @generated by helios-fhir-gen (R4B NutritionOrder) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,instantiates_canonical,instantiates_uri,status,intent,patient,date_time,orderer")]
