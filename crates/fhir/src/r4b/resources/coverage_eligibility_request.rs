// @generated by helios-fhir-gen (R4B CoverageEligibilityRequest) — do not edit
...
#[fhir_resource(choice_elements = "serviced", summary_fields = "id,meta,implicit_rules,status,purpose,patient,created,insurer")]
