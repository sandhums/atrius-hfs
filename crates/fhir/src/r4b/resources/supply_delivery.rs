// @generated by helios-fhir-gen (R4B SupplyDelivery) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,based_on,part_of,status,occurrence")]
