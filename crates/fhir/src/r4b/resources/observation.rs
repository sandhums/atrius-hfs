// @generated by helios-fhir-gen (R4B Observation) — do not edit
...
#[fhir_resource(choice_elements = "effective,value", summary_fields = "id,meta,implicit_rules,identifier,based_on,part_of,status,code,subject,focus,encounter,effective,issued,performer,value,has_member,derived_from,component")]
