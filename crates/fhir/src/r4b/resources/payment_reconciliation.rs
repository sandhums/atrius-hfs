// @generated by helios-fhir-gen (R4B PaymentReconciliation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,period,created,payment_issuer,payment_date,payment_amount")]
