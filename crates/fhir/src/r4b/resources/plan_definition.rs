// @generated by helios-fhir-gen (R4B PlanDefinition) — do not edit
...
#[fhir_resource(choice_elements = "subject", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,r#type,status,experimental,date,publisher,contact,description,use_context,jurisdiction,effective_period")]
