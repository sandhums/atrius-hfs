// @generated by helios-fhir-gen (R4B Patient) — do not edit
...
#[fhir_resource(choice_elements = "deceased,multipleBirth", summary_fields = "id,meta,implicit_rules,identifier,active,name,telecom,gender,birth_date,deceased,address,managing_organization,link")]
pub struct Patient {
