// @generated by helios-fhir-gen (R4B MessageDefinition) — do not edit
...
#[fhir_resource(choice_elements = "event", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,replaces,status,experimental,date,publisher,contact,description,use_context,jurisdiction,purpose,base,parent,event,category,focus")]
