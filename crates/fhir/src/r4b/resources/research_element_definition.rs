// @generated by helios-fhir-gen (R4B ResearchElementDefinition) — do not edit
...
#[fhir_resource(choice_elements = "subject", summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,short_title,status,experimental,date,publisher,contact,description,use_context,jurisdiction,effective_period,r#type,characteristic")]
