// @generated by helios-fhir-gen (R4B ManufacturedItemDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,status,manufactured_dose_form,unit_of_presentation,manufacturer,ingredient,property")]
