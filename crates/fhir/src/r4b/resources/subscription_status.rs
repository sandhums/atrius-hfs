// @generated by helios-fhir-gen (R4B SubscriptionStatus) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,r#type,events_since_subscription_start,subscription,topic,error")]
