// @generated by helios-fhir-gen (R4B SupplyRequest) — do not edit
...
#[fhir_resource(choice_elements = "item,occurrence", summary_fields = "id,meta,implicit_rules,identifier,status,category,priority,item,quantity,occurrence,authored_on,requester,supplier")]
