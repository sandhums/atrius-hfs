// @generated by helios-fhir-gen (R4B Person) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,name,telecom,gender,birth_date,managing_organization,active")]
pub struct Person {
