...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,identifier,version,status,classification,domain,grade,description,information_source,note,manufacturer,supplier,moiety,property,molecular_weight,structure,code,name,relationship,source_material"
)]
