// @generated by helios-fhir-gen (R4B HealthcareService) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,provided_by,category,r#type,specialty,location,name,comment,photo")]
