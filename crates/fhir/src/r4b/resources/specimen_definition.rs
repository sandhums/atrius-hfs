// @generated by helios-fhir-gen (R4B SpecimenDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,type_collected,patient_preparation,time_aspect,collection")]
