// @generated by helios-fhir-gen (R4B RelatedPerson) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,active,patient,relationship,name,telecom,gender,birth_date,address")]
