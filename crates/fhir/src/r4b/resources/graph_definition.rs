// @generated by helios-fhir-gen (R4B GraphDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,version,name,status,experimental,date,publisher,contact,use_context,jurisdiction,start")]
