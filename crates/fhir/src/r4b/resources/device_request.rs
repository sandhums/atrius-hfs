...
#[fhir_resource(choice_elements = "code,occurrence", summary_fields = "id,meta,implicit_rules,identifier,instantiates_canonical,instantiates_uri,based_on,prior_request,group_identifier,status,intent,priority,code,subject,encounter,occurrence,authored_on,requester,performer_type,performer,reason_code,reason_reference")]
