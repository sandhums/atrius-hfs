// @generated by helios-fhir-gen (R4B TestReport) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,name,status,test_script,result,score,tester,issued")]
