// @generated by helios-fhir-gen (R4B ClaimResponse) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,status,r#type,r#use,patient,created,insurer,request,outcome,total")]
