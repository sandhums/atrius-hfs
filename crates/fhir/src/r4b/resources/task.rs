// @generated by helios-fhir-gen (R4B Task) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,instantiates_canonical,instantiates_uri,based_on,group_identifier,part_of,status,status_reason,business_status,intent,code,description,focus,r#for,encounter,execution_period,last_modified,requester,owner,location")]
pub struct Task {
