// @generated by helios-fhir-gen (R4B CapabilityStatement) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,version,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,kind,instantiates,imports,software,implementation,fhir_version,format,patch_format,implementation_guide,rest,messaging,document")]
...
pub struct CapabilityStatementRestResourceSearchParam {
    ...
    /// canonical URL, except for the control parameters that do not have a canonical
    /// URL (or a SearchParameter definition). If systems wish to document their
    /// support for modifiers, comparators, target resource types, and chained
    /// parameters, they should do using a search parameter resource. This element
    /// SHALL be populated if the search parameter refers to a SearchParameter
