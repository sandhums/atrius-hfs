// @generated by helios-fhir-gen (R4B MolecularSequence) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,r#type,coordinate_system,patient,specimen,device,performer,quantity,reference_seq,variant,observed_seq,quality,read_coverage,repository,pointer,structure_variant")]
