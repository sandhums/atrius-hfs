...
impl ResearchStudyStatus {
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            Self::OverallStudy => Some("Used for documenting the start and end of the overall study, distinct from progress states."),
            Self::Active => Some("Study is opened for accrual."),
            Self::ActiveButNotRecruiting => Some("The study is ongoing, and participants are receiving an intervention or being examined, but potential participants are not currently being recruited or enrolled."),
            ...
            Self::Completed => Some("The study closed according to the study plan. There will be no further treatments, interventions or data collection."),
            Self::Disapproved => Some("Protocol was disapproved by the review board."),
            Self::EnrollingByInvitation => Some("The study is selecting its participants from a population, or group of people, decided on by the researchers in advance. These studies are not open to everyone who meets the eligibility criteria but only to people in that particular population, who are specifically invited to participate."),
            ...
            Self::Terminated => Some("The study has stopped early and will not start again. Participants are no longer being examined or treated."),
