...
impl MedicationDispenseStatusCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/CodeSystem/medicationdispense-status";
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            ...
            Self::Unfulfilled => Some("Actions implied by the dispense have been permanently halted, before all of them occurred."),
