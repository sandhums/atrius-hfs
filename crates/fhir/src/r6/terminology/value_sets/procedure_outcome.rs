...
pub struct ProcedureOutcomeCodesSNOMEDCT;

impl ProcedureOutcomeCodesSNOMEDCT {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/procedure-outcome";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "procedure_outcome";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "385669000" | "385671000" | "385670004" | "704302001" | "247758009" | "284778005" | "307085007" | "298429006" | "298434005"));
        }
        None
    }
