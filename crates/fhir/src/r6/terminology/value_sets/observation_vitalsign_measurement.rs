...
impl VitalSignsMeasurement {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/observation-vitalsign-panel
        match super::super::value_sets::observation_vitalsign_panel::VitalSignsPanel::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/observation-vitalsign-bppanel
        match super::super::value_sets::observation_vitalsign_bppanel::VitalSignsBPPanel::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/observation-vitalsign-bmi
        match super::super::value_sets::observation_vitalsign_bmi::VitalSignsBMI::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/observation-vitalsign-bodytemp
        match super::super::value_sets::observation_vitalsign_bodytemp::VitalSignsBodyTemp::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        ...
        // http://hl7.org/fhir/ValueSet/observation-vitalsign-resprate
        match super::super::value_sets::observation_vitalsign_resprate::VitalSignsRespRate::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
