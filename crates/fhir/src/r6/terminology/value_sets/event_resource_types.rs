...
impl EventResourceTypes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/event-resource-types";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "event_resource_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(matches!(code, "AdverseEvent" | "AuditEvent" | "ClaimResponse" | "Communication" | "Composition" | "Consent" | "Contract" | "Coverage" | "CoverageEligibilityResponse" | "DetectedIssue" | "DeviceAlert" | "DiagnosticReport" | "DocumentReference" | "Encounter" | "EnrollmentResponse" | "EpisodeOfCare" | "ExplanationOfBenefit" | "FamilyMemberHistory" | "GuidanceResponse" | "ImagingSelection" | "ImagingStudy" | "Immunization" | "Invoice" | "MedicationAdministration" | "MedicationDispense" | "MedicationStatement" | "MessageHeader" | "NutritionIntake" | "Observation" | "PaymentNotice" | "PaymentReconciliation" | "Procedure" | "Provenance" | "QuestionnaireResponse" | "RiskAssessment"));
        }
        None
    }
