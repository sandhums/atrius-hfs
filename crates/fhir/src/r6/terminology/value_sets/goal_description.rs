...
impl GoalDescription {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/goal-description";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "goal_description";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "2004005" | "301475006" | "282192007" | "161922009" | "228367002" | "1157152000" | "19063003" | "700000006" | "271651005" | "716424007"));
        }
        None
    }
