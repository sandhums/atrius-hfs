...
impl RequestResourceTypes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(matches!(code, "Appointment" | "CarePlan" | "Claim" | "CommunicationRequest" | "CoverageEligibilityRequest" | "DeviceRequest" | "EnrollmentRequest" | "MedicationRequest" | "NutritionOrder" | "RequestOrchestration" | "ServiceRequest" | "Task" | "VisionPrescription"));
        }
        None
    }
