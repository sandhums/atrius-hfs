...
//! Search Modifier All Codes
//!
//! A supported modifier for a search parameter.
use super::super::super::{CodeableConcept, Coding};
use crate::TerminologyValidationError;

pub struct SearchModifierAllCodes;

impl SearchModifierAllCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/search-modifier-all-codes";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "search_modifier_all_codes";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/search-modifier-code" {
            return Some(super::super::code_systems::SearchModifierCode::try_from_code(code).is_some());
        }
        ...
        // http://hl7.org/fhir/ValueSet/extended-resource-types
        match super::super::value_sets::extended_resource_types::ExtendedResourceTypes::contains(system, code) {
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/search-modifier-code" {
            return super::super::code_systems::SearchModifierCode::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("http://hl7.org/fhir/search-modifier-code".to_string()), code: code.to_string() })
            }
            None => Err(TerminologyValidationError::RemoteValidationRequired("Remote terminology validation required".to_string())),
        }
    }
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/search-modifier-code", code)
    }
