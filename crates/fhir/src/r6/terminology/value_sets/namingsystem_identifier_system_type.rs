...
//! Naming System Identifier System Type
//!
//! Identifies the style of unique identifier used to identify a namespace.
use super::super::super::{CodeableConcept, Coding};
use crate::TerminologyValidationError;

pub struct NamingSystemIdentifierSystemType;

impl NamingSystemIdentifierSystemType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/namingsystem-identifier-system-type";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "namingsystem_identifier_system_type";
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("http://terminology.hl7.org/CodeSystem/v2-0203".to_string()), code: code.to_string() })
            }
            None => Err(TerminologyValidationError::RemoteValidationRequired("Remote terminology validation required".to_string())),
        }
    }
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://terminology.hl7.org/CodeSystem/v2-0203", code)
    }
