...
impl TypeRestfulInteraction {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/type-restful-interaction";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "type_restful_interaction";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return Some(matches!(code, "read" | "vread" | "update" | "update-conditional" | "patch" | "patch-conditional" | "delete" | "delete-conditional-single" | "delete-conditional-multiple" | "delete-history" | "delete-history-version" | "history-instance" | "history-type" | "create" | "create-conditional" | "search-type"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return match code {
                ...
                "vread" => None,
                "update" => None,
                "update-conditional" => None,
                "patch" => None,
                "patch-conditional" => None,
                "delete" => None,
                "delete-conditional-single" => None,
                "delete-conditional-multiple" => None,
                "delete-history" => None,
                "delete-history-version" => None,
                "history-instance" => None,
                "history-type" => None,
                "create" => None,
                "create-conditional" => None,
                "search-type" => None,
                _ => None,
            };
        }
