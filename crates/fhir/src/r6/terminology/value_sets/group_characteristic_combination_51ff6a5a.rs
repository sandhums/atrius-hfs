...
//! Group Characteristic Combination
//!
...
pub struct GroupCharacteristicCombination;

impl GroupCharacteristicCombination {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/group-characteristic-combination";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "group_characteristic_combination_51ff6a5a";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &[
        "http://hl7.org/fhir/group-characteristic-combination",
    ];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/group-characteristic-combination" {
            return Some(matches!(code, "all-of" | "any-of" | "at-least" | "at-most" | "except-subset"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/group-characteristic-combination" {
            return match code {
                ...
                "at-most" => Some("At most"),
                "except-subset" => Some("Except subset"),
                _ => None,
            };
        }
        None
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("http://hl7.org/fhir/group-characteristic-combination".to_string()), code: code.to_string() })
            }
            None => Err(TerminologyValidationError::RemoteValidationRequired("Remote terminology validation required".to_string())),
        }
    }
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/group-characteristic-combination", code)
    }
