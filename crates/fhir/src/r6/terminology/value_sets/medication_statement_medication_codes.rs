...
impl MedicationStatementMedicationCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/medication-statement-medication-codes";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/medication-codes
        match super::super::value_sets::medication_codes::SNOMEDCTMedicationCodes::contains(system, code) {
