...
//! Evidence Variable Definition Modifier Code
//!
...
pub struct EvidenceVariableDefinitionModifierCode;

impl EvidenceVariableDefinitionModifierCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/evidence-variable-definition-modifier-code";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "evidence_variable_definition_modifier_code";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "303105007" | "272103003" | "397669002" | "1157245009" | "261829003" | "262459003"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "303105007" => Some("Disease phases (qualifier value)"),
                "272103003" => Some("Time patterns (qualifier value)"),
                "397669002" => Some("Age (qualifier value)"),
                "1157245009" => Some("Fixed dose (qualifier value)"),
                "261829003" => Some("High dose (qualifier value)"),
                "262459003" => Some("Low dose (qualifier value)"),
                _ => None,
            };
        }
        None
