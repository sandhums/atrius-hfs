...
pub struct DetectedIssueExpectedOnsetType;

impl DetectedIssueExpectedOnsetType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/detectedissue-expected-onset-type";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "detectedissue_expected_onset_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "385315009" | "788800008"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "385315009" => Some("Sudden onset (qualifier value)"),
                "788800008" => Some("Delayed onset (qualifier value)"),
                _ => None,
            };
        }
        None
