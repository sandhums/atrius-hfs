...
impl CommonLanguages {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:ietf:bcp:47" {
            return Some(matches!(code, "ar" | "bg" | "bg-BG" | "bn" | "bs" | "bs-BA" | "cs" | "cs-CZ" | "da" | "da-DK" | "de" | "de-AT" | "de-CH" | "de-DE" | "el" | "el-GR" | "en" | "en-AU" | "en-CA" | "en-GB" | "en-IN" | "en-NZ" | "en-SG" | "en-US" | "es" | "es-AR" | "es-ES" | "es-UY" | "et" | "et-EE" | "fi" | "fi-FI" | "fr" | "fr-BE" | "fr-CA" | "fr-CH" | "fr-FR" | "fy" | "fy-NL" | "ga" | "he" | "hi" | "hr" | "hr-HR" | "hu" | "is" | "is-IS" | "it" | "it-CH" | "it-IT" | "ja" | "kk" | "ko" | "lt" | "lt-LT" | "lv" | "lv-LV" | "mk" | "mt" | "nl" | "nl-BE" | "nl-NL" | "no" | "no-NO" | "pa" | "pl" | "pl-PL" | "pt" | "pt-BR" | "pt-PT" | "rm" | "rm-CH" | "ro" | "ro-RO" | "ru" | "ru-RU" | "sk" | "sk-SK" | "sl" | "sl-SI" | "sq" | "sr" | "sr-RS" | "sv" | "sv-SE" | "te" | "tr" | "uk" | "zh" | "zh-CN" | "zh-HK" | "zh-SG" | "zh-TW"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "urn:ietf:bcp:47" {
            return match code {
                ...
                "et" => Some("Estonian"),
                "et-EE" => Some("Estonian (Estonia)"),
                "fi" => Some("Finnish"),
                "fi-FI" => Some("Finnish (Finland)"),
                "fr" => Some("French"),
                "fr-BE" => Some("French (Belgium)"),
                "fr-CA" => Some("French (Canada)"),
                "fr-CH" => Some("French (Switzerland)"),
                "fr-FR" => Some("French (France)"),
                "fy" => Some("Frisian"),
                "fy-NL" => Some("Frisian (Netherlands)"),
                "ga" => Some("Irish"),
                "he" => Some("Hebrew"),
                "hi" => Some("Hindi"),
                "hr" => Some("Croatian"),
                "hr-HR" => Some("Croatian (Croatia)"),
                "hu" => Some("Hungarian"),
                "is" => Some("Icelandic"),
                "is-IS" => Some("Icelandic (Iceland)"),
                "it" => Some("Italian"),
                ...
                "ko" => Some("Korean"),
                "lt" => Some("Lithuanian"),
                "lt-LT" => Some("Lithuanian (Lithuania)"),
                "lv" => Some("Latvian"),
                "lv-LV" => Some("Latvian (Latvia)"),
                "mk" => Some("Macedonian"),
                "mt" => Some("Maltese"),
                "nl" => Some("Dutch"),
                ...
                "pa" => Some("Punjabi"),
                "pl" => Some("Polish"),
                "pl-PL" => Some("Polish (Poland)"),
                "pt" => Some("Portuguese"),
                "pt-BR" => Some("Portuguese (Brazil)"),
                "pt-PT" => Some("Portuguese (Portugal)"),
                "rm" => Some("Romansh"),
                "rm-CH" => Some("Romansh (Switzerland)"),
                "ro" => Some("Romanian"),
                "ro-RO" => Some("Romanian (Romania)"),
                "ru" => Some("Russian"),
                "ru-RU" => Some("Russian (Russia)"),
                "sk" => Some("Slovakian"),
                "sk-SK" => Some("Slovakian (Slovakia)"),
                "sl" => Some("Slovenian"),
                "sl-SI" => Some("Slovenian (Slovenia)"),
                "sq" => Some("Albanian"),
                "sr" => Some("Serbian"),
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("urn:ietf:bcp:47".to_string()), code: code.to_string() })
            }
            None => Err(TerminologyValidationError::RemoteValidationRequired("Remote terminology validation required".to_string())),
        }
    }
