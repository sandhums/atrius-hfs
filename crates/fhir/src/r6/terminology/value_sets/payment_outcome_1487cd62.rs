...
impl PaymentOutcome {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/payment-outcome" {
            return Some(
                super::super::code_systems::ClaimProcessingCodes_36c63d8c::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/payment-outcome" {
            return super::super::code_systems::ClaimProcessingCodes_36c63d8c::try_from_code(code)
