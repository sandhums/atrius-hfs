...
pub struct AuditEventOutcomeDetailExample;

impl AuditEventOutcomeDetailExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/audit-event-outcome-detail-example";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "audit_event_outcome_detail_example";
