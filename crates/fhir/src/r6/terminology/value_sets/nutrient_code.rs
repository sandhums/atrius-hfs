...
pub struct NutrientCodes;

impl NutrientCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/nutrient-code";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "nutrient_code";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            if matches!(code, "31212001" | "68356001" | "71482002" | "31539008" | "19751002" | "63793008" | "60471000" | "41503000" | "111064005" | "29183001" | "43268001" | "57272005" | "70726008" | "73196006" | "34865002" | "2832002" | "11555005" | "25958007") { return Some(true); }
            return None;
        }
        None
    }
