...
impl SearchComparator {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/search-comparator";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "search_comparator_b98c031a";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/search-comparator" {
            return Some(super::super::code_systems::SearchComparator::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/search-comparator" {
            return super::super::code_systems::SearchComparator::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
