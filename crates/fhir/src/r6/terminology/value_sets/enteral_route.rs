...
pub struct EnteralRouteCodes;

impl EnteralRouteCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/enteral-route";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "enteral_route";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-RouteOfAdministration" {
            return Some(matches!(code, "PO" | "EFT" | "ENTINSTL" | "GT" | "NGT" | "OGT" | "GJT" | "JJTINSTL" | "OJJ"));
        }
        None
    }
