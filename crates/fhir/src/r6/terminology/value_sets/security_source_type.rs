...
impl AuditEventSourceType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/security-source-type";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "security_source_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/security-source-type" {
            return Some(matches!(code, "1" | "2" | "3" | "4" | "5" | "6" | "7" | "8"));
        }
        None
    }
