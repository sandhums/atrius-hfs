...
impl DefinitionResourceTypes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(matches!(code, "ActivityDefinition" | "ClinicalUseDefinition" | "EventDefinition" | "Measure" | "MessageDefinition" | "ObservationDefinition" | "OperationDefinition" | "PlanDefinition" | "Questionnaire" | "Requirements" | "SubscriptionTopic"));
        }
        None
    }
