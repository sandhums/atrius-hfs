...
pub struct DosageConditionDetailsVS;

impl DosageConditionDetailsVS {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/dosage-condition-details";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "dosage_condition_details";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "22253000" | "76948002" | "37796009" | "725119006" | "257551009" | "225581002" | "719232003" | "302758002" | "80449002" | "267036007" | "309253009" | "278040002" | "14140009" | "65971000052100" | "14760008"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "22253000" => Some("Pain"),
                "76948002" => Some("Severe pain"),
                "37796009" => Some("Migraine"),
                "725119006" => Some("Generalized rash"),
                "257551009" => Some("Infection"),
                "225581002" => Some("Sight deteriorating"),
                "719232003" => Some("Difficulty walking"),
                "302758002" => Some("Tiredness"),
                "80449002" => Some("Muscle fatigue"),
                "267036007" => Some("Dyspnea"),
                "309253009" => Some("Difficulty reading"),
                "278040002" => Some("Loss of hair"),
                "14140009" => Some("Hyperkalemia"),
                "65971000052100" => Some("Acute psychosis"),
                "14760008" => Some("Constipation"),
                _ => None,
            };
        }
        None
