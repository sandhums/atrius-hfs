...
pub struct DetectedIssueCode;

impl DetectedIssueCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/detectedissue-code";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "detectedissue_code";
