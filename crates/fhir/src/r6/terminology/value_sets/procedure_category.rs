...
pub struct ProcedureCategoryCodesSNOMEDCT;

impl ProcedureCategoryCodesSNOMEDCT {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/procedure-category";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "procedure_category";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "24642003" | "409063005" | "409073007" | "387713003" | "15220000" | "363679005" | "122869004" | "46947000" | "410606002"));
        }
        None
    }
