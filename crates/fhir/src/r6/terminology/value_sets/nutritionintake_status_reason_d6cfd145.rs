...
//! Nutrition Intake Status Reason
//!
...
pub struct NutritionIntakeStatusReason;

impl NutritionIntakeStatusReason {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/nutritionintake-status-reason";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "nutritionintake_status_reason_d6cfd145";
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &[
        ...
        "http://hl7.org/fhir/CodeSystem/nutritionintake-status-reason",
    ];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "419099009"));
        }
        if system == "http://hl7.org/fhir/CodeSystem/nutritionintake-status-reason" {
            return Some(super::super::code_systems::NutritionIntakeStatusReason::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        ...
        if system == "http://hl7.org/fhir/CodeSystem/nutritionintake-status-reason" {
            return super::super::code_systems::NutritionIntakeStatusReason::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
