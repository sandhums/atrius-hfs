...
pub struct DeviceAlertConditionCodes;

impl DeviceAlertConditionCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/devicealert-condition";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "devicealert_condition";
