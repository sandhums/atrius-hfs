...
impl AuditEventSubTypeExample {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return Some(super::super::code_systems::FHIRRestfulInteractions::try_from_code(code).is_some());
        }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/restful-interaction" {
            return super::super::code_systems::FHIRRestfulInteractions::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
