...
//! Example Audit Event Entity Role
//!
//! Example codes representing the role the entity played in the audit event.
use super::super::super::{CodeableConcept, Coding};
use crate::TerminologyValidationError;

pub struct AuditEventEntityRoleExample;

impl AuditEventEntityRoleExample {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/object-role-example";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "object_role_example";
