...
impl PatientMedicineChangeTypes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:oid:1.2.36.1.2001.1001.101.104.16592" {
            return Some(super::super::code_systems::PatientMedicineChangeTypes::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "urn:oid:1.2.36.1.2001.1001.101.104.16592" {
            return super::super::code_systems::PatientMedicineChangeTypes::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
