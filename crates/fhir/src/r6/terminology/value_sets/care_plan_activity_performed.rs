...
pub struct CarePlanActivityPerformed;

impl CarePlanActivityPerformed {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/care-plan-activity-performed";
    pub const VERSION: &'static str = "6.0.0-ballot3";
    pub const MODULE: &'static str = "care_plan_activity_performed";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "238165008" | "11816003" | "967006" | "6397004" | "367336001" | "1148817001" | "185468001"));
        }
        None
    }
