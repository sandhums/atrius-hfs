// @generated by helios-fhir-gen (R6 Coding) — do not edit
...
pub struct Coding {
    ...
    /// from HL7's list of FHIR defined special URIs or it should be an absolute
    /// reference to some definition that establishes the system clearly and
    /// unambiguously.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
