// @generated by helios-fhir-gen (R6 RelativeTime) — do not edit
...
#[fhir_resource(choice_elements = "offset", summary_fields = "modifier_extension,context_reference,context_definition,context_path,context_code,offset,text")]
