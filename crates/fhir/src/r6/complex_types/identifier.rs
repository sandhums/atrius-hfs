// AUTO-GENERATED by atrius-fhir-generator (R6 Identifier)
use crate::r6::*;
...
pub struct Identifier {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/identifier-use|6.0.0-ballot3
    ...
    ///
    /// ## Implementation Notes
    /// Identifier.system is always case sensitive. The FHIR specification,
    /// terminology.hl7.org and HL7 affiliates (for identifiers specific to their
    /// jurisdiction) define identifier systems that SHALL be used for certain types
    /// of identifiers. Specific rules can be found [here](identifier-registry.html).
    ///
    /// ## Cardinality: Optional (0..1)
    ///
    /// ## Special Semantics
    ...
    /// [http://hl7.org/fhir/StructureDefinition/rendered-value](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-rendered-value.html)).
