// @generated by helios-fhir-gen (R6 Expression) — do not edit
...
pub struct Expression {
    ...
    /// 
    /// ## Implementation Notes
    /// This element is defined with a data type of code because of its behavior, not
    /// because of any expectation it will be bound to a value set.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
