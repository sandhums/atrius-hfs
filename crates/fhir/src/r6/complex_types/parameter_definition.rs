// AUTO-GENERATED by atrius-fhir-generator (R6 ParameterDefinition)
use crate::r6::*;

/// FHIR ParameterDefinition type
///
/// ParameterDefinition Type: The parameters to the module. This collection
/// specifies both the input and output parameters. Input parameters are provided
/// by the caller as part of the $evaluate operation. Output parameters are
