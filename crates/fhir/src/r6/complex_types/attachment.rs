// @generated by helios-fhir-gen (R6 Attachment) — do not edit
...
pub struct Attachment {
    ...
    /// the service base URL, like a resource reference, rather than relative to the
    /// resource itself; for example, Patient/123 (relative) rather than
    /// http://someserver.org/Patient/123 (absolute). Urls may also be URIs only
    /// resolvable within a Bundle containing the resource with the attachment type.
