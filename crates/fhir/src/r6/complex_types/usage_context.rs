// @generated by helios-fhir-gen (R6 UsageContext) — do not edit
...
pub struct UsageContext {
    ...
    pub code: Coding,
    /// Value(s) that define the context
    ///
    /// A value or set of possible values that defines the context specified in this
    /// context of use. The interpretation of the value is defined by the code. If a
    /// 'range' is specified, then the context means that the artifact applies for
    /// any value of the context that falls within range. If a 'valueset' is
    /// specified, then the context means that the artifact applies if a code matches
    /// the value set.
    ///
    /// ## Cardinality: Required (1..1)
    ///
