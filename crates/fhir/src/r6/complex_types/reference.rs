// @generated by helios-fhir-gen (R6 Reference) — do not edit
...
pub struct Reference {
    ...
    /// additional identifiers are required, use the [additional
    /// identifier](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-additionalIdentifier.html)
    /// extension.
    ///
    /// ## Cardinality: Optional (0..1)
    ///
