// @generated by helios-fhir-gen (R6 VirtualServiceDetail) — do not edit
...
#[fhir_resource(choice_elements = "address", summary_fields = "channel_type,address,additional_info,max_participants,session_key")]
