// AUTO-GENERATED by atrius-fhir-generator (R6 Narrative)
use crate::r6::*;
...
pub struct Narrative {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/narrative-status|6.0.0-ballot3
    pub status: Code,
