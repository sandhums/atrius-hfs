...
#[fhir_resource(choice_elements = "effectiveTiming", summary_fields = "id,meta,implicit_rules,modifier_extension,based_on,group_identifier,status,intent,priority,do_not_perform,medication,subject,authored_on,requester,is_record_of_request,performer_type")]
