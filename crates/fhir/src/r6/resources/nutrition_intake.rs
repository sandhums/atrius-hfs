// @generated by helios-fhir-gen (R6 NutritionIntake) — do not edit
...
#[fhir_resource(choice_elements = "occurrence,reported", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,part_of,status,code,subject,encounter,occurrence,recorded")]
