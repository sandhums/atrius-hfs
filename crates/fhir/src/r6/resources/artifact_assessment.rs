// @generated by helios-fhir-gen (R6 ArtifactAssessment) — do not edit
...
#[fhir_resource(choice_elements = "artifact", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,title,artifact,date,last_review_date,workflow_status,disposition")]
pub struct ArtifactAssessment {
    ...
    /// and can include restrictions on the use and publishing of the artifact
    /// assessment.
    /// 
    /// ## Requirements
