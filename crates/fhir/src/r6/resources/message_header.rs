...
#[fhir_resource(choice_elements = "event", summary_fields = "id,meta,implicit_rules,modifier_extension,event,destination,source,reason,response,focus,definition")]
