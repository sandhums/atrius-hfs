// @generated by helios-fhir-gen (R6 QuestionnaireResponse) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,part_of,questionnaire,status,subject,encounter,authored,author,source")]
pub struct QuestionnaireResponse {
    ...
    /// extensions (e.g. conveying the title or identifier for the questionnaire, or
    /// if there is no legacy identifying information available at all, a
    /// data-absent-reason extension). This may happen for legacy data. If there is
    /// no formally defined Questionnaire, it is undefined what the 'correct' values
    /// for the linkId elements should be and it is possible that linkIds might be
    /// inconsistent for QuestionnaireResponses for the same form if captured by
    /// distinct systems.
    /// 
    ...
    /// 
    /// ## Special Semantics
    /// - Order meaning: The order of the items is the order in which the questions were presented to the user when completing the Questionnaire.
    /// 
    /// ## Constraints
