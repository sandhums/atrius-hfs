// @generated by helios-fhir-gen (R6 List) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,mode,title,code,subject,date,source,contributor")]
pub struct List {
    ...
    /// Who helps maintain the list
    /// 
    /// Entities who have the ability to adjust the contents of the list.
    /// 
    /// ## Implementation Notes
    /// If both 'source' and 'contributors' are present, then 'source' has primary
    /// responsibility. If contributors are present without source, then all
    /// contributors have shared responsibility. The source SHOULD NOT be also listed
    /// as a contributor. To indicate a practitioner working for an organization, use
    /// PractitionerRole, even if as a contained resource rather than having separate
    /// repetitions of this element for Practitioner and Organization.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
...
pub struct ListEntry {
    ...
    /// 
    /// ## Special Semantics
    /// - Modifier element - If deleted is true, then the item included in the list is not actually part of the list anymore
