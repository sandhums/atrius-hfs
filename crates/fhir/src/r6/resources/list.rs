// AUTO-GENERATED by atrius-fhir-generator (R6 List)
use crate::r6::*;
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,mode,title,code,subject,date,source")]
pub struct List {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/list-status|6.0.0-ballot3
    pub status: Code,
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/list-mode|6.0.0-ballot3
    pub mode: Code,
