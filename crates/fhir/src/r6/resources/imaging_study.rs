...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,modality,subject,encounter,started,based_on,procedure,referrer,endpoint,location,reason,note,description,number_of_series,number_of_instances,series")]
