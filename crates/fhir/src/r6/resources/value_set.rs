...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,immutable,effective_period"
)]
pub struct ValueSet {
