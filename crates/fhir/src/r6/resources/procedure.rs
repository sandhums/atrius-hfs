// @generated by helios-fhir-gen (R6 Procedure) — do not edit
...
#[fhir_resource(choice_elements = "occurrence,reported", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,part_of,status,status_reason,category,code,subject,focus,encounter,occurrence,recorded,recorder,reported,performer,location,reason,body_site,outcome,complication")]
pub struct Procedure {
    ...
    /// term outcomes are typically documented as Observations. For example, a
    /// cardiac stent procedure may have two Procedure.outcomes of successful
    /// placement of stent and successful reestablishment of blood flow, but the long
    /// term outcome of no further cardiac events would not be documented as a
    /// Procedure.outcome and instead documented as an Observation. In the ICU where
    /// patient is intubated and attached to a ventilator, the ventilator parameter
    /// settings can include respiratory rate, tidal volume, FiO2, and PEEP. The
