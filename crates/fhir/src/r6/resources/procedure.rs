...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,part_of,status,status_reason,category,code,subject,focus,encounter,occurrence,recorded,recorder,reported,performer,location,reason,body_structure,outcome,complication"
)]
