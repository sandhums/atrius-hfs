// @generated by helios-fhir-gen (R6 PaymentNotice) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,status_reason,created,payment,recipient,amount")]
pub struct PaymentNotice {
    ...
    /// 
    /// ## Requirements
    /// Needed to track the status of the resource as 'draft' resources may undergo
    ...
    /// 
    /// ## Requirements
    /// Needed to record a timestamp for use by both the recipient and the issuer.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// ## Requirements
    /// Needed to identify the actual payment.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// ## Requirements
    /// Needed to convey the date when the action being notified occurred.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Requirements
    /// Allows payment notices to identify the claim context.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_serde(rename = "claimIdentifier")]
    pub claim_identifier: Option<Vec<Identifier>>,
    /// Party being paid
    /// 
    ...
    /// 
    /// ## Requirements
    /// Needed to identify the recipient of the notification.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
