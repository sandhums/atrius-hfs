// AUTO-GENERATED by atrius-fhir-generator (R6 Library)
use crate::r6::*;
...
/// artifacts such as logic libraries and information model descriptions, as well
/// as to describe a collection of knowledge artifacts.
/// 
/// ## Type: Resource type
...
#[fhir_resource(choice_elements = "versionAlgorithm,subject", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,r#type,date,publisher,contact,description,use_context,jurisdiction,effective_period,content")]
pub struct Library {
    ...
    /// which an authoritative instance of this library is (or will be) published.
    /// This URL can be the target of a canonical reference. It SHALL remain the same
    /// when the library is stored on different servers.
    /// 
    /// ## Requirements
    ...
    /// knowledge artifacts, refer to the Decision Support Service specification.
    ...
    /// ## Binding
    /// - **Strength**: extensible
    /// - **Description**: The type of knowledge artifact this library contains.
    ...
    /// the library. Additional specific dates may be added as extensions or be found
    ...
    /// library as conveyed in the 'text' field of the resource itself. This item
    /// SHOULD be populated unless the information is available from context (e.g.
    /// the language of the library is presumed to be the predominant language in the
    ...
    /// library intended to be used for the year 2016 might be published in 2015.
    /// 
    /// See guidance around (not) making local changes to elements
    /// [here](canonicalresource.html#localization).
    /// 
    ...
    /// Library SHOULD be a Library, and dependencies and components of a Library
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **lib-2**: Dependencies and components of a Library should reference a resource (warning)
