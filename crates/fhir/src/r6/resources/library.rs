...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,r#type,date,publisher,contact,description,use_context,jurisdiction,effective_period,content"
)]
pub struct Library {
