// @generated by helios-fhir-gen (R6 CoverageEligibilityRequest) — do not edit
...
#[fhir_resource(choice_elements = "serviced", summary_fields = "id,meta,implicit_rules,modifier_extension,status,status_reason,purpose,patient,created,insurer")]
pub struct CoverageEligibilityRequest {
    ...
    /// authorization prior to service delivery may be required by the payer.
    /// 
    /// ## Requirements
...
pub struct CoverageEligibilityRequestItemDiagnosis {
    ...
    /// 
    /// ## Constraints
    /// - **cer-0**: Either a concept or a reference is provided but not both. (error)
    ...
    pub diagnosis: Option<CodeableReference>,
}
