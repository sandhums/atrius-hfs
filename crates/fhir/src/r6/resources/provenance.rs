// @generated by helios-fhir-gen (R6 Provenance) — do not edit
...
pub struct Provenance {
    ...
    /// - **prov-4**: If who is an organization, onBehalfOf can't be a healthcare service within that organization (error)
