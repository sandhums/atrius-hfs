// @generated by helios-fhir-gen (R6 PackagedProductDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,name,r#type,package_for,status,status_date,contained_item_quantity,description,legal_status_of_supply,marketing_status,copackaged_indicator,manufacturer,attached_document,packaging,characteristic")]
