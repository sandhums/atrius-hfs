// @generated by helios-fhir-gen (R6 Location) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,operational_status,code,name,description,mode,r#type,form,managing_organization")]
pub struct Location {
    ...
    /// Codes that represent this location
    /// 
    ...
    /// 
    /// ## Implementation Notes
    /// Locations with a virtual form can be used to represent virtual locations, for
    /// example for telehealth visits, and can contain additional related details in
    /// virtualService.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    ...
    /// `[Location Boundary
    /// (GeoJSON)](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-location-boundary-geojson.html)`,
