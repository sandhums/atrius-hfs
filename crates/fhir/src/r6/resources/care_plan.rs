// @generated by helios-fhir-gen (R6 CarePlan) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,replaces,part_of,status,intent,category,title,description,subject,encounter,period,created,custodian,addresses")]
pub struct CarePlan {
...
pub struct CarePlanActivity {
    ...
    /// 
    /// ## Implementation Notes
    /// Standard extension exists ([Resource Pertains To
    /// Goal](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-resource-pertainsToGoal.html))
