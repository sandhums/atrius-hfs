// @generated by helios-fhir-gen (R6 OrganizationAffiliation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,period,organization,participating_organization,code,specialty,location")]
