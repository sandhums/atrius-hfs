// @generated by helios-fhir-gen (R6 DeviceRequest) — do not edit
...
#[fhir_resource(choice_elements = "product,occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,replaces,group_identifier,status,intent,category,priority,do_not_perform,product,subject,encounter,occurrence,authored_on,requester,performer,location,reason")]
