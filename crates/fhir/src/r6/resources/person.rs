...
#[fhir_resource(choice_elements = "deceased", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,name,telecom,gender,birth_date,deceased,address,managing_organization")]
pub struct Person {
