...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,device,relationship,status,status_reason,association_status,subject,focus,body_structure,period")]
pub struct DeviceAssociation {
    ...
    /// explicitly stated. If the device is associated with multiple individuals at
    /// the same time the Group or CareTeam resource should be utilized.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
