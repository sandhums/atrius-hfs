// @generated by helios-fhir-gen (R6 CommunicationRequest) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,replaces,group_identifier,status,intent,priority,do_not_perform,encounter,occurrence,authored_on,requester,information_provider,reason")]
...
pub struct CommunicationRequestPayload {
    ...
    /// 
    /// If the payload content is narrative text, then string would be used. If the
    /// payload content is typically able to be coded but a code is not currently
    /// available, then CodeableConcept.text may be used.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Constraints
