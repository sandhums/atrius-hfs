// @generated by helios-fhir-gen (R6 StructureDefinition) — do not edit
...
pub struct StructureDefinition {
    ...
    /// be used to assist with indexing and searching of templates by describing the
    ...
    /// 
    /// ## Implementation Notes
    /// Note that this element is deprecated. Use the [Artifact
    /// Topic](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-artifact-topic.html)
    /// extension instead.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
