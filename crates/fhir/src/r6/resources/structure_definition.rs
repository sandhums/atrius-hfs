// AUTO-GENERATED by atrius-fhir-generator (R6 StructureDefinition)
use crate::r6::*;
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,keyword,fhir_version,kind,r#abstract,context,context_invariant,r#type,base_definition,derivation")]
pub struct StructureDefinition {
    ...
    /// and can include restrictions on the use and publishing of the structure
    /// definition. The short copyright declaration (e.g. (c) '2015+ xyz
    /// organization') should be sent in the copyrightLabel element without the
    /// copyright prefix (i.e., do not include '(c)' or the symbol).
    /// 
    /// ## Requirements
    ...
    /// [http://hl7.org/fhir/StructureDefinition/artifact-topic](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-artifact-topic.html)
    /// extension instead.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/structure-definition-kind|6.0.0-ballot3
    /// 
    /// ## Conditions
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/type-derivation-rule|6.0.0-ballot3
    /// 
    /// ## Conditions
...
pub struct StructureDefinitionContext {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/extension-context-type|6.0.0-ballot3
    #[fhir_serde(rename = "type")]
    pub r#type: Code,
