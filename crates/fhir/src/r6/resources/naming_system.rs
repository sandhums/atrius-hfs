...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,kind,experimental,date,publisher,contact,use_context,jurisdiction,effective_period,unique_id")]
