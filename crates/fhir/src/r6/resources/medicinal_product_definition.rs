// @generated by helios-fhir-gen (R6 MedicinalProductDefinition) — do not edit
...
pub struct MedicinalProductDefinitionOperation {
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **Description**: The type of manufacturing or business operation for a medicinal product.
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/medicinal-product-manufacturing-activity
    #[fhir_serde(rename = "type")]
