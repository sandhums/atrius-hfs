// @generated by helios-fhir-gen (R6 Organization) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,r#type,name,description,part_of")]
pub struct Organization {
    ...
    /// 
    /// ## Implementation Notes
    /// Note that an organization might have endpoints listed in any of the
    /// referenced directory resources, not just at the top Organization level (i.e.
    /// sub Organizations, Locations, HealthcareServices, PractitionerRoles)
    /// 
    /// The Endpoint.managingOrganization property indicates the organization that is
    /// supporting/managing the technical endpoint.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
...
pub struct OrganizationQualification {
    ...
    /// likely to be ignored, and might be related to when it was active.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
