...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,modifier_extension,status,status_reason,r#type,r#use,subject,billable_period,created,insurer,provider,priority,insurance"
)]
pub struct Claim {
