// @generated by helios-fhir-gen (R6 StructureMap) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,structure,import,r#const,group")]
pub struct StructureMap {
    ...
    /// the structure map. Additional specific dates may be added as extensions or be
    ...
    /// structure map as conveyed in the 'text' field of the resource itself. This
    /// item SHOULD be populated unless the information is available from context
    /// (e.g. the language of the structure map is presumed to be the predominant
    /// language in the place the structure map was created).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
...
pub struct StructureMapGroup {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/map-group-type-mode|6.0.0-ballot4
...
pub struct StructureMapGroupInput {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/map-input-mode|6.0.0-ballot4
    pub mode: Code,
...
pub struct StructureMapGroupRuleSource {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **smp-3**: Max SHALL be a number or "*" (error)
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/map-source-list-mode|6.0.0-ballot4
...
pub struct StructureMapGroupRuleTarget {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/map-target-list-mode|6.0.0-ballot4
    #[fhir_serde(rename = "listMode")]
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/map-transform|6.0.0-ballot4
...
pub struct StructureMapStructure {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/map-model-mode|6.0.0-ballot4
    pub mode: Code,
