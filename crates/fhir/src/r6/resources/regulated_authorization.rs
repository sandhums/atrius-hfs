// @generated by helios-fhir-gen (R6 RegulatedAuthorization) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,subject,r#type,description,region,status,status_date,validity_period,indication,intended_use,basis,holder,regulator,attached_document,case")]
