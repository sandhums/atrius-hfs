// @generated by helios-fhir-gen (R6 OperationDefinition) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,kind,experimental,date,publisher,contact,use_context,jurisdiction,affects_state,synchronicity,code,base,resource,system,r#type,instance")]
pub struct OperationDefinition {
    ...
    /// 
    /// ## Implementation Notes
    /// Named queries are invoked differently, and have different capabilities. If
    /// there is a need to pre-adopt new codes from a future version, set this
    /// element to 'operation' and convey the additional concept in an extension.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// The types on which this operation can be executed. This must be a resource,
    /// or a type with a [Structure Type Characterstics (Constraint
...
pub struct OperationDefinitionParameterBinding {
    ...
    /// 
    /// ## Implementation Notes
    /// If an operation has bindings with strengths other than those listed here,
    /// they can be expressed computably in the input or output profile for the
    /// operation. Good practice is to also include a descriptive binding here to
    /// highlight that the terminology constraint exists for readers who don't know
