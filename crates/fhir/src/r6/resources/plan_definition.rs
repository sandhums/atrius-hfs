// @generated by helios-fhir-gen (R6 PlanDefinition) — do not edit
...
pub struct PlanDefinition {
    ...
    /// versions can be placed in a lexicographical sequence. For more information on
...
pub struct PlanDefinitionAction {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-code-example
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-reason-code-example
