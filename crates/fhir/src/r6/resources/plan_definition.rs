// AUTO-GENERATED by atrius-fhir-generator (R6 PlanDefinition)
use crate::r6::*;
...
/// artifacts such as clinical decision support rules, order sets, protocols,
/// drug quality specifications, and drug manufacturing process.
/// 
/// ## Type: Resource type
...
#[fhir_resource(choice_elements = "versionAlgorithm,subject,asNeeded", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,r#type,status,experimental,date,publisher,contact,description,use_context,jurisdiction,effective_period,as_needed")]
pub struct PlanDefinition {
    ...
    /// 
    /// ## Implementation Notes
    /// Allows filtering of plan definitions that are appropriate for use versus
    ...
    /// PlanDefinition SHOULD be a PlanDefinition, dependencies of a PlanDefinition
    /// SHOULD reference a resource, and a PlanDefinition SHOULD NOT have components.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **pld-6**: Dependencies of a PlanDefinition should reference a resource (warning)
    ...
    /// - **pld-7**: PlanDefinition should not have components (warning)
    ...
    /// 
    /// ## Special Semantics
    /// - Order meaning: The order of actions is the sequence in which the actions are to be evaluated and performed. This is true of both the actions in the root as well as child actions of each action.
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
...
pub enum PlanDefinitionActionTiming {
    ...
    #[fhir_serde(rename = "timingRelativeTime")]
...
pub struct PlanDefinitionAction {
    ...
    /// 
    /// ## Implementation Notes
    /// If no applicability conditions are present, the action is considered
    /// applicable (i.e. it should be performed). When multiple conditions of the
    /// same kind are present, the effects are combined using AND semantics, so the
    /// overall condition is true only if all the conditions are true. Conditions of
    /// different kinds are always considered separately (e.g. applicability and
    /// start criteria are never considered together)
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Special Semantics
    /// - When missing: If no applicability behavior is specified but the action has children, the default applicability criteria of All is assumed, meaning that each child action is evaluated independently.
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-applicability-behavior|6.0.0-ballot3
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-grouping-behavior|6.0.0-ballot3
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-selection-behavior|6.0.0-ballot3
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-required-behavior|6.0.0-ballot3
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-precheck-behavior|6.0.0-ballot3
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-cardinality-behavior|6.0.0-ballot3
    ...
    /// ObservationDefinition that specifies what observation should be captured, or
    /// an OperationDefinition that specifies what operation should be invoked. When
    /// the value is a uri, it is intended to be a reference to non-FHIR content that
    /// characterizes the action to be performed. This option is allowed to enable
    /// the PlanDefinition to be used to provide semi-structured representation, when
    /// the guidance is not computable, but there is still value in elaborating the
    /// overall structure with a PlanDefinition. The intended behavior when a
    /// definitionUri is realized as part of an apply is that it is copied to the
    /// resulting RequestOrchestration so that it is available to the consuming
    /// system. How that system interprets that uri is not specified.
    /// 
    /// ## Implementation Notes
    ...
    /// resource dynamically. If the reference is to an ActivityDefinition or a
    /// PlanDefinition, the realization processing documented in those resources is
    /// followed. For the other definitional resource types, implementations SHOULD
    /// realize the action as a Task resource with a focus of the definitional
    /// resource to indicate that the activity should be carried out (e.g. evaluating
    /// a measure, gathering a specimen, filling out a questionnaire, sending a
    /// message, invoking an operation, etc.).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
...
pub struct PlanDefinitionActionCondition {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-condition-kind|6.0.0-ballot3
    pub kind: Code,
...
pub struct PlanDefinitionActionRelatedAction {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/action-relationship-type|6.0.0-ballot3
