...
#[fhir_resource(choice_elements = "quantity,occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,replaces,requisition,status,intent,category,priority,do_not_perform,code,order_detail,quantity,subject,focus,encounter,occurrence,as_needed,as_needed_for,authored_on,requester,performer_type,performer,location,reason,specimen,body_structure")]
