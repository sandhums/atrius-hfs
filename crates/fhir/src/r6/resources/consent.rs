// @generated by helios-fhir-gen (R6 Consent) — do not edit
...
pub struct ConsentPolicyBasis {
    ...
    /// 
    /// ## Implementation Notes
    /// While any resource may be used, Consent, and PlanDefinition would be most
    /// frequent
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
...
pub struct ConsentProvision {
    ...
    /// 
    /// ## Special Semantics
    /// - When missing: There is no specific actor associated with the provision
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    ...
    /// ## Binding
    /// - **Strength**: extensible
    /// - **Description**: What purposes of use are controlled by this provision. If more than one label is specified, operations must have all the specified labels.
