// AUTO-GENERATED by atrius-fhir-generator (R6 Consent)
use crate::r6::*;
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,category,subject,date,period,grantor,grantee,verification,decision,provision")]
pub struct Consent {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/consent-state-codes|6.0.0-ballot3
    pub status: Code,
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/consent-category-example
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/consent-provision-type|6.0.0-ballot3
...
pub struct ConsentProvisionData {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/consent-data-meaning|6.0.0-ballot3
    pub meaning: Code,
