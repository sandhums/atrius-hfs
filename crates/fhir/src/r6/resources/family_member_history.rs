// AUTO-GENERATED by atrius-fhir-generator (R6 FamilyMemberHistory)
use crate::r6::*;
...
#[fhir_resource(choice_elements = "born,age,deceased", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,data_absent_reason,patient,date,recorder,asserter,name,relationship,sex,age,estimated_age,deceased,reason,condition")]
pub struct FamilyMemberHistory {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/history-status|6.0.0-ballot3
    pub status: Code,
