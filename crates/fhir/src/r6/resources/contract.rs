...
#[fhir_resource(choice_elements = "topic,legallyBinding", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,version,status,issued,applies,subject,name,title,r#type,sub_type")]
pub struct Contract {
