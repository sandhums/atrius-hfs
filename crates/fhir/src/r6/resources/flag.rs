// @generated by helios-fhir-gen (R6 Flag) — do not edit
...
pub struct Flag {
    ...
    /// Business identifier
    /// 
    /// Business identifiers assigned to this flag by the author or other systems
    ...
    /// surgery or tumor. Flag.supportingInfo replaced the extension [Flag
    /// details](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-flag-detail.html)
