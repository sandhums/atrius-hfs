...
#[fhir_resource(choice_elements = "start", summary_fields = "id,meta,implicit_rules,modifier_extension,lifecycle_status,achievement_status,category,priority,description,subject,start,status_date,recorder,source")]
pub struct Goal {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/goal-status|6.0.0-ballot3
...
pub struct GoalAcceptance {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/goal-accept-status|6.0.0-ballot3
