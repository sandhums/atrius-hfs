// @generated by helios-fhir-gen (R6 Condition) — do not edit
...
pub struct Condition {
    ...
    /// Fall in (into) filled bathtub or bucket of water). Otherwise, use [Condition
    /// Due
    /// To](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-condition-dueTo.html)
