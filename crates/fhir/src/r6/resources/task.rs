// AUTO-GENERATED by atrius-fhir-generator (R6 Task)
use crate::r6::*;
...
pub struct Task {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/task-status|6.0.0-ballot3
    pub status: Code,
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/task-intent|6.0.0-ballot3
    pub intent: Code,
    ...
    /// Typically a Task should only have one focus. If multiple focuses are
    /// provided, then action must be taken on the complete set as a whole (i.e,. all
...
/// Choice of types for the value\[x\] field in TaskFocus
...
pub struct TaskFocus {
    ...
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_serde(flatten)]
    pub value: Option<TaskFocusValue>,
}
...
pub struct TaskRestriction {
    ...
    /// single device. If just creating a Task that is to manipulate a device in the
    /// absence of a broader order, there's no need for restriction.recipient. The
