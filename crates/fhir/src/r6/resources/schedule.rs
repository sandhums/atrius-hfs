// @generated by helios-fhir-gen (R6 Schedule) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,service_category,service_type,specialty,name,actor,planning_horizon")]
pub struct Schedule {
    ...
    /// 
    /// ## Implementation Notes
    /// This MAY be used to describe what the schedule is for where it is clearer
