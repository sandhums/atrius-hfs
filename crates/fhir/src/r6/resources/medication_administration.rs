// @generated by helios-fhir-gen (R6 MedicationAdministration) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,part_of,status,medication,subject,occurrence,recorded,performer")]
...
pub struct MedicationAdministrationDosage {
    ...
    /// identify and track separately) then use the standard extension [BodyStructure
    /// Reference](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-bodySite.html).
