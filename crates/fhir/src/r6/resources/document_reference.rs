...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,version,status,doc_status,modality,r#type,category,subject,context,body_structure,period,date,author,relates_to,description,security_label,content")]
