// @generated by helios-fhir-gen (R6 Questionnaire) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,derived_from,status,experimental,subject_type,date,publisher,contact,description,use_context,jurisdiction,effective_period,code")]
pub struct Questionnaire {
    ...
    /// expectations - [Questionnaire Derivation
    /// Type](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-questionnaire-derivationType.html).
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// ## Special Semantics
    /// - Order meaning: The order items are listed indicates the order in which they should be presented to the user (if they are enabled)
    /// 
    /// ## Constraints
    ...
    ///   Expression: `(type in ('string' | 'decimal' | 'integer' | 'text' | 'date' | 'dateTime' | 'time' | 'url')) or answerConstraint='optionsOrString' or maxLength.empty()`
...
pub struct QuestionnaireItem {
    ...
    /// The value may come from the ElementDefinition referred to by .definition.
    /// 
    /// For guidance on handling alternative item types, refer to [this
    /// section](questionnaire.html#alternativetype).
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Constraints
    ...
    /// [enableWhenExpression](https://hl7.org/fhir/uv/sdc/en/StructureDefinition-sdc-questionnaire-enableWhenExpression.html)
    /// extension. For example, logic that involves a mixture of and and or logic,
    /// checking for membership in a value set or within a range, etc.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
    ...
    /// - **que-19**: When using codings, both code and system should be present.  See FHIR specification Questionnaire 'Using Coded Answers' usage notes for guidance. (warning)
    ///   Expression: `answer is Coding implies answer.system.exists()`
    /// 
    /// ## Conditions
    /// Used when: que-12
    ...
    /// the same linkId in the QuestionnaireResponse. For a question, it will be
    /// represented by a single item with that linkId with multiple answers.
    /// 
    /// If a question is marked as repeats=true, then multiple distinct answers can
    /// be provided for the question in the corresponding QuestionnaireResponse. When
    ...
    /// 
    /// ## Special Semantics
    /// - Order meaning: The order of the options indicates the order in which they should be presented to the user by default.  Extensions may drive changes to the presentation order.
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **que-20**: When using codings, both code and system should be present.  See FHIR specification Questionnaire 'Using Coded Answers' usage notes for guidance. (warning)
    ///   Expression: `value is Coding implies value.system.exists()`
    /// 
    /// ## Conditions
    ...
    /// marked as read-only). If the user does not change the value, then this
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **que-21**: When using codings, both code and system should be present.  See FHIR specification Questionnaire 'Using Coded Answers' usage notes for guidance. (warning)
    ///   Expression: `value is Coding implies value.system.exists()`
    /// 
    /// ## Conditions
