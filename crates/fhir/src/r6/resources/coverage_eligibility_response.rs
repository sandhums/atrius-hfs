// AUTO-GENERATED by atrius-fhir-generator (R6 CoverageEligibilityResponse)
use crate::r6::*;
...
#[fhir_resource(choice_elements = "serviced", summary_fields = "id,meta,implicit_rules,modifier_extension,status,status_reason,purpose,patient,created,request,outcome,insurer")]
pub struct CoverageEligibilityResponse {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/eligibilityresponse-purpose|6.0.0-ballot3
    ...
    /// 
    /// The provider which is responsible for the eligibility, claim,
    /// predetermination or preauthorization request.
    /// 
    /// ## Implementation Notes
    /// This party is responsible for the request but not necessarily professionally
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/eligibility-outcome|6.0.0-ballot3
    pub outcome: Code,
    /// Disposition Message
    /// 
