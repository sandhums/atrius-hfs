// @generated by helios-fhir-gen (R6 CoverageEligibilityResponse) — do not edit
...
pub struct CoverageEligibilityResponseInsurance {
    ...
    /// Coverage in-force indicator
    /// 
    /// Flag indicating if the coverage provided is in-force currently if no service
