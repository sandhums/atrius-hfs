// @generated by helios-fhir-gen (R6 ObservationDefinition) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm,device", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,effective_period,derived_from_canonical,derived_from_uri,subject,performer_type,category,code")]
pub struct ObservationDefinition {
    ...
    /// that are listed. These contexts may be general categories (gender, age, etc.)
    /// or may be references to specific programs (insurance plans, studies, etc.)
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **Description**: Codes identifying the type of subject for an observation definition, such as organisms or physical objects.
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/observation-subject-type
    ...
    /// 
    /// A reference to additional devices, kits, or reagents (e.g., TestKit,
    /// Calibration Kit, QC materials) to support the generation of the measurement.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
...
pub struct ObservationDefinitionComponent {
    ...
    /// Quantity | CodeableConcept | string | boolean | integer | Range | Ratio | SampledData | time | dateTime | Period
    /// 
    /// The data types allowed for the value element of the instance of these
