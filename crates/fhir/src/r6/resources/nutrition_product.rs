// AUTO-GENERATED by atrius-fhir-generator (R6 NutritionProduct)
use crate::r6::*;
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,code,status,category,manufacturer,nutrient")]
pub struct NutritionProduct {
    ...
    /// number, a USDA Food Data Central (FDC) ID number, Universal Product Code
    /// (UPC), a Langual code, or a country specific food database code.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/nutritionproduct-status|6.0.0-ballot3
    pub status: Code,
    ...
    /// 
    /// ## Requirements
    /// Allows identification of the product as it is known by various participating
    ...
    /// 
    /// ## Implementation Notes
    /// If structured ingredient information is present, the ingredientSummary should
    /// be consistent.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
...
pub struct NutritionProductIngredient {
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **Description**: Codes identifying the specific ingredient.
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/edible-substance-type
    ...
    /// 
    /// ## Implementation Notes
    /// Quantity is allowed to specify a specific amount of an ingredient, eg. 100mg
    /// or 100 mg/mL. Ratio is to say 100mg / 5mL and you don't want to normalize the
    /// ratio. Quantity also allows for indicating trace amounts of ingredients.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
...
pub struct NutritionProductNutrient {
    ...
    /// 
    /// The amount of nutrient expressed in one or more units, either X per pack /
    /// per serving / per dose or X amount.
    /// 
    /// ## Implementation Notes
    /// Quantity is allowed to specify a specific amount of a nutrient, eg. 100mg or
    /// 100 mg/serving. Ratio is to say 100mg / 5mL and you don't want to normalize
    /// the ratio. Quantity also allows for indicating trace amounts of nutrients.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
