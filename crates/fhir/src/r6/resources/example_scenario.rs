// @generated by helios-fhir-gen (R6 ExampleScenario) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,description,use_context,jurisdiction")]
pub struct ExampleScenario {
    ...
    /// 
    /// ## Implementation Notes
    /// It is not expected that ExampleScenarios will be used to generate code, as
    /// they are only examples and not definitional. However, this element is
    /// retained to remain compatible with the canonical resource interface. Systems
    /// are free to omit populating the element.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// ## Special Semantics
    /// - Modifier element - This is labeled as "Is Modifier" because applications should not use a retired ExampleScenario without due consideration
    /// - Included in summary
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ...
    /// 
    /// ## Special Semantics
    /// - Order meaning: The order in which these elements appear is the order in which they are expected to be rendered (in a table, in a diagram, etc.)
    /// 
    /// ## Constraints
    ...
    /// - **exs-24**: actor SHALL have either a type or a definition but not both (error)
...
pub struct ExampleScenarioActor {
    ...
    /// 
    /// ## Requirements
    /// The title for a particular actor might be more refined/specific than what's
    /// found on the definition, if one is provided
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Requirements
    /// The description for a particular actor might be more refined/specific than
    /// what's found on the definition, if one is provided
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Implementation Notes
    /// The title and description appearing in this resource may differ from that in
    /// the formal definition. The type SHALL be the same.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
...
pub struct ExampleScenarioInstance {
    ...
    /// 
    /// ## Implementation Notes
    /// This element may be omitted if describing a step that does not involve the
    /// sharing of a data structure - e.g. a human action
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Implementation Notes
    /// Not used if an instance does not change
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Requirements
    /// An instance may contain multiple resources - for example, a search response
    /// Bundle, a document Bundle, nested contained resources, etc. In some cases
    /// it's useful to be able to talk about these contained instances distinctly, as
    /// they may appear in multiple locations in a scenario - sometimes contained,
    /// sometimes not. For example, a scenario may include the creation of an
    /// Observation (stand-alone instance) followed by a search that results in a
    /// Bundle that contains that same Observation. The ExampleScenario can highlight
    /// the fact that the 'created' instance and 'contained' instance are the same by
    /// having the Bundle refer to the same instance id.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
...
pub struct ExampleScenarioProcess {
    ...
    /// 
    /// ## Special Semantics
    /// - Order meaning: The order in which these elements appear is the order in which they are expected to be rendered (in a table, in a diagram, etc.).  It also indicates the order in which the events occur.
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
...
pub struct ExampleScenarioProcessStep {
    ...
    /// to be numeric. E.g. '2c' is a valid step number. The 'number' should only
    /// contain the textual part of the step identifier, not any separating
    /// punctuation. I.e. 'number' should be '2c' not '2c.' or '2c)' or '2c - '.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// - **exs-26**: A definition can only be provided if the type is 'operation' (error)
    ///   Expression: `definition.exists() implies type.code = 'operation' and type.system = 'http://hl7.org/fhir/restful-interaction'`
    /// 
    /// ## Conditions
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children or both (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **exs-25**: Alternative steps can't have alternatives (error)
    ///   Expression: `step.alternative.exists().not()`
    /// 
    /// ## Conditions
    /// Used when: exs-13
...
pub struct ExampleScenarioProcessStepOperation {
    ...
    /// 
    /// ## Implementation Notes
    /// This binding is extensible to provide support for non-FHIR interactions as
    /// well
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    ...
    /// Operation invoked
    /// 
    /// If this operation represents the invocation of a FHIR operation, points to
    /// the canonical definition of that operation.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
