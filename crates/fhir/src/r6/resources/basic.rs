// @generated by helios-fhir-gen (R6 Basic) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,code,subject,created,author")]
pub struct Basic {
