// @generated by helios-fhir-gen (R6 AdministrableProductDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,form_of,administrable_dose_form,unit_of_presentation,produced_from,ingredient,device,code,property,route_of_administration")]
