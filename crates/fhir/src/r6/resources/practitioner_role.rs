// AUTO-GENERATED by atrius-fhir-generator (R6 PractitionerRole)
use crate::r6::*;
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,period,practitioner,organization,network,code,display,specialty,location")]
