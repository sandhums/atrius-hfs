// @generated by helios-fhir-gen (R6 PractitionerRole) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,period,practitioner,organization,code,display,specialty,location")]
pub struct PractitionerRole {
    ...
    /// 
    /// ## Implementation Notes
    /// Some relationships (represented as PractitionerRoles) that may exist between
    /// practitioners and organizations include:
    /// * A practitioner may act as a pediatrician when associated with an
    ///   organization that runs a family clinic. PractitionerRole.organization would
    ///   represent the family clinic.
    /// * The same practitioner may act as a physician when providing physicals for
    ///   an athletics department at a school. PractitionerRole.organization would
    ///   represent the school.
    /// * A practitioner may perform coumadin / anticoagulation services for a clinic
    ///   run by a health system. PractitionerRole.organization would represent the
    ///   coumadin clinic.
    /// * A practitioner may act as an inpatient pharmacist reviewing and dispensing
    ///   medications. PractitionerRole.organization would represent the hospital
    ///   pharmacy.
    /// * A practitioner may perform medication management and adherence services for
    ///   an internal medicine clinic. PractitionerRole.organization would represent
    ///   the internal medicine clinic.
    /// * A practitioner is part of a payer's network (such as a preferred provider
    ///   organization (PPO), or health maintenance organizations (HMO)).
    ///   PractitionerRole.organization would represent the payer's network.
    /// 
    /// Each of the examples above above, would be represented as different
    /// PractitionerRole instances, each with a different values for
    ...
    /// 
    /// A value that describes the intersection of the practitioner, organization,
    /// and the role of the practitioner within the organization. This is not the
    /// human name of the practitioner, though the textual representation of that
    /// human name may be a part of this property.
    /// 
    /// ## Implementation Notes
    /// The PractitionerRole display value may be considered a de-normalized value
    /// from Practitioner and/or Organization for the purposes of convenient display
    /// in both the PractitionerRole resources and reference to it. When a system is
    /// consuming a PractitionerRole resource and displaying a name to a user, they
    /// may choose to use PractitionerRole.display, or they could use one or both of
    /// the names from the referenced Practitioner and/or Organization resources
    /// along with the role or other relevant properties in PractitionerRole.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    ...
    /// 
    /// The contact details of available ways to contact the specific
    /// PractitionerRole for specific purposes. This can include addresses, phone
    /// numbers, fax numbers, mobile numbers, email addresses, web sites and various
    /// addresses.
    /// 
    /// ## Requirements
