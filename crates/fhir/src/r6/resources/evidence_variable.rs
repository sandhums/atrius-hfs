// @generated by helios-fhir-gen (R6 EvidenceVariable) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,short_title,status,date,publisher,contact,description,use_context,definition")]
pub struct EvidenceVariable {
    ...
    /// that versions can be placed in a lexicographical sequence. For more
    /// information on versioning knowledge artifacts, refer to the Canonical
    /// Resource Management Infrastructure (CRMI) implementation guide artifact
    ...
    /// ## Binding
    /// - **Strength**: extensible
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/evidence-variable-handling
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/evidence-variable-classifier-example
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/evidence-variable-unacceptable-data-handling
