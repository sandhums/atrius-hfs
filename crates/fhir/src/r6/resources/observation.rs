// @generated by helios-fhir-gen (R6 Observation) — do not edit
...
pub struct Observation {
    ...
    ///   file (for example 'X' detected and here is the proof in this image), the
    ///   binary file may be directly represented using *DocumentReference* and
    ...
    /// lab results or other observations. Similarly, information about the timing,
