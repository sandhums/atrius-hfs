// AUTO-GENERATED by atrius-fhir-generator (R6 Ingredient)
use crate::r6::*;
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,r#for,role,function,group,allergenic_indicator,manufacturer,substance")]
pub struct Ingredient {
    ...
    /// to describe that (rather than just a code), the allergen information should
    /// go there, not here.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
...
pub struct IngredientManufacturer {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/ingredient-manufacturer-role|6.0.0-ballot3
...
pub struct IngredientSubstanceStrength {
    ...
    /// 
    /// A textual representation of either the whole of the presentation strength or
    ...
    /// 
    /// A textual representation of either the whole of the concentration strength or
    ...
    /// ingredient substance as stated or on the substance base (when the ingredient
    /// is a salt).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
