...
#[fhir_resource(choice_elements = "deceased,multipleBirth", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,name,telecom,gender,birth_date,deceased,address,managing_organization,link")]
pub struct Patient {
