// @generated by helios-fhir-gen (R6 EventDefinition) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm,subject", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,approval_date,last_review_date,effective_period,trigger")]
pub struct EventDefinition {
    ...
    /// Logic used by the event definition
    /// 
