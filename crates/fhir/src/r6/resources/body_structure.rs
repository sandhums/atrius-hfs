// @generated by helios-fhir-gen (R6 BodyStructure) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,description,patient")]
pub struct BodyStructure {
    ...
    /// 
    /// ## Requirements
    /// A body structure entry must be able to be marked as invalid if it was created
    /// in error.
    /// 
    /// ## Implementation Notes
...
pub struct BodyStructureIncludedStructure {
    ...
    /// without defining a morphology. When multiple morphologic characteristics
    /// apply to the same body structure, a single pre-coordinated terminology
    /// concept or post-coordinated expression may be used when an appropriate
    /// representation exists. Multiple repetitions of morphology can be used to
    /// represent individual morphologic characteristics when no suitable single
    /// concept or expression is available.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
    ...
    pub morphology: Option<Vec<CodeableConcept>>,
    /// Origin of the body structure
    /// 
    /// The origin of the included body structure, such as autologous, allogeneic,
    /// synthetic, or other source.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **Description**: Codes describing the origin of a body structure.
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/bodystructure-origin
    pub origin: Option<Vec<CodeableConcept>>,
}
