...
#[fhir_resource(choice_elements = "versionAlgorithm,subject", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,derived_from_canonical,derived_from_uri,status,experimental,subject,date,publisher,contact,jurisdiction,effective_period,type_collected,patient_preparation,time_aspect,collection")]
