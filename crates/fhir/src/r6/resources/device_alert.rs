// @generated by helios-fhir-gen (R6 DeviceAlert) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,procedure,status,category,priority,code,subject,encounter,occurrence,device,location")]
pub struct DeviceAlert {
    ...
    /// ## Binding
    /// - **Strength**: example
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/devicealert-category
    pub category: Option<Vec<CodeableConcept>>,
    /// The particular kind of alert
    /// 
    /// The particular kind of alert, such as whether it is related to the patient
    /// condition; to irregular device state; or to workflow or regular device state,
    /// such as timers.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    ...
    /// ## Binding
    /// - **Strength**: extensible
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/devicealert-type
    ...
    /// ## Binding
    /// - **Strength**: preferred
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/devicealert-condition
    ...
    /// condition is or was active. The absence of `occurrence.end` usually indicates
    /// that the alert condition was ongoing at the last update. Coincident
    /// `occurrence.start` and `occurrence.end` values allow the expression of
    /// instantaneous alert conditions. Implementers should remain aware that
    /// partially specified `dateTime` values for `occurrence.start` or
    /// `occurrence.end` are ambiguous about what point in time they represent.
    /// Corner cases, such representing an alert condition known to be ongoing
    /// without knowledge of the start time, may require special handling such as use
    /// of [extensions](extensibility.html)—consult relevant implementation guides.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
...
pub struct DeviceAlertSignal {
    ...
    /// 
    /// ## Requirements
    /// Allows identification of the `signal` as it is known by various participating
    ...
    /// deactivated or temporarily deactivated (i.e., paused). An activated signal is
    /// not necessarily present; a present signal is always activated.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
    ...
    /// Indicates whether signal annunciation is occurring, along with the underlying reason
    /// 
    /// Indicates whether signal annunciation is occurring, along with the underlying
    /// reason. An `on` signal is currently being annunciated; a `latched` signal is
    /// currently being annunciated although the alert condition has ended; an `off`
    /// signal is not currently being annunciated; and an `acknowledged` signal is
    /// not currently being annunciated because the user has acknowledged the signal.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// ## Binding
    /// - **Strength**: extensible
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/devicealert-presence
    ...
    /// ## Binding
    /// - **Strength**: required
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/devicealert-annunciation|1.0.0
    ...
    /// ## Binding
    /// - **Strength**: extensible
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/devicealert-manifestation
    ...
    /// `period.end` is indicated, the signalling state is presumed to be on-going at
    /// last update.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
