...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,procedure,status,category,priority,code,subject,encounter,occurrence,device,location"
)]
