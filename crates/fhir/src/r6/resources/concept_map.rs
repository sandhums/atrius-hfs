...
#[fhir_resource(choice_elements = "versionAlgorithm,sourceScope,targetScope", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,effective_period,property,additional_attribute,source_scope,target_scope")]
