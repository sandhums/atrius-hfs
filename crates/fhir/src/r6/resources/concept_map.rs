// @generated by helios-fhir-gen (R6 ConceptMap) — do not edit
...
pub struct ConceptMap {
    ...
    /// 
    /// The only values that can be used to populate the
    /// ConceptMap.group.element.target.relationship in this ConceptMap.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
    /// - Included in summary
    /// - When missing: Any relationship can be used
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
