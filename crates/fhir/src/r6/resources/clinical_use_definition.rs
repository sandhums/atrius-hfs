...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,r#type,category,subject,status,undesirable_effect,indication,contraindication,interaction,population,library,warning")]
