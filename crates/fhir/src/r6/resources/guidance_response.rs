// @generated by helios-fhir-gen (R6 GuidanceResponse) — do not edit
...
pub struct GuidanceResponse {
    ...
    /// entered-in-error status is used to provide a way for systems to mark
    /// incorrectly entered information without removing the record. In addition, the
    /// status of a GuidanceResponse reflects the ability of the delivering system to
    ...
    /// much detail as possible by using the [Target
    /// element](https://build.fhir.org/ig/HL7/fhir-extensions/StructureDefinition-targetElement.html)
    /// and [Target
