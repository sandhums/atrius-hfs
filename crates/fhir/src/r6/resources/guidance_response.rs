...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,request_identifier,identifier,module,status,subject,encounter,occurrence_date_time,location,reason,indicator"
)]
