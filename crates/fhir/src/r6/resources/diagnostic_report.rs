// AUTO-GENERATED by atrius-fhir-generator (R6 DiagnosticReport)
use crate::r6::*;
...
#[fhir_resource(choice_elements = "effective", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,category,code,subject,encounter,effective,issued,procedure,performer,results_interpreter,media,recomendation")]
pub struct DiagnosticReport {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/diagnostic-report-status|6.0.0-ballot3
    pub status: Code,
    /// Service category
    /// 
    ...
    /// being reported by the DiagnosticReport were obtained/acquired. When a
    ...
    /// the clinical report. In the regulated context of diagnostic laboratory work
    /// on humans, it is extremely likely that regulation requires a human performer.
    ...
    /// between the referring physician and the patient or a subsequent specialist)
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    pub comparison: Option<Reference>,
}
