// AUTO-GENERATED by atrius-fhir-generator (R6 Slot)
use crate::r6::*;
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,service_category,service_type,specialty,appointment_type,schedule,status,start,end")]
pub struct Slot {
    ...
    /// - **ValueSet**: http://hl7.org/fhir/ValueSet/slotstatus|6.0.0-ballot3
    pub status: Code,
