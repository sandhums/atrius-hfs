// @generated by helios-fhir-gen (R6 Immunization) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,based_on,status,vaccine_code,patient,occurrence,primary_source,performer,note,is_subpotent")]
pub struct Immunization {
    ...
    /// Reason not done
    /// 
    /// Indicates the reason the immunization event was **not performed** or was
    /// **entered in error**.
    /// 
    /// ## Implementation Notes
    /// This element is only used for the status of "not-done" or "entered-in-error".
    /// The reason for performing the immunization event is captured in reasonCode,
    /// not here.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
...
pub struct ImmunizationPerformer {
    ...
    /// - **Strength**: extensible
    /// - **Description**: x
    /// - **ValueSet**: http://terminology.hl7.org/ValueSet/immunization-function
