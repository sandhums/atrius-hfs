...
pub struct QuestionnaireCategoryCodes;

impl QuestionnaireCategoryCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/questionnaire-category";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "questionnaire_category";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "273601006" | "273820006" | "273479001" | "273384008" | "304784009"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "273601006" => Some("Mental status questionnaire"),
                "273820006" => Some("Social support questionnaire"),
                "273479001" => Some("General health questionnaire"),
                "273384008" => Some("Consumer satisfaction questionnaire"),
                "304784009" => Some("Administrative form"),
                _ => None,
            };
        }
        None
