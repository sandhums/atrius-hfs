...
pub struct AuditEventEntityType;

impl AuditEventEntityType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/audit-entity-type";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "audit_entity_type_382f1935";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/audit-entity-type" {
            return Some(super::super::code_systems::AuditEventEntityType::try_from_code(code).is_some());
        }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/audit-entity-type" {
            return super::super::code_systems::AuditEventEntityType::try_from_code(code).and_then(|c| c.display());
        }
        if system == "http://hl7.org/fhir/resource-types" {
