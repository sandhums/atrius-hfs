...
impl ContractResourceDefinitionTypeCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/contract-definition-type" {
            return Some(
                super::super::code_systems::ContractResourceDefinitionTypeCodes::try_from_code(
                    code,
                )
                .is_some(),
            );
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/contract-definition-type" {
            return super::super::code_systems::ContractResourceDefinitionTypeCodes::try_from_code(
                code,
            )
