...
pub struct ServiceRequestOrderDetailsCodes;

impl ServiceRequestOrderDetailsCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/servicerequest-orderdetail";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "servicerequest_orderdetail";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "47545007" | "286812008" | "243144002" | "243150007" | "59427005"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "47545007" => Some("Continuous positive airway pressure ventilation treatment (regime/therapy)"),
                "286812008" => Some("Pressure controlled ventilation (procedure)"),
                "243144002" => Some("Patient triggered inspiratory assistance (procedure)"),
                "243150007" => Some("Assisted controlled mandatory ventilation (procedure)"),
                "59427005" => Some("Synchronized intermittent mandatory ventilation (procedure)"),
                _ => None,
            };
        }
        None
