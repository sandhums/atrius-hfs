...
pub struct CoverageSelfPayCodes;

impl CoverageSelfPayCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/coverage-selfpay";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "coverage_selfpay_84c2983c";
