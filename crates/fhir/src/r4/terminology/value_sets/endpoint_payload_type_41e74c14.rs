...
impl EndpointPayloadType {
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/endpoint-payload-type" {
            return super::super::code_systems::EndpointPayloadType::try_from_code(code).and_then(|c| c.display());
        }
        if system == "urn:oid:1.3.6.1.4.1.19376.1.2.3" {
            return match code {
                ...
                "urn:ihe:pcc:apr:handp:2008" => Some("Antepartum Record (APR) - History and Physical"),
                ...
                "urn:ihe:iti:bppc-sd:2007" => Some("Basic Patient Privacy Consents with Scanned Document"),
                ...
                "urn:ihe:rad:CDA:ImagingReportStructuredHeadings:2013" => Some("Radiology XDS-I Structured CDA"),
                ...
                "urn:ihe:pat:apsr:cancer:all:2010" => Some("Anatomic Pathology Structured Report Cancer All"),
                "urn:ihe:pat:apsr:cancer:breast:2010" => Some("Anatomic Pathology Structured Report Cancer Breast"),
                "urn:ihe:pat:apsr:cancer:colon:2010" => Some("Anatomic Pathology Structured Report Cancer Colon"),
                "urn:ihe:pat:apsr:cancer:prostate:2010" => Some("Anatomic Pathology Structured Report Cancer Prostate"),
                "urn:ihe:pat:apsr:cancer:thyroid:2010" => Some("Anatomic Pathology Structured Report Cancer Thyroid"),
                "urn:ihe:pat:apsr:cancer:lung:2010" => Some("Anatomic Pathology Structured Report Cancer Lung"),
                "urn:ihe:pat:apsr:cancer:skin:2010" => Some("Anatomic Pathology Structured Report Cancer Skin"),
                "urn:ihe:pat:apsr:cancer:kidney:2010" => Some("Anatomic Pathology Structured Report Cancer Kidney"),
                "urn:ihe:pat:apsr:cancer:cervix:2010" => Some("Anatomic Pathology Structured Report Cancer Cervix"),
                "urn:ihe:pat:apsr:cancer:endometrium:2010" => Some("Anatomic Pathology Structured Report Cancer Endometrium"),
                "urn:ihe:pat:apsr:cancer:ovary:2010" => Some("Anatomic Pathology Structured Report Cancer Ovary"),
                "urn:ihe:pat:apsr:cancer:esophagus: 2010" => Some("Anatomic Pathology Structured Report Cancer Esophagus"),
                "urn:ihe:pat:apsr:cancer:stomach: 2010" => Some("Anatomic Pathology Structured Report Cancer Stomach"),
                "urn:ihe:pat:apsr:cancer:liver:2010" => Some("Anatomic Pathology Structured Report Cancer Liver"),
                "urn:ihe:pat:apsr:cancer:pancreas: 2010" => Some("Anatomic Pathology Structured Report Cancer Pancreas"),
                "urn:ihe:pat:apsr:cancer:testis:2010" => Some("Anatomic Pathology Structured Report Cancer Testis"),
                "urn:ihe:pat:apsr:cancer:urinary_bladder:2010" => Some("Anatomic Pathology Structured Report Cancer Urinary Bladder"),
                "urn:ihe:pat:apsr:cancer:lip_oral_cavity:2010" => Some("Anatomic Pathology Structured Report Cancer Lip Oral Cavity"),
                "urn:ihe:pat:apsr:cancer:pharynx:2010" => Some("Anatomic Pathology Structured Report Cancer Pharynx"),
                "urn:ihe:pat:apsr:cancer:salivary_gland:2010" => Some("Anatomic Pathology Structured Report Cancer Salivary Gland"),
                "urn:ihe:pat:apsr:cancer:larynx:2010" => Some("Anatomic Pathology Structured Report Cancer Larynx"),
                ...
                "urn:hl7-org:sdwg:ccda-structuredBody:1.1" => Some("For documents following C-CDA constraints using a structured body. "),
                "urn:hl7-org:sdwg:ccda-nonXMLBody:1.1" => Some("For documents following C-CDA constraints using a non structured body. "),
                _ => None,
            };
        }
        None
