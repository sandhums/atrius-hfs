...
impl IdentifierTypeCodes {
    ...
    pub const MODULE: &'static str = "identifier_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v2-0203" {
            return Some(matches!(code, "DL" | "PPN" | "BRN" | "MR" | "MCN" | "EN" | "TAX" | "NIIP" | "PRN" | "MD" | "DR" | "ACSN" | "UDI" | "SNO" | "SB" | "PLAC" | "FILL" | "JHN"));
        }
        None
    }
