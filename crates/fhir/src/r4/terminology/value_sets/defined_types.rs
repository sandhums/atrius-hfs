...
pub struct FHIRDefinedType;

impl FHIRDefinedType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/defined-types";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "defined_types";
