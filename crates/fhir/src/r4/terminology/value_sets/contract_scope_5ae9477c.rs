...
impl ContractResourceScopeCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/contract-scope" {
            return Some(
                super::super::code_systems::ContractResourceScopeCodes_e61894f2::try_from_code(
                    code,
                )
                .is_some(),
            );
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/contract-scope" {
            return super::super::code_systems::ContractResourceScopeCodes_e61894f2::try_from_code(
                code,
            )
