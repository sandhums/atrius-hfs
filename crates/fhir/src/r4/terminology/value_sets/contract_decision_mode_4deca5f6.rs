...
impl ContractResourceDecisionModeCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/contract-decision-mode" {
            return Some(
                super::super::code_systems::ContractResourceDecisionModeCodes::try_from_code(code)
                    .is_some(),
            );
        }
        None
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/contract-decision-mode" {
            return super::super::code_systems::ContractResourceDecisionModeCodes::try_from_code(
                code,
            )
