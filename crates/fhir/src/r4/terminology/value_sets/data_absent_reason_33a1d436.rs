...
impl DataAbsentReason {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/data-absent-reason";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "data_absent_reason_33a1d436";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/data-absent-reason" {
            return Some(super::super::code_systems::DataAbsentReason::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/data-absent-reason" {
            return super::super::code_systems::DataAbsentReason::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
