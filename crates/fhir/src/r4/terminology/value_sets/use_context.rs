...
impl ContextOfUseValueSet {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/usps-state (not generated locally)
        any_none = true;
        // http://hl7.org/fhir/ValueSet/practitioner-specialty
        match super::super::value_sets::practitioner_specialty_5432bb2a::PractitionerSpecialty::contains(system, code) {
