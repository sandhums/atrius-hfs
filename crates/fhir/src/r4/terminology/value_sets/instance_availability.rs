...
impl InstanceAvailability {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/instance-availability";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "instance_availability";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://dicom.nema.org/resources/ontology/DCM" {
            return Some(matches!(code, "ONLINE" | "OFFLINE" | "NEARLINE" | "UNAVAILABLE"));
        }
        None
    }
