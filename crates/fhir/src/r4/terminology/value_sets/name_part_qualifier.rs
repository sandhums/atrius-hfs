...
pub struct EntityNamePartQualifier;

impl EntityNamePartQualifier {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/name-part-qualifier";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "name_part_qualifier";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2" {
            return Some(matches!(code, "LS" | "AC" | "NB" | "PR" | "HON" | "BR" | "AD" | "SP" | "MID" | "CL" | "IN"));
        }
        if system == "http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifier" {
            return Some(matches!(code, "VV"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-EntityNamePartQualifierR2" {
            return match code {
                "LS" => Some("Legal status"),
                "AC" => Some("Academic"),
                "NB" => Some("Nobility"),
                "PR" => Some("Professional"),
                "HON" => Some("Honorific"),
                "BR" => Some("Birth"),
                "AD" => Some("Acquired"),
                "SP" => Some("Spouse"),
                "MID" => Some("Middle Name"),
                "CL" => Some("Call me"),
                "IN" => Some("Initial"),
                _ => None,
            };
