...
impl MedicationrequestStatus {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/CodeSystem/medicationrequest-status" {
            return Some(super::super::code_systems::MedicationrequestStatus::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/CodeSystem/medicationrequest-status" {
            return super::super::code_systems::MedicationrequestStatus::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
