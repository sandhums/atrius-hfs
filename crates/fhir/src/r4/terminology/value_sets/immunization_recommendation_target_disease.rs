...
pub struct ImmunizationRecommendationTargetDiseaseCodes;

impl ImmunizationRecommendationTargetDiseaseCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-recommendation-target-disease";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "immunization_recommendation_target_disease";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "1857005" | "397430003" | "14189004" | "36989005" | "36653000" | "76902006" | "709410003" | "27836007" | "398102009"));
        }
        None
    }
