...
impl ParticipantType {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/encounter-participant-type";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "encounter_participant_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType" {
            if matches!(code, "SPRF" | "PPRF" | "PART") { return Some(true); }
            return None;
        }
        if system == "http://terminology.hl7.org/CodeSystem/participant-type" {
            return Some(super::super::code_systems::ParticipantType::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        ...
        if system == "http://terminology.hl7.org/CodeSystem/participant-type" {
            return super::super::code_systems::ParticipantType::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
