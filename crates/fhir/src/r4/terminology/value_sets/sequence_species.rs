...
pub struct SNOMEDCTCodesForSpecies;

impl SNOMEDCTCodesForSpecies {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/sequence-species";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "sequence_species";
