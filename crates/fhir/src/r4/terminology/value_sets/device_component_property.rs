...
pub struct DeviceDefinitionPropertyCode;

impl DeviceDefinitionPropertyCode {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/device-component-property";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "device_component_property";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:iso:std:iso:11073:10101" {
            return Some(matches!(code, "68219" | "68220" | "68221" | "68222" | "68223" | "68224" | "68226" | "532353" | "532354" | "532355"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "urn:iso:std:iso:11073:10101" {
            return match code {
                "68219" => Some("MDC_TIME_CAP_STATE"),
                "68220" => Some("MDC_TIME_SYNC_PROTOCOL"),
                "68221" => Some("MDC_TIME_SYNC_ACCURACY"),
                "68222" => Some("MDC_TIME_RES_ABS"),
                "68223" => Some("MDC_TIME_RES_REL"),
                "68224" => Some("MDC_TIME_RES_REL_HI_RES"),
                "68226" => Some("MDC_TIME_RES_BO"),
                "532353" => Some("MDC_REG_CERT_DATA_CONTINUA_CERT_DEV_LIST"),
                "532354" => Some("MDC_REG_CERT_DATA_CONTINUA_REG_STATUS"),
                "532355" => Some("MDC_REG_CERT_DATA_CONTINUA_PHG_CERT_LIST"),
                _ => None,
            };
        }
        None
