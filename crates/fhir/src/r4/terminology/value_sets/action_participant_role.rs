...
pub struct ActionParticipantRole;

impl ActionParticipantRole {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/action-participant-role";
    pub const VERSION: &'static str = "4.0.1";
    pub const MODULE: &'static str = "action_participant_role";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/practitioner-role
        match super::super::value_sets::practitioner_role_dfd93bf2::PractitionerRole::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/relatedperson-relationshiptype
        match super::super::value_sets::relatedperson_relationshiptype::PatientRelationshipType::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
