...
impl QuestionnaireResponseStatus {
    pub const URL: &'static str = "http://hl7.org/fhir/questionnaire-answers-status";
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            ...
            Self::Stopped => Some("This QuestionnaireResponse has been partially filled out with answers but has been abandoned. It is unknown whether changes or additions are expected to be made to it."),
        }
    }
