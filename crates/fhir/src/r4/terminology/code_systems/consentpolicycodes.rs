...
pub enum ConsentPolicyRuleCodes {
    Cric,
...
impl ConsentPolicyRuleCodes {
    ...
    pub fn display(self) -> Option<&'static str> {
        match self {
            ...
            Self::IllinoisMinorProcedure => Some("Illinois Consent by Minors to Medical Procedures"),
            ...
            Self::Mdhhs5515 => Some("Michigan MDHHS-5515 Consent to Share Behavioral Health Information for Care Coordination Purposes"),
            ...
            Self::NihGrdr => Some("NIH Global Rare Disease Patient Registry and Data Repository consent"),
