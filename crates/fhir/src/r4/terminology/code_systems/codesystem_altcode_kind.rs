...
pub enum AlternativeCodeKind_22506499 {
    Alternate,
    Deprecated,
    CaseInsensitive,
    CaseSensitive,
...
impl AlternativeCodeKind_22506499 {
    pub const URL: &'static str = "http://terminology.hl7.org/CodeSystem/codesystem-altcode-kind";
