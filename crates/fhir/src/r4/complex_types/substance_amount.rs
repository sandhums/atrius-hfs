// @generated by helios-fhir-gen (R4 SubstanceAmount) — do not edit
...
#[fhir_resource(choice_elements = "amount", summary_fields = "modifier_extension,amount,amount_type,amount_text,reference_range")]
