// @generated by helios-fhir-gen (R4 MedicinalProductIndication) — do not edit
...
/// FHIR MedicinalProductIndication type
/// 
...
/// FHIR Version: 4.0.1
/// 
/// See: [MedicinalProductIndication](http://hl7.org/fhir/StructureDefinition/MedicinalProductIndication)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(summary_fields = "id,meta,implicit_rules,subject,disease_symptom_procedure,disease_status,comorbidity,intended_effect,duration,other_therapy,undesirable_effect,population")]
