...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,subject,disease_symptom_procedure,disease_status,comorbidity,intended_effect,duration,other_therapy,undesirable_effect,population"
)]
