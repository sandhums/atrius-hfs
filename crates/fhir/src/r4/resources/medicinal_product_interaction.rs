// @generated by helios-fhir-gen (R4 MedicinalProductInteraction) — do not edit
...
/// FHIR Version: 4.0.1
/// 
/// See: [MedicinalProductInteraction](http://hl7.org/fhir/StructureDefinition/MedicinalProductInteraction)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(summary_fields = "id,meta,implicit_rules,subject,description,interactant,r#type,effect,incidence,management")]
