// @generated by helios-fhir-gen (R4 MedicinalProductAuthorization) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,subject,country,jurisdiction,status,status_date,restore_date,validity_period,data_exclusivity_period,date_of_first_authorization,international_birth_date,legal_basis,jurisdictional_authorization,holder,regulator,procedure")]
