// @generated by helios-fhir-gen (R4 MedicinalProductManufactured) — do not edit
...
/// FHIR MedicinalProductManufactured type
/// 
...
/// FHIR Version: 4.0.1
/// 
/// See: [MedicinalProductManufactured](http://hl7.org/fhir/StructureDefinition/MedicinalProductManufactured)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(summary_fields = "id,meta,implicit_rules,manufactured_dose_form,unit_of_presentation,quantity,manufacturer,ingredient,physical_characteristics,other_characteristics")]
