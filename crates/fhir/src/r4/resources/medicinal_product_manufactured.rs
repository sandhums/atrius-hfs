...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,manufactured_dose_form,unit_of_presentation,quantity,manufacturer,ingredient,physical_characteristics,other_characteristics"
)]
