// @generated by helios-fhir-gen (R4 RiskEvidenceSynthesis) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,date,publisher,contact,description,use_context,jurisdiction,effective_period,population,exposure,outcome,risk_estimate")]
