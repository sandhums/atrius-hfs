...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,short_title,status,date,publisher,contact,description,use_context,jurisdiction,effective_period,r#type,characteristic"
)]
