// @generated by helios-fhir-gen (R4 EvidenceVariable) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,short_title,status,date,publisher,contact,description,use_context,jurisdiction,effective_period,r#type,characteristic")]
pub struct EvidenceVariable {
    ...
    /// 
    /// ## Implementation Notes
    /// It may be possible for the evidence variable to be used in jurisdictions
    ...
    /// evidence variable and/or its content.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// allows for a sunsetting process when new versions of the evidence variable
    /// are or are expected to be used instead.
    /// 
    /// ## Implementation Notes
    /// The effective period for a evidence variable determines when the content is
    ...
    /// 
    /// ## Requirements
    /// Repositories must be able to determine how to categorize the EvidenceVariable
...
pub enum EvidenceVariableCharacteristicDefinition {
    ...
    #[fhir_serde(rename = "definitionTriggerDefinition")]
...
///   Expression: `hasValue() or (children().count() > id.count())`
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(choice_elements = "definition,participantEffective")]
