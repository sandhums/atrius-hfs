// @generated by helios-fhir-gen (R4 SubstanceReferenceInformation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,comment,gene,gene_element,classification,target")]
