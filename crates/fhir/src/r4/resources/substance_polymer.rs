// @generated by helios-fhir-gen (R4 SubstancePolymer) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,class,geometry,copolymer_connectivity,modification,monomer_set,repeat")]
...
pub struct SubstancePolymerRepeat {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_serde(rename = "numberOfUnits")]
...
pub struct SubstancePolymerRepeatRepeatUnit {
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    #[fhir_serde(rename = "orientationOfPolymerisation")]
