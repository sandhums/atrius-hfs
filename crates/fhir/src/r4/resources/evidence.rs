// @generated by helios-fhir-gen (R4 Evidence) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,url,identifier,version,name,title,status,date,publisher,contact,description,use_context,jurisdiction,effective_period,exposure_background,exposure_variant,outcome")]
pub struct Evidence {
