// @generated by helios-fhir-gen (R5 MedicationAdministration) — do not edit
...
#[fhir_resource(choice_elements = "occurence", summary_fields = "id,meta,implicit_rules,modifier_extension,part_of,status,medication,subject,occurence,recorded,performer")]
