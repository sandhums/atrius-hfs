// @generated by helios-fhir-gen (R5 Observation) — do not edit
...
#[fhir_resource(choice_elements = "instantiates,effective,value", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates,based_on,part_of,status,code,subject,focus,encounter,effective,issued,performer,value,has_member,derived_from,component")]
