// @generated by helios-fhir-gen (R5 ClinicalImpression) — do not edit
...
#[fhir_resource(choice_elements = "effective", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,description,subject,encounter,effective,date,performer,problem")]
pub struct ClinicalImpression {
    ...
    /// assessed, such as worsening, improving, or no change. It is a subjective
    /// assessment of the direction of the change.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
