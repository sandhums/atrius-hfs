// @generated by helios-fhir-gen (R5 InventoryReport) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,count_type,operation_type,operation_type_reason,reported_date_time,inventory_listing")]
