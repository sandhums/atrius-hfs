// @generated by helios-fhir-gen (R5 Communication) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,based_on,part_of,status,status_reason,priority,subject,encounter,reason")]
