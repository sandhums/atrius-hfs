// @generated by helios-fhir-gen (R5 MedicationStatement) — do not edit
...
#[fhir_resource(choice_elements = "effective", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,category,medication,subject,encounter,effective,date_asserted,adherence")]
