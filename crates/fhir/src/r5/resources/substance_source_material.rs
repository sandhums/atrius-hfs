// @generated by helios-fhir-gen (R5 SubstanceSourceMaterial) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,source_material_class,source_material_type,source_material_state,organism_id,organism_name,parent_substance_id,parent_substance_name,country_of_origin,geographical_location,development_stage,fraction_description,organism,part_description")]
