// @generated by helios-fhir-gen (R5 ResearchSubject) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,period,study,subject")]
