// @generated by helios-fhir-gen (R5 TestPlan) — do not edit
...
/// FHIR Version: 5.0.0
/// 
/// See: [TestPlan](http://hl7.org/fhir/StructureDefinition/TestPlan)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,status,experimental,date,publisher,contact,use_context,jurisdiction")]
pub struct TestPlan {
    ...
    /// identifier) data type, and can then identify this test plan outside of FHIR,
    ...
    /// 
    /// The identifier that is used to identify this version of the test plan when it
    ...
    /// 
    /// ## Implementation Notes
    /// There may be different test plan instances that have the same identifier but
    /// different versions. The version can be appended to the url in a reference to
    /// allow a reference to a particular business version of the test plan with the
    ...
    /// that would be used for a production-level test plan.
    /// 
    /// ## Implementation Notes
    /// Allows filtering of test plans that are appropriate for use versus not.
    /// 
    ...
    /// the test plan. Additional specific dates may be added as extensions or be
    ...
    /// 
    /// ## Requirements
    /// Helps establish the "authority/credibility" of the test plan. May also allow
    /// for contact.
    /// 
    /// ## Implementation Notes
    /// Usually an organization but may be an individual. The publisher (or steward)
    /// of the test plan is the organization or individual primarily responsible for
    /// the maintenance and upkeep of the test plan. This is not necessarily the same
    ...
    /// the test plan. This item SHOULD be populated unless the information is
    ...
    /// test plan as conveyed in the 'text' field of the resource itself. This item
    /// SHOULD be populated unless the information is available from context (e.g.
    /// the language of the test plan is presumed to be the predominant language in
    /// the place the test plan was created).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Implementation Notes
    /// It may be possible for the test plan to be used in jurisdictions other than
    ...
    /// 
    /// ## Implementation Notes
    /// This element does not describe the usage of the test plan Instead, it
    ...
    /// specifications that drove the structure of this test plan.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// publishing of the test plan. The short copyright declaration (e.g. (c) '2015+
...
pub struct TestPlanDependency {
    ...
    /// 
    /// A textual description of the criterium - what is needed for the dependency to
    /// be considered met.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    ...
    /// 
    /// Predecessor test plans - those that are expected to be successfully performed
    /// as a dependency for the execution of this test plan.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
