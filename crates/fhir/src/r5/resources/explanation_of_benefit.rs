// @generated by helios-fhir-gen (R5 ExplanationOfBenefit) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,r#type,r#use,patient,billable_period,created,insurer,provider,outcome,decision,insurance,total")]
