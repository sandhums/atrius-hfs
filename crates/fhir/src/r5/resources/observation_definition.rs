// @generated by helios-fhir-gen (R5 ObservationDefinition) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,effective_period,derived_from_canonical,derived_from_uri,subject,performer_type,category,code")]
pub struct ObservationDefinition {
    ...
    /// and if this body part is not implied by code found in
