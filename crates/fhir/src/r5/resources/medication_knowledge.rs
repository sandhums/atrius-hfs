// @generated by helios-fhir-gen (R5 MedicationKnowledge) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,code,status,name,monitoring_program")]
