// @generated by helios-fhir-gen (R5 SubscriptionTopic) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,derived_from,status,experimental,date,publisher,contact,use_context,jurisdiction,effective_period,resource_trigger,event_trigger,can_filter_by,notification_shape")]
...
pub struct SubscriptionTopicNotificationShape {
    ...
    /// resource of the topic (or one of them if there are more than one) and the
