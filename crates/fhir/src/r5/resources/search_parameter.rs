// @generated by helios-fhir-gen (R5 SearchParameter) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,description,use_context,jurisdiction,code,base,r#type")]
pub struct SearchParameter {
    ...
    /// will never define multiple search parameters with the same code.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
