// @generated by helios-fhir-gen (R5 Linkage) — do not edit
...
/// FHIR Version: 5.0.0
/// 
/// See: [Linkage](http://hl7.org/fhir/StructureDefinition/Linkage)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,active,author,item")]
pub struct Linkage {
    ...
    /// 
    /// ## Requirements
    /// Need to be able to mark a linkage record as not to be used because it was
    /// created in error.
    /// 
    /// ## Implementation Notes
