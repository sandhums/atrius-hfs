// @generated by helios-fhir-gen (R5 SupplyDelivery) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,based_on,part_of,status,occurrence")]
pub struct SupplyDelivery {
    ...
    /// 
    /// ## Implementation Notes
    /// This identifier is typically assigned by the supplier, and may be used to
...
pub struct SupplyDeliverySuppliedItem {
    ...
    /// being supplied. This is either a link to a resource representing the details
    /// of the item or a code that identifies the item from a known list.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
