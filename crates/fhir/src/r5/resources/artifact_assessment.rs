...
#[fhir_resource(
    choice_elements = "citeAs,artifact",
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,title,date,last_review_date,artifact,workflow_status,disposition"
)]
