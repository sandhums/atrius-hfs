// @generated by helios-fhir-gen (R5 EvidenceReport) — do not edit
...
#[fhir_resource(choice_elements = "citeAs", summary_fields = "id,meta,implicit_rules,modifier_extension,url,status,use_context,identifier,related_identifier,subject,publisher,contact,author,endorser")]
