...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,derived_from_uri,part_of,replaces,status,experimental,date,publisher,contact,description,use_context,jurisdiction,code"
)]
