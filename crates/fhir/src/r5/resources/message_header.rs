// @generated by helios-fhir-gen (R5 MessageHeader) — do not edit
...
#[fhir_resource(choice_elements = "event", summary_fields = "id,meta,implicit_rules,modifier_extension,event,destination,sender,author,source,responsible,reason,response,focus,definition")]
pub struct MessageHeader {
    ...
    /// its definition. Events defined as part of the FHIR specification are defined
    /// by the implementation. Alternatively a canonical uri to the EventDefinition.
    /// 
    /// ## Requirements
    ...
    /// 
    /// ## Implementation Notes
    /// Usually only for the request but can be used in a response.Proposing to
