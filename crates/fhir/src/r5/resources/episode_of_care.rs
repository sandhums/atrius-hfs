// @generated by helios-fhir-gen (R5 EpisodeOfCare) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,r#type,reason,diagnosis,patient,managing_organization,period")]
