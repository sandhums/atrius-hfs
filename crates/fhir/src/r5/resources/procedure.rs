// @generated by helios-fhir-gen (R5 Procedure) — do not edit
...
#[fhir_resource(choice_elements = "occurrence,reported", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,based_on,part_of,status,status_reason,category,code,subject,focus,encounter,occurrence,recorded,recorder,reported,performer,location,reason,body_site,outcome")]
