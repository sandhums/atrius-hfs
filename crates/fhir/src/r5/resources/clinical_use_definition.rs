// @generated by helios-fhir-gen (R5 ClinicalUseDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,r#type,category,subject,status,contraindication,indication,interaction,population,library,undesirable_effect,warning")]
