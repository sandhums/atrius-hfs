// @generated by helios-fhir-gen (R5 Bundle) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,identifier,r#type,timestamp,total,link,entry,signature,issues")]
pub struct Bundle {
    ...
    /// of entries of type 'match' across all pages in the search. It does not
    /// include search.mode = 'include' or 'outcome' entries and it does not provide
    ...
    /// 
    /// Captures issues and warnings that relate to the construction of the Bundle
