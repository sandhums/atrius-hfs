// @generated by helios-fhir-gen (R5 CapabilityStatement) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,kind,instantiates,imports,software,implementation,fhir_version,format,patch_format,accept_language,implementation_guide,rest,messaging,document")]
