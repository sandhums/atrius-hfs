// @generated by helios-fhir-gen (R5 ConceptMap) — do not edit
...
pub struct ConceptMapGroup {
    ...
    ///
    /// ## Constraints
    /// - **cmd-4**: If noMap is present, target SHALL NOT be present (error)
...
pub struct ConceptMapGroupElement {
    ...
    ///
    /// ## Constraints
    /// - **cmd-1**: If the map is source-is-broader-than-target or not-related-to, there SHALL be some comments, unless the status is 'draft' (error)
