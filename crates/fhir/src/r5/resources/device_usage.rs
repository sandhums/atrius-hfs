// @generated by helios-fhir-gen (R5 DeviceUsage) — do not edit
...
#[fhir_resource(choice_elements = "timing", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,status,patient,derived_from,context,timing,date_asserted,information_source,device,reason,body_site")]
