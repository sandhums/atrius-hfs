...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,short_title,status,date,publisher,contact,description,use_context,characteristic"
)]
