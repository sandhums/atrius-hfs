// @generated by helios-fhir-gen (R5 MessageDefinition) — do not edit
...
pub struct MessageDefinition {
    ...
    /// 
    /// Graph is Canonical reference to a GraphDefinition. If a URL is provided, it
    /// is the canonical reference to a GraphDefinition that it controls what
    /// additional resources are to be added to the Bundle when building the message.
