// @generated by helios-fhir-gen (R5 ImmunizationEvaluation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,patient,target_disease,immunization_event,dose_status")]
