// @generated by helios-fhir-gen (R5 MolecularSequence) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,r#type,subject,focus,specimen,device,performer,literal,formatted,relative")]
