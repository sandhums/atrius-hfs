// @generated by helios-fhir-gen (R5 Task) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,instantiates_canonical,instantiates_uri,based_on,group_identifier,part_of,status,status_reason,business_status,intent,do_not_perform,code,description,focus,r#for,encounter,requested_period,execution_period,last_modified,requester,owner,performer,location")]
pub struct Task {
