...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,modifier_extension,instantiates_canonical,instantiates_uri,group_identifier,status,intent,subject,date_time,orderer"
)]
