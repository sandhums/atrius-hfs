// @generated by helios-fhir-gen (R5 ChargeItem) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,code,subject,encounter,occurrence,quantity,bodysite,enterer,entered_date,account")]
