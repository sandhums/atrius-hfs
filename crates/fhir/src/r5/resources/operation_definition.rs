...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,kind,experimental,date,publisher,contact,use_context,jurisdiction,affects_state,code,base,resource,system,r#type,instance"
)]
