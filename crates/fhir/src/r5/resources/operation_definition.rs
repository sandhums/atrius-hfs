// @generated by helios-fhir-gen (R5 OperationDefinition) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,kind,experimental,date,publisher,contact,use_context,jurisdiction,affects_state,code,base,resource,system,r#type,instance")]
pub struct OperationDefinition {
    ...
    /// and publishing of the operation definition.
    /// 
    /// ## Requirements
