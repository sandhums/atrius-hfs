// @generated by helios-fhir-gen (R5 RelatedPerson) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,patient,relationship,name,telecom,gender,birth_date,address")]
pub struct RelatedPerson {
    ...
    /// 
    /// ## Requirements
    /// We need to know the relationship with the patient since it influences the
    /// interpretation of the information attributed to this person.
    /// 
    /// ## Implementation Notes
