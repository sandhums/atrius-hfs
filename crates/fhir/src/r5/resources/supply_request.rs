...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,based_on,category,priority,item,quantity,occurrence,authored_on,requester,supplier"
)]
