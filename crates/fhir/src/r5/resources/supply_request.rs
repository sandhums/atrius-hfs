// @generated by helios-fhir-gen (R5 SupplyRequest) — do not edit
...
/// device, certain types of biologically derived product, and nutrition product
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,based_on,category,priority,item,quantity,occurrence,authored_on,requester,supplier")]
