// @generated by helios-fhir-gen (R5 ImagingStudy) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,modality,subject,encounter,started,based_on,part_of,referrer,endpoint,number_of_series,number_of_instances,procedure,location,reason,note,description,series")]
