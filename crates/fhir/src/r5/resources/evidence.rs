// @generated by helios-fhir-gen (R5 Evidence) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm,citeAs", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,title,status,date,publisher,contact,author,endorser,use_context")]
pub struct Evidence {
