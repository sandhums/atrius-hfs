// @generated by helios-fhir-gen (R5 DeviceDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,manufacturer,device_name,model_number,classification,conforms_to,has_part,safety")]
