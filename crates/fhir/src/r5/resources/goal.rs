// @generated by helios-fhir-gen (R5 Goal) — do not edit
...
#[fhir_resource(choice_elements = "start", summary_fields = "id,meta,implicit_rules,modifier_extension,lifecycle_status,achievement_status,category,priority,description,subject,start,status_date,source")]
pub struct Goal {
    ...
    /// defined to diet, then the care plan’s activity outcome could be calories
