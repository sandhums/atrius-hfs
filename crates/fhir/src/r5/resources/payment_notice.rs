// @generated by helios-fhir-gen (R5 PaymentNotice) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,created,payment,recipient,amount")]
