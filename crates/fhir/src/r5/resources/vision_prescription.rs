// @generated by helios-fhir-gen (R5 VisionPrescription) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,created,patient,date_written,prescriber,lens_specification")]
