// @generated by helios-fhir-gen (R5 Device) — do not edit
...
/// etc.), adminstrative (manufacturer name, model number, serial number,
...
/// for example the serail number, manufacturer name, and model number). An
...
pub struct Device {
    ...
    ///
    /// ## Implementation Notes
    /// The Device.gateway may be used when the Device being referenced has a gateway
    /// and/or to capture one or more gateways associated with the device. If the
    /// Gateway is included in the Observation resource, the
    /// Observation.gatewayDevice should be used instead.
    ///
    /// ## Cardinality: Optional, Multiple (0..*)
    ///
    /// ## Constraints
