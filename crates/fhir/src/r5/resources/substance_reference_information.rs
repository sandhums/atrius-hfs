// @generated by helios-fhir-gen (R5 SubstanceReferenceInformation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,comment,gene,gene_element,target")]
