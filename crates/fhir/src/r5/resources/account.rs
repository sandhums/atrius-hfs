// @generated by helios-fhir-gen (R5 Account) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,billing_status,r#type,name,subject,service_period,coverage,owner,description,diagnosis,procedure")]
pub struct Account {
