// @generated by helios-fhir-gen (R5 BiologicallyDerivedProductDispense) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,based_on,part_of,status,origin_relationship_type,product,patient,match_status,performer,location,quantity,prepared_date,when_handed_over,destination,note,usage_instruction")]
