// @generated by helios-fhir-gen (R5 CarePlan) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,based_on,replaces,part_of,status,intent,category,title,description,subject,encounter,period,created,custodian,addresses")]
pub struct CarePlan {
...
pub struct CarePlanActivity {
    ...
    /// progress). The activity performed is independent of the outcome of the
    /// related goal(s). For example, if the goal is to achieve a target body weight
    /// of 150 lbs and an activity is defined to exercise, then the activity
    /// performed could be amount and intensity of exercise performed whereas the
