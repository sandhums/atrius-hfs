...
#[fhir_resource(
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,based_on,replaces,part_of,status,intent,category,title,description,subject,encounter,period,created,custodian,addresses"
)]
pub struct CarePlan {
