// @generated by helios-fhir-gen (R5 CoverageEligibilityResponse) — do not edit
...
#[fhir_resource(choice_elements = "serviced", summary_fields = "id,meta,implicit_rules,modifier_extension,status,purpose,patient,created,request,outcome,insurer")]
