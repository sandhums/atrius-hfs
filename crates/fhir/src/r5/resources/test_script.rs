// @generated by helios-fhir-gen (R5 TestScript) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction")]
pub struct TestScript {
    ...
    /// address at which an authoritative instance of this test script is (or will
    /// be) published. This URL can be the target of a canonical reference. It SHALL
    /// remain the same when the test script is stored on different servers.
    /// 
    /// ## Requirements
    ...
    /// the test script. Additional specific dates may be added as extensions or be
    ...
    /// test script as conveyed in the 'text' field of the resource itself. This item
    ...
    /// 
    /// ## Implementation Notes
    /// See the [Resource List](resourcelist.html) for complete list of resource
    /// types.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
...
pub struct TestScriptDestination {
    ...
    /// 
    /// ## Implementation Notes
    /// If provided, the test engine is not expected to prompt for or accept external
    /// input of this value.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
...
pub struct TestScriptScope {
    ...
    /// 
    /// The specific conformance artifact being tested. The canonical reference can
    /// be version-specific.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    ...
    /// strict - all tests are expected to pass and warnings are treated as a
    /// failure.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    ...
    /// phase, integration - internal system to system phase, production - live
    /// system to system phase (Note, this may involve pii/phi data).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
...
pub struct TestScriptSetupActionAssert {
    ...
    /// fixture. When compareToSourceId is defined, either compareToSourceExpression
    ...
    /// 
    /// ## Implementation Notes
    /// Manual completion is used to pause the test engine execution and evaluation
    /// allowing an external review of the defined assert condition. The
    /// defaultManualCompletion defines the default manual completion outcome applied
    /// if one of the enumerated values is not applied.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    /// - When missing: If defaultManualCompletion is not specified, then the default manual completion outcome will be 'skip'.
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    ...
    /// 
    /// The FHIRPath expression can be evaluated as either a path to a specific value
    /// or as a boolean expression against the given FHIR resource. When the FHIRPath
    /// is a boolean expression, the assert.value element is not used. See [Testing
    /// FHIR Use Expressions](testing.html#expressions).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// ## Implementation Notes
    /// Operators are useful for both positive and negative testing. If operator is
    /// not specified, then the default conditional behavior is implemented as
    /// defined in [Testing FHIR Assertions](testing.html#assertion-table).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
    /// - When missing: If operator is not specified, then the default conditional behavior is implemented as defined in the Testing FHIR page Assertions table - see Comments.
    /// 
    /// ## Constraints
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    ...
    /// search, etc. See the [Resource List](resourcelist.html) for complete list of
    ...
    /// 
    /// ## Implementation Notes
    /// If this element is specified and it is true, then assertion failures should
    /// not stop the current test execution from proceeding.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Constraints
...
pub struct TestScriptSetupActionOperation {
    ...
    /// Resource type
    /// 
    /// The type of the FHIR resource. See the [resource list](resourcelist.html).
    ...
    /// [Conditional Create using "If-None-Exist"](http.html#2.1.0.11). See [Invalid
    /// "Content-Type" header](http.html#2.1.0.13.1) for negative testing. - etc.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
...
pub struct TestScriptVariable {
    ...
    /// body. When variables are defined, only one of either expression, headerField
