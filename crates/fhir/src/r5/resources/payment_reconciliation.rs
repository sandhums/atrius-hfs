// @generated by helios-fhir-gen (R5 PaymentReconciliation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,r#type,status,period,created,payment_issuer,date,amount")]
