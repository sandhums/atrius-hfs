// @generated by helios-fhir-gen (R5 SubstanceDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,version,status,classification,domain,grade,description,information_source,note,manufacturer,supplier,moiety,characterization,property,reference_information,molecular_weight,structure,code,name,relationship,nucleic_acid,polymer,protein,source_material")]
