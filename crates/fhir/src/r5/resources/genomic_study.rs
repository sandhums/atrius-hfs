// @generated by helios-fhir-gen (R5 GenomicStudy) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,r#type,subject,encounter")]
