// @generated by helios-fhir-gen (R5 Questionnaire) — do not edit
...
pub struct Questionnaire {
    ...
    /// expectations -
    /// [http://hl7.org/fhir/StructureDefinition/questionnaire-derivationType](http://hl7.org/fhir/extensions/StructureDefinition-questionnaire-derivationType.html).
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Special Semantics
    ...
    /// - **ele-1**: All FHIR elements must have a @value or children (error)
    ///   Expression: `hasValue() or (children().count() > id.count())`
    /// - **que-1a**: Group items must have nested items when Questionanire is complete (error)
    ...
    /// - **que-5**: Only coding, decimal, integer, date, dateTime, time, string or quantity  items can have answerOption or answerValueSet (error)
