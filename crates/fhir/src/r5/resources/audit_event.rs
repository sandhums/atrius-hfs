// @generated by helios-fhir-gen (R5 AuditEvent) — do not edit
...
#[fhir_resource(choice_elements = "occurred", summary_fields = "id,meta,implicit_rules,modifier_extension,category,code,action,severity,recorded,outcome,authorization,agent,source,entity")]
