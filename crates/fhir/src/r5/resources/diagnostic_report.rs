...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,category,code,subject,encounter,effective,issued,performer,results_interpreter,media"
)]
