// @generated by helios-fhir-gen (R5 DiagnosticReport) — do not edit
...
#[fhir_resource(choice_elements = "effective", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,category,code,subject,encounter,effective,issued,performer,results_interpreter,media")]
