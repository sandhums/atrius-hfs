// @generated by helios-fhir-gen (R5 ActorDefinition) — do not edit
...
#[fhir_resource(choice_elements = "versionAlgorithm", summary_fields = "id,meta,implicit_rules,modifier_extension,url,identifier,version,version_algorithm,name,title,status,experimental,date,publisher,contact,use_context,jurisdiction,r#type")]
pub struct ActorDefinition {
    ...
    /// 
    /// ## Implementation Notes
    /// In general terms, the description desribes what the actor is, and this
    /// element describes what the actor does (or is expected to do).
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
    ...
    /// 
    /// A url that identifies the definition of this actor in another IG (which IG
    /// must be listed in the dependencies). This actor inherits all the obligations
    /// etc. as defined in the other IG.
    /// 
    /// ## Cardinality: Optional, Multiple (0..*)
    /// 
    /// ## Constraints
