// @generated by helios-fhir-gen (R5 SubstancePolymer) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,class,geometry,copolymer_connectivity,modification,monomer_set,repeat")]
