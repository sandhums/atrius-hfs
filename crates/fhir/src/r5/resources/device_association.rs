// @generated by helios-fhir-gen (R5 DeviceAssociation) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,device,category,status,status_reason,subject,body_structure,period,operation")]
