// @generated by helios-fhir-gen (R5 BodyStructure) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,morphology,description,patient")]
