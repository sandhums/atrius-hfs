// @generated by helios-fhir-gen (R5 AllergyIntolerance) — do not edit
...
#[fhir_resource(choice_elements = "onset", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,clinical_status,verification_status,r#type,category,criticality,code,patient,participant")]
