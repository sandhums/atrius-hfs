// @generated by helios-fhir-gen (R5 GuidanceResponse) — do not edit
...
#[fhir_resource(choice_elements = "module", summary_fields = "id,meta,implicit_rules,modifier_extension,request_identifier,identifier,module,status")]
