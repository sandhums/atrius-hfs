// @generated by helios-fhir-gen (R5 Coverage) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,kind,r#type,policy_holder,subscriber,subscriber_id,beneficiary,dependent,period,insurer,order,network")]
pub struct Coverage {
