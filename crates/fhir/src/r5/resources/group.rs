// @generated by helios-fhir-gen (R5 Group) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,active,r#type,membership,code,name,quantity,managing_entity,characteristic")]
pub struct Group {
