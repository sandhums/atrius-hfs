// @generated by helios-fhir-gen (R5 DeviceRequest) — do not edit
...
#[fhir_resource(choice_elements = "occurrence", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,based_on,replaces,group_identifier,status,intent,priority,do_not_perform,code,subject,encounter,occurrence,authored_on,requester,performer,reason")]
pub struct DeviceRequest {
    ...
    /// "do perform". DeviceRequest.reasonCode includes the reason for marking the
