...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,based_on,replaces,group_identifier,status,intent,priority,do_not_perform,code,subject,encounter,occurrence,authored_on,requester,performer,reason"
)]
