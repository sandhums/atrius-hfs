// @generated by helios-fhir-gen (R5 Substance) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instance,status,category,code,description,expiry,quantity,ingredient")]
