// @generated by helios-fhir-gen (R5 Permission) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,asserter,date,validity,justification,combining,rule")]
