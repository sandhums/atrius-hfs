// @generated by helios-fhir-gen (R5 ImagingSelection) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,subject,issued,performer,based_on,category,code,study_uid,derived_from,endpoint,series_uid,series_number,frame_of_reference_uid,body_site,focus,instance")]
