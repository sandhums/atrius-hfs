// @generated by helios-fhir-gen (R5 Invoice) — do not edit
...
#[fhir_resource(choice_elements = "period", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,r#type,subject,recipient,creation,period,total_net,total_gross")]
pub struct Invoice {
    ...
    /// 
    /// ## Requirements
    /// Required to suppress the Data Type VirtualServiceDetail: ERROR:
    /// Invoice::date: Expression 'Invoice.date' has illegal path.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Constraints
