// @generated by helios-fhir-gen (R5 SubstanceProtein) — do not edit
...
/// FHIR Version: 5.0.0
/// 
/// See: [SubstanceProtein](http://hl7.org/fhir/StructureDefinition/SubstanceProtein)
#[derive(Debug, Clone, PartialEq, FhirSerde, FhirPath, Default)]
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,sequence_type,number_of_subunits,disulfide_linkage,subunit")]
pub struct SubstanceProtein {
    ...
    /// of subunit number and position within subunit followed by the abbreviation of
    /// the amino acids involved. The disulfide linkage positions shall actually
...
pub struct SubstanceProteinSubunit {
    ...
    /// single letter code an X should be used within the sequence. The modified
