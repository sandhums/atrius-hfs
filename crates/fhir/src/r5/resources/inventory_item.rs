// @generated by helios-fhir-gen (R5 InventoryItem) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,category,code,name,inventory_status,base_unit,net_content")]
