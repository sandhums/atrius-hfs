// @generated by helios-fhir-gen (R5 TestReport) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,name,status,test_script,result,score,tester,issued")]
