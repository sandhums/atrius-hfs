// @generated by helios-fhir-gen (R5 VerificationResult) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,target,target_location,need,status,status_date,validation_type,validation_process,failure_action")]
