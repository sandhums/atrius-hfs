// @generated by helios-fhir-gen (R5 Medication) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,code,status,marketing_authorization_holder,total_volume")]
pub struct Medication {
    ...
    /// specific amount of drug in the product. For example, when specifying a
    /// product that has the same strength (For example, Insulin glargine 100 unit
    /// per mL solution for injection), this attribute provides additional
