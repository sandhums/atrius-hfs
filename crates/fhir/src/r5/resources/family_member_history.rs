// @generated by helios-fhir-gen (R5 FamilyMemberHistory) — do not edit
...
#[fhir_resource(choice_elements = "born,age,deceased", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,instantiates_canonical,instantiates_uri,status,data_absent_reason,patient,date,participant,name,relationship,sex,age,estimated_age,deceased,reason")]
