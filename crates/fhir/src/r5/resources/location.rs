// @generated by helios-fhir-gen (R5 Location) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,operational_status,name,description,mode,r#type,form,managing_organization")]
pub struct Location {
