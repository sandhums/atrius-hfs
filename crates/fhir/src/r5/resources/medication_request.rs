// @generated by helios-fhir-gen (R5 MedicationRequest) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,based_on,group_identifier,status,intent,priority,do_not_perform,medication,subject,authored_on,requester,reported,performer_type")]
