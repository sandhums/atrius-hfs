// @generated by helios-fhir-gen (R5 Specimen) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,accession_identifier,status,r#type,subject,received_time,combined,condition")]
pub struct Specimen {
