// @generated by helios-fhir-gen (R5 ClaimResponse) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,status,r#type,r#use,patient,created,insurer,request,outcome,decision,total")]
