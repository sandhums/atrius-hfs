// @generated by helios-fhir-gen (R5 DeviceMetric) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,r#type,unit,device,operational_status,category")]
pub struct DeviceMetric {
    ...
    /// 
    /// ## Implementation Notes
    /// Note if this is not the top level device - also know as the source device, it
    /// may be referenced in the device.parent element.
    /// 
    /// ## Cardinality: Required (1..1)
    /// 
    /// ## Special Semantics
    ...
    /// an hour. Less often, the measurementFrequency may be based on a unit other
    /// than time, such as distance (e.g. for a measuring wheel). The update period
    /// may be different than the measurement frequency, if the device does not
