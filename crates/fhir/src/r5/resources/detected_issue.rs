// @generated by helios-fhir-gen (R5 DetectedIssue) — do not edit
...
#[fhir_resource(choice_elements = "identified", summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,code,severity,subject,encounter,identified,author,implicated")]
pub struct DetectedIssue {
    ...
    /// 
    /// ## Implementation Notes
    /// This will typically be the encounter the DetectedIssue was created during,
    /// but some DetectedIssues may be initiated prior to or after the official
