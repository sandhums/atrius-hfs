// @generated by helios-fhir-gen (R5 ManufacturedItemDefinition) — do not edit
...
#[fhir_resource(summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,status,name,manufactured_dose_form,unit_of_presentation,manufacturer,marketing_status,ingredient,property,component")]
