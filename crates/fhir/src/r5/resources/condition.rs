...
#[fhir_resource(
    ...
    summary_fields = "id,meta,implicit_rules,modifier_extension,identifier,clinical_status,verification_status,code,body_site,subject,encounter,onset,recorded_date,participant,evidence"
)]
