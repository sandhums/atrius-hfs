// @generated by helios-fhir-gen (R5 RelatedArtifact) — do not edit
...
#[fhir_resource(summary_fields = "r#type,classifier,label,display,citation,document,resource,resource_reference,publication_status,publication_date")]
