// @generated by helios-fhir-gen (R5 Meta) — do not edit
...
pub struct Meta {
    ...
    /// Instead, it is populated in the response instance and when retrieving
    /// information using a GET. The server / resource manager sets this value; what
    /// a client provides is irrelevant. This is equivalent to the HTTP Last-Modified
    /// and SHOULD have the same value on a [read](http.html#read) interaction.
    /// 
    /// ## Cardinality: Optional (0..1)
    /// 
    /// ## Special Semantics
