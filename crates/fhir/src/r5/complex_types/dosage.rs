// @generated by helios-fhir-gen (R5 Dosage) — do not edit
...
#[fhir_resource(summary_fields = "modifier_extension,sequence,text,additional_instruction,patient_instruction,timing,as_needed,as_needed_for,site,route,method,dose_and_rate,max_dose_per_period,max_dose_per_administration,max_dose_per_lifetime")]
pub struct Dosage {
