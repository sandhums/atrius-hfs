...
impl TransportStatus {
    pub const URL: &'static str = "http://hl7.org/fhir/transport-status";
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            Self::InProgress => Some("Transport has started but not completed."),
            Self::Completed => Some("Transport has been completed."),
