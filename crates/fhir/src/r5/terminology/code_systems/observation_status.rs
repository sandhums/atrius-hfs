...
impl ObservationStatus {
    ...
    pub fn definition(self) -> Option<&'static str> {
        match self {
            ...
            Self::Amended => Some("Subsequent to being Final, the observation has been modified subsequent.  This includes updates/new information and corrections."),
            Self::Corrected => Some("Subsequent to being Final, the observation has been modified to correct an error in the test result."),
            Self::Cancelled => Some("The observation is unavailable because the measurement was not started or not completed (also sometimes called \"aborted\")."),
