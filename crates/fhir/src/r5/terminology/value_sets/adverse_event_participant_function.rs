...
pub struct AdverseEventParticipantFunction;

impl AdverseEventParticipantFunction {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/adverse-event-participant-function";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "adverse_event_participant_function";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType" {
            return Some(matches!(code, "INF" | "PART" | "WIT" | "AUT"));
        }
        None
    }
