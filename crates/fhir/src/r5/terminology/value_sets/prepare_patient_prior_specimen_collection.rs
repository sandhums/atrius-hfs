...
pub struct PreparePatient;

impl PreparePatient {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/prepare-patient-prior-specimen-collection";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "prepare_patient_prior_specimen_collection";
