...
impl RequestResourceTypes {
    ...
    pub const MODULE: &'static str = "request_resource_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(matches!(code, "Appointment" | "AppointmentResponse" | "CarePlan" | "Claim" | "CommunicationRequest" | "CoverageEligibilityRequest" | "DeviceRequest" | "EnrollmentRequest" | "ImmunizationRecommendation" | "MedicationRequest" | "NutritionOrder" | "RequestOrchestration" | "ServiceRequest" | "SupplyRequest" | "Task" | "Transport" | "VisionPrescription"));
        }
        None
    }
