...
pub struct AuditEventOutcomeDetail;

impl AuditEventOutcomeDetail {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/audit-event-outcome-detail";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "audit_event_outcome_detail";
