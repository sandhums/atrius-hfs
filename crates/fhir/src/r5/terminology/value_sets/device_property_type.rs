...
impl DeviceType {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:iso:std:iso:11073:10101" {
            return Some(matches!(code, "528391" | "528404" | "528425" | "528402" | "528409" | "528390" | "528457" | "528401" | "528455" | "528403" | "528405" | "528388" | "528397" | "528408" | "528426" | "528392" | "528399"));
        }
        if system == "urn:oid:2.16.840.1.113883.6.276" {
            return Some(matches!(code, "38017" | "38663" | "42347" | "46352" | "47264" | "62163" | "62260" | "62423" | "62414" | "64587" | "64992"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        ...
        if system == "urn:oid:2.16.840.1.113883.6.276" {
            return match code {
                ...
                "62423" => Some("Spinal cord/peripheral nerve implantable analgesic electrical stimulation system lead, wired connection"),
