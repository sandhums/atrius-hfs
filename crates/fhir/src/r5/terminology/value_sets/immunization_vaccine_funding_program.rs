...
pub struct CodesForVaccineFundingPrograms;

impl CodesForVaccineFundingPrograms {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-vaccine-funding-program";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "immunization_vaccine_funding_program";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://loinc.org" {
            return Some(matches!(code, "64994-7"));
        }
        None
    }
