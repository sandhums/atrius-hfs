...
impl DefinitionResourceTypes {
    ...
    pub const MODULE: &'static str = "definition_resource_types";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/fhir-types" {
            return Some(matches!(code, "ActivityDefinition" | "ChargeItemDefinition" | "ClinicalUseDefinition" | "EventDefinition" | "Measure" | "MessageDefinition" | "ObservationDefinition" | "OperationDefinition" | "PlanDefinition" | "Questionnaire" | "Requirements" | "SubscriptionTopic" | "TestPlan" | "TestScript"));
        }
        None
    }
