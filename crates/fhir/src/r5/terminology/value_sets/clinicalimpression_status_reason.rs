...
pub struct ClinicalImpressionStatusReason;

impl ClinicalImpressionStatusReason {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/clinicalimpression-status-reason";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "clinicalimpression_status_reason";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "397709008" | "105480006" | "719500002" | "445060000" | "704273008" | "704274002" | "704458005" | "704275001" | "704276000" | "704277009" | "398090008"));
        }
        None
    }
