...
pub struct ClinicalImpressionChangePatter;

impl ClinicalImpressionChangePatter {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/clinicalimpression-change-pattern";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "clinicalimpression_change_pattern";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "230993007" | "385633008" | "260388006"));
        }
        None
    }
