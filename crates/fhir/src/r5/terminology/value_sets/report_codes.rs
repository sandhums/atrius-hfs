...
pub struct LOINCDiagnosticReportCodes;

impl LOINCDiagnosticReportCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/report-codes";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "report_codes";
