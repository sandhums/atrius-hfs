...
impl VitalSigns {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/observation-vitalsignresult";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "observation_vitalsignresult";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://loinc.org" {
            return Some(matches!(code, "85353-1" | "9279-1" | "8867-4" | "2708-6" | "8310-5" | "8302-2" | "9843-4" | "29463-7" | "39156-5" | "85354-9" | "8480-6" | "8462-4" | "8478-0"));
        }
        None
    }
