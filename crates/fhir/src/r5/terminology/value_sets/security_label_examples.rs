...
impl SecurityLabelExamples {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/security-label-examples";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "security_label_examples";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/security-label-data-examples
        match super::super::value_sets::security_label_data_examples::SecurityLabelDataExamples::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
        // http://hl7.org/fhir/ValueSet/security-label-event-examples
        match super::super::value_sets::security_label_event_examples::SecurityLabelEventExamples::contains(system, code) {
            Some(true) => return Some(true),
            Some(false) => { any_false = true; }
            None => { any_none = true; }
        }
