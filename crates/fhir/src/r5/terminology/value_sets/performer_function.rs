...
pub struct PerformerFunctionCodes;

impl PerformerFunctionCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/performer-function";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "performer_function";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType" {
            return Some(matches!(code, "TRANS" | "PART" | "ATND" | "CON" | "AUT" | "INF" | "ENT" | "WIT" | "PPRF" | "SPRF" | "RESP" | "VRF" | "AUTHEN" | "LA"));
        }
        None
    }
