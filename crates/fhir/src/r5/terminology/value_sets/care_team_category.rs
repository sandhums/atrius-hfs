...
pub struct CareTeamCategory;

impl CareTeamCategory {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/care-team-category";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "care_team_category";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://loinc.org" {
            return Some(matches!(code, "LA27975-4" | "LA27976-2" | "LA27977-0" | "LA27978-8" | "LA28865-6" | "LA28866-4" | "LA27980-4" | "LA28867-2"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://loinc.org" {
            return match code {
                "LA27975-4" => Some("Event-focused care team"),
                "LA27976-2" => Some("Encounter-focused care team"),
                "LA27977-0" => Some("Episode of care-focused care team"),
                "LA27978-8" => Some("Condition-focused care team"),
                "LA28865-6" => Some("Longitudinal care-coordination focused care team"),
                "LA28866-4" => Some("Home & Community Based Services (HCBS)-focused care team"),
                "LA27980-4" => Some("Clinical research-focused care team"),
                "LA28867-2" => Some("Public health-focused care team"),
                _ => None,
            };
        }
        None
