...
impl ExpressionLanguage {
    ...
    pub const MODULE: &'static str = "expression_language";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:ietf:bcp:13" {
            return Some(matches!(code, "text/cql" | "text/fhirpath" | "text/x-fhir-query" | "text/cql-identifier" | "text/cql-expression"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "urn:ietf:bcp:13" {
            return match code {
                "text/cql" => Some("CQL"),
                "text/fhirpath" => Some("FHIRPath"),
                "text/x-fhir-query" => Some("FHIR Query"),
                "text/cql-identifier" => Some("CQL Identifier"),
                "text/cql-expression" => Some("CQL Expression"),
                _ => None,
            };
        }
        None
