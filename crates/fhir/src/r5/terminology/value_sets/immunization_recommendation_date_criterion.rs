...
pub struct ImmunizationRecommendationDateCriterionCodes;

impl ImmunizationRecommendationDateCriterionCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/immunization-recommendation-date-criterion";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "immunization_recommendation_date_criterion";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://loinc.org" {
            return Some(matches!(code, "30981-5" | "30980-7" | "59777-3" | "59778-1"));
        }
        None
    }
