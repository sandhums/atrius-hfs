...
impl DeviceSafety {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/device-safety";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "device_safety";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "urn:oid:2.16.840.1.113883.3.26.1.1" {
            return Some(matches!(code, "C106046" | "C106045" | "C106047" | "C113844" | "C101673" | "C106038"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "urn:oid:2.16.840.1.113883.3.26.1.1" {
            return match code {
                "C106046" => Some("Magnetic Resonance Conditional"),
                "C106045" => Some("Magnetic Resonance Safe"),
                "C106047" => Some("Magnetic Resonance Unsafe"),
                "C113844" => Some("Labeling does not Contain MRI Safety Information"),
                "C101673" => Some("Labeled as Containing Natural Rubber Latex"),
                "C106038" => Some("Not Made with Natural Rubber Latex"),
                _ => None,
            };
        }
        None
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("urn:oid:2.16.840.1.113883.3.26.1.1".to_string()), code: code.to_string() })
            }
            None => Err(TerminologyValidationError::RemoteValidationRequired("Remote terminology validation required".to_string())),
        }
    }
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("urn:oid:2.16.840.1.113883.3.26.1.1", code)
    }
