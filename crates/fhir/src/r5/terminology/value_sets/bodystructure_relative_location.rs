...
impl BodystructureLocationQualifier {
    ...
    pub const MODULE: &'static str = "bodystructure_relative_location";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "7771000" | "24028007" | "51440002" | "46053002" | "255554000" | "264147007" | "261183002" | "261122009" | "255561001" | "49370004" | "264217000" | "261089000" | "255551008" | "351726001" | "352730000"));
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                "7771000" => Some("Left (qualifier value)"),
                "24028007" => Some("Right (qualifier value)"),
                "51440002" => Some("Bilateral"),
                "46053002" => Some("Distal"),
                "255554000" => Some("Dorsal"),
                "264147007" => Some("Plantar"),
                "261183002" => Some("Upper"),
                "261122009" => Some("Lower"),
                "255561001" => Some("Medial"),
                "49370004" => Some("Lateral"),
                "264217000" => Some("Superior"),
                "261089000" => Some("Inferior"),
                "255551008" => Some("Posterior"),
                "351726001" => Some("Below"),
                "352730000" => Some("Above"),
                _ => None,
            };
        }
        None
