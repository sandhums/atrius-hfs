    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://snomed.info/sct" {
            return match code {
                ...
                "441601000124106" => Some("Diabetic high calorie high protein enteral formula with fiber"),
