...
impl BodystructureBodyLandmarkClockFacePosition {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/bodystructure-bodylandmarkorientation-clockface-position";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://snomed.info/sct" {
            return Some(matches!(code, "260318004" | "260328008" | "260330005" | "260333007" | "260335000" | "260337008" | "260339006" | "260341007" | "260343005" | "260322009" | "260324005" | "260326007"));
        }
        None
    }
