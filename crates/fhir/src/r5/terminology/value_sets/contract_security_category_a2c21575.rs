...
impl ContractResourceScopeCodes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/contract-security-category" {
            return Some(super::super::code_systems::ContractSecurityCategory::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/contract-security-category" {
            return super::super::code_systems::ContractSecurityCategory::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
