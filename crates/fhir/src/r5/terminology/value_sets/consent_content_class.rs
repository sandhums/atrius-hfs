...
impl ConsentContentClass {
    ...
    pub const INCLUDED_SYSTEMS: &'static [&'static str] = &["urn:ietf:rfc:3986", "urn:ietf:bcp:13"];
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        ...
        // http://hl7.org/fhir/ValueSet/doc-typecodes
        match super::super::value_sets::doc_typecodes::FHIRDocumentTypeCodes::contains(system, code)
        {
