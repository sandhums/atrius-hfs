...
impl TaskIntent {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/task-intent";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "task_intent_a245c08b";
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("http://hl7.org/fhir/task-intent".to_string()), code: code.to_string() })
            }
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/task-intent", code)
    }
