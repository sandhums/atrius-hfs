...
pub struct ProvenanceEventHistoryAgentRoleCodes;

impl ProvenanceEventHistoryAgentRoleCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/provenance-history-agent-type";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "provenance_history_agent_type";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType" {
            return Some(matches!(code, "AUT" | "INF" | "VRF" | "ENT"));
        }
        None
    }
