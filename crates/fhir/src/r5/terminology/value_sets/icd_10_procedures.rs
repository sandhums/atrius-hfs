...
pub struct ICD10ProcedureCodes;

impl ICD10ProcedureCodes {
    pub const URL: &'static str = "http://hl7.org/fhir/ValueSet/icd-10-procedures";
    pub const VERSION: &'static str = "5.0.0";
    pub const MODULE: &'static str = "icd_10_procedures";
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/sid/ex-icd-10-procedures" {
            return Some(super::super::code_systems::ICD10ProcedureCodes::try_from_code(code).is_some());
        }
        None
    }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/sid/ex-icd-10-procedures" {
            return super::super::code_systems::ICD10ProcedureCodes::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
    ...
    pub fn validate_code(code: &str) -> Result<(), TerminologyValidationError> {
        match Self::contains_implicit_code(code) {
            Some(true) => Ok(()),
            Some(false) => {
                Err(TerminologyValidationError::NotInValueSet { valueset_url: Self::URL.to_string(), system: Some("http://hl7.org/fhir/sid/ex-icd-10-procedures".to_string()), code: code.to_string() })
            }
    ...
    pub fn contains_implicit_code(code: &str) -> Option<bool> {
        Self::contains("http://hl7.org/fhir/sid/ex-icd-10-procedures", code)
    }
