...
impl ElementDefinitionTypes {
    ...
    pub fn contains(system: &str, code: &str) -> Option<bool> {
        if system == "http://hl7.org/fhir/CodeSystem/fhirpath-types" {
            return Some(super::super::code_systems::FHIRPathTypesCodeSystem::try_from_code(code).is_some());
        }
    ...
    pub fn expected_display(system: &str, code: &str) -> Option<&'static str> {
        if system == "http://hl7.org/fhir/CodeSystem/fhirpath-types" {
            return super::super::code_systems::FHIRPathTypesCodeSystem::try_from_code(code).and_then(|c| c.display());
        }
        None
    }
