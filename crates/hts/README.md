...
| [BCP 47 languages fork (2026-09-22)](docs/fork-bcp47-languages.md) | Keep on `upstream/main` merge: expand enumerated language ValueSets without a CodeSystem; validate well-formed tags against `urn:ietf:bcp:47` |
