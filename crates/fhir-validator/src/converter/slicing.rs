...
//! or `extension(...)`, and discriminator kinds we cannot evaluate yet
//! (e.g. `exists`), produce a slice with **no match and no minimum**: it can
//! never produce false cardinality errors; its constraints simply stay
//! dormant and the generator surfaces a warning.
//!
