        ...
        if let Some(choice) = &self.version_algorithm {
            match choice {
                ObservationDefinitionVersionAlgorithm::String(value) => {
                    let child_issues = fhir_validation::r5::validate_primitive_value_binding(validator, "ObservationDefinition.versionAlgorithm[x]", "http://hl7.org/fhir/ValueSet/version-algorithm", fhir_validation_types::BindingStrength::Extensible, value.value.as_deref(), |value| helios_fhir::r5::terminology::validate_code("http://hl7.org/fhir/ValueSet/version-algorithm", value), terminology);
                    issues.extend(child_issues);
                }
