...
| **SQL-on-FHIR / Analytics** | Full SQL-on-FHIR (3.0.0-ballot) with Parquet, CSV, NDJSON, JSON output and Python bindings. Addresses the "analytical queries" deal breaker (Ch. 3) and secondary use cases the book highlights. |
