...
- [Code Generation](ch10-codegen.md)
- [Use Cases and Recipes](ch11-recipes.md)
...
- [CLI Reference](appendix-a-cli.md)
- [FHIRPath Function Reference](appendix-b-fhirpath-functions.md)
- [Glossary](appendix-c-glossary.md)
- [Changelog](appendix-d-changelog.md)
